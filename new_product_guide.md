...
> ⚠️ **النسخة الأولى كانت ناقصة.** يوجد **ملفان إضافيان** مفقودان لم يتم توثيقهما.
...
export const {slug_with_underscores} = {
    ...
    stock: 3000,     // الكمية المتاحة (رقم واقعي)
    ...
    images: [
        {
            ...
            alt: "وصف الصورة بالإنجليزي — SEO محسّن",
            order: 0,
            isPrimary: true,
            width: 1080,
            height: 1080
...
| الاسم | بالإنجليزي، lowercase، `-` كفاصل |
| Alt text | en للـ SEO — كلمات مفتاحية + اسم المنتج + cairovolt |
...
> **⚠️ ملاحظة:** بعض المجلدات تستخدم uppercase في نهايتها مثل `30W` — كن دقيقاً في المطابقة.
...
export const {slug_underscores}_lab: ProductLabData = {
    ...
    labMetrics: {
        ...
        actualWeight_g: 38,       // للشواحن
        devicesCharged: 2,        // عدد الأجهزة المشحونة
    }
};
```
...
- [ ] 8 صور `.webp` بحجم 1080×1080
- [ ] مسارات الصور صحيحة في الكود
- [ ] الـ description يحتوي كل الأقسام الـ 6
- [ ] metaTitle ≤ 60 حرف
- [ ] metaDesc ≤ 160 حرف
- [ ] 4-5 FAQs لكل لغة
- [ ] 5-7 تقييمات واقعية
...
- [ ] **ملف tests/{slug}.ts منشأ** ← كان مفقوداً في الدليل الأول
- [ ] **مُضاف في product-tests.ts** ← كان مفقوداً في الدليل الأول
- [ ] **تحديث category-content/{brand}/{category}.ts** ← كان مفقوداً في الدليل الأول

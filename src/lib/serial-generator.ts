...
export const PRODUCT_NAMES: Record<string, { ar: string; en: string }> = {
    'anker-nano-45w': { ar: 'شاحن انكر نانو 45W', en: 'Anker Nano 45W Charger' },
    'anker-powercore-10000': { ar: 'باور بانك انكر 10000mAh', en: 'Anker PowerCore 10000' },
    'anker-powercore-20000': { ar: 'باور بانك انكر 20000mAh', en: 'Anker PowerCore 20000' },
    'anker-powercore-26800': { ar: 'باور بانك انكر 26800mAh', en: 'Anker PowerCore 26800' },
    'anker-737-powerbank': { ar: 'باور بانك انكر 737', en: 'Anker 737 Power Bank' },
    'anker-521-powerhouse': { ar: 'محطة طاقة انكر 521', en: 'Anker 521 PowerHouse' },
    'anker-powerport-20w': { ar: 'شاحن انكر 20W', en: 'Anker PowerPort 20W' },
    'anker-powerport-25w': { ar: 'شاحن انكر 25W', en: 'Anker PowerPort 25W' },
    'anker-a2147-gan-charger-30w': { ar: 'شاحن انكر GaN 30W', en: 'Anker GaN 30W' },
    'anker-a2732-charger-35w': { ar: 'شاحن انكر 35W', en: 'Anker 35W Charger' },
    'anker-a2741-charger-30w': { ar: 'شاحن انكر 30W', en: 'Anker 30W Charger' },
    'anker-powerline-usb-c-lightning': { ar: 'كابل انكر USB-C إلى Lightning', en: 'Anker PowerLine USB-C Lightning' },
    'anker-powerline-usb-c-usb-c': { ar: 'كابل انكر USB-C إلى USB-C', en: 'Anker PowerLine USB-C' },
    'anker-a8050-usb-c-cable': { ar: 'كابل انكر USB-C', en: 'Anker USB-C Cable' },
    'anker-car-charger-dual-usb': { ar: 'شاحن سيارة انكر', en: 'Anker Car Charger' },
    'anker-622-maggo': { ar: 'باور بانك انكر MagGo', en: 'Anker 622 MagGo' },
    ...
    'anker-soundcore-motion-plus': { ar: 'سبيكر ساوندكور Motion+', en: 'Soundcore Motion+' },
    ...
    'anker-a1637-wukong-3-in-1-power-bank': { ar: 'باور بانك انكر × بلاك ميث: ووكونج 3 في 1 (A1637)', en: 'Anker x Black Myth: Wukong 3-in-1 Power Bank (A1637)' },
    'anker-a2216-magnetic-wireless-car-charger': { ar: 'شاحن سيارة انكر نانو مغناطيسي لاسلكي (A2216)', en: 'Anker Nano Magnetic Wireless Car Charger (A2216)' },
    'anker-nano-45w-1c-pd': { ar: 'شاحن انكر نانو 45 واط 1C (A2039)', en: 'Anker Nano 45W 1C (A2039)' },
    'anker-nano-45w-smart-display-charger': { ar: 'شاحن انكر نانو 45 واط بشاشة ذكية (A121D)', en: 'Anker Nano 45W Smart Display GaN Charger (A121D)' },
    'anker-nano-pro-45w-a2692': { ar: 'شاحن حائط انكر نانو برو 45 واط USB-C موديل A2692', en: 'Anker Nano Pro 45W USB-C Charger (A2692)' },
    'anker-pencil-stylus': { ar: 'قلم انكر Pencil', en: 'Anker Pencil' },
    'anker-powerport-iii-20w-a2639': { ar: 'شاحن انكر باور بورت III 20 واط كيوب', en: 'Anker PowerPort III 20W Cube' },
    'anker-prime-a1336-20000mah-power-bank': { ar: 'انكر برايم باور بانك 20000mAh (A1336)', en: 'Anker Prime 20,000mAh Power Bank (A1336)' },
    'anker-prime-a2669-67w-gan-charger': { ar: 'شاحن حائط انكر برايم 67 واط جان (A2669)', en: 'Anker Prime 67W GaN Wall Charger (A2669)' },
    'anker-prime-a2688-100w-charger': { ar: 'شاحن انكر برايم 100 واط GaN بـ3 منافذ', en: 'Anker Prime 100W 3-Port GaN Charger' },
    'anker-prime-fusion-a1339-9600mah-65w': { ar: 'باور بانك انكر برايم فيوجن 9,600 مللي أمبير 65 واط (A1339)', en: 'Anker Prime Power Bank 9,600mAh 65W Fusion (A1339)' },
    ...
    'anker-zolo-30w-a2698-charger': { ar: 'شاحن حائط انكر زولو 30 واط USB-C (A2698)', en: 'Anker Zolo 30W USB-C Wall Charger (A2698)' },
    'anker-zolo-a110d-10000': { ar: 'باور بانك انكر زولو 10,000 مللي أمبير (22.5 واط)', en: 'Anker ZOLO Power Bank 10,000mAh (22.5W)' },
    'anker-zolo-a110e-20000': { ar: 'باور بانك انكر زولو 20,000 مللي أمبير (22.5 واط)', en: 'Anker ZOLO Power Bank 20,000mAh (22.5W)' },
    'anker-zolo-a1681-20000': { ar: 'باور بانك انكر زولو 20,000 مللي أمبير 45 واط PD', en: 'Anker ZOLO Power Bank 20,000mAh 45W PD' },
    'anker-zolo-usb-c-braided-cable': { ar: 'كابل انكر زولو USB-C إلى USB-C مضفر (A81D6)', en: 'Anker Zolo USB-C to USB-C Braided Cable (A81D6)' },
    ...
    'joyroom-type-c-lightning-24mos': { ar: 'كابل جوي روم USB-C إلى Lightning موديل JR-S-CL24M', en: 'Joyroom USB-C to Lightning Cable (JR-S-CL24M)' },
    'joyroom-type-c-lightning-36mos': { ar: 'كابل جوي روم USB-C إلى Lightning موديل JR-S-CL36M', en: 'Joyroom USB-C to Lightning Cable (JR-S-CL36M)' },
    ...
    'soundcore-a25i-earbuds': { ar: 'سماعة انكر ساوندكور A25i', en: 'Anker Soundcore A25i' },
...
/**
 * Get bilingual product names for warranty-record display
 */
export function getProductName(productId: string): { ar: string; en: string } {
    const productName = PRODUCT_NAMES[productId] || { ar: 'منتج كايرو فولت', en: 'CairoVolt Product' };

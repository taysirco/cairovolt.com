        ...
        <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 pt-10 md:pt-16 pb-8" dir={isRTL ? 'rtl' : 'ltr'}>
            <div className="container mx-auto px-4">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <div className="mb-3 md:mb-4">
                            <Image
                                ...
                                height={89}
                                loading="lazy"
                                className="object-contain h-12 md:h-14 w-auto dark:[filter:brightness(0)_invert(1)]"
                            />
                        </div>
                ...
                <div className="border-t border-gray-200 dark:border-gray-800 pt-6 pb-4">
                    <p className="text-xs text-gray-400 dark:text-gray-500 leading-relaxed text-center max-w-4xl mx-auto" itemScope itemType="https://schema.org/Organization">

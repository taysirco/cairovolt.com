            ...
            >
                ...
                {items.length > 0 && (
                    <div className="p-4 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
                        ...
                        {/* خيار ثانوي أنيق جنب «إتمام الطلب» — يقفل السلة ويكمل التصفح */}
                        <button
                            onClick={() => setIsOpen(false)}
                            className="mt-2.5 w-full py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40 text-gray-700 dark:text-gray-200 font-bold text-sm hover:bg-gray-100 dark:hover:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600 transition-all active:scale-95 flex items-center justify-center gap-2"
                        >
                            ...
                            {isRTL ? 'أكمل التسوق' : 'Continue Shopping'}
                        </button>
                    </div>
                )}
            </div>

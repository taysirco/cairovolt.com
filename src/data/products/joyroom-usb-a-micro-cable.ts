...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">This cable does NOT work with iPhone, Samsung S26/S25, or any USB-C device. Check your device's charging port before ordering. If it's oval-shaped (USB-C), you need a different cable.</p></div>`,
            ...
            ar: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">الباور بانك والسماعة البلوتوث وماكينة الحلاقة وتابلت الأولاد لسه بيشتغلوا بـ Micro USB — والكابلات الرخيصة بتبوظ في أسابيع. كابل <strong>جوي روم Micro USB</strong> بيدّي <strong>2.4 أمبير كاملة</strong> مع TPE متين. بـ <strong>44 جنيه</strong>، ده كابل الخدمة اللي كل بيت مصري محتاجه.</p></div>

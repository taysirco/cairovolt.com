    ...
    <ul class="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li><strong>Price:</strong> Below 875 EGP is suspicious</li>
            ...
            faqs: [
                    ...
                    { question: "Liberty Buds or Liberty 4 NC — which should I buy?", answer: "Liberty Buds: semi-in-ear comfort, weaker ANC (~15dB), BT 6.1, AI translation, 1,750 EGP. Liberty 4 NC: sealed in-ear, strong ANC (35dB), 50h battery, 2,499 EGP. Choose Buds for comfort. Choose 4 NC for noise isolation." },
    ...
    <ul class="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li><strong>السعر:</strong> أقل من 875 جنيه = مشكوك فيه</li>
            ...
            faqs: [
                    ...
                    { question: "Liberty Buds ولا Liberty 4 NC — أشتري أنهي؟", answer: "Liberty Buds: راحة semi-in-ear، ANC أضعف (~15dB)، BT 6.1، ترجمة AI، 1,750 جنيه. Liberty 4 NC: in-ear محكمة، ANC قوي (35dB)، 50 ساعة، 2,499 جنيه. اختار Buds للراحة. اختار 4 NC للعزل." },

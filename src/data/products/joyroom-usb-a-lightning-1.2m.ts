...
export const joyroom_usb_a_lightning_1_2m = {
        ...
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">The <strong>1.2m Lightning cable</strong> solves Egypt's #1 cable complaint: too short to reach from wall outlet to bed. <strong>2.4A + 36-month warranty + nylon build</strong>. Tested in 4 Egyptian car models. At 114 EGP for 3 years = 0.10 EGP/day.</p></div>
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">USB-A to Lightning only. Does NOT work with iPhone 17/16/15 (USB-C) and does NOT support PD fast charging. For fast charging, use a USB-C to Lightning cable.</p></div>`,
            ...
            ar: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">كابل <strong>Lightning 1.2 متر</strong> بيحل مشكلة مصر الأولى مع الكابلات: قصير ومبيوصلش من البريزة للسرير. <strong>2.4 أمبير + ضمان 36 شهر + بناء نايلون</strong>. مجرّب في 4 موديلات عربيات مصرية. بـ 114 جنيه لـ 3 سنين = 0.10 جنيه/يوم.</p></div>

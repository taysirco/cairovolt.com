...
export const anker_soundcore_r50i = {
        ...
        gtin: "194644126100", gtin13: "0194644126100", mpn: "A3949", price: 950, originalPrice: 1300, stock: 856, featured: false, status: "active",
        images: [
...
<p class="text-gray-700 leading-relaxed text-lg">"The R50i is Anker's entry point — and what an entry point it is. At 950 EGP, you get 10mm drivers, BassUp technology, 30-hour battery, AI ENC for calls, and the full Soundcore app experience. The in-ear design with silicone tips provides passive noise isolation that's surprisingly effective on the Metro. No, it doesn't have ANC like the <a href='/en/anker/audio/anker-soundcore-r50i-nc' class='text-blue-600 hover:underline'>R50i NC</a>, but the silicone seal blocks a lot of ambient noise naturally. The sound quality punches above budget expectations. If you want maximum value, this is where you start. If you want ANC, step up to the R50i NC. If you want maximum comfort, choose the <a href='/en/anker/audio/anker-soundcore-k20i' class='text-blue-600 hover:underline'>K20i</a>."<br><span class="font-bold block mt-2">✍️ CairoVolt Tech Team</span> CairoVolt return rate: <strong>only 0.7%</strong> across 500+ units sold.</p></div>
<div class="product-details">
<section><h2 class="text-2xl font-bold mb-2">Soundcore R50i: The Value Champion</h2>
<p class="text-gray-700">At 950 EGP, the Soundcore R50i delivers what many earbuds at twice the price can't: reliable sound, reliable battery, and reliable calls. The <strong>10mm BassUp drivers</strong> provide solid bass and clear mids. The Soundcore app unlocks 22 EQ presets and an 8-band custom equalizer. For everyday commuting, music, podcasts, and calls — the Soundcore R50i does everything competently.</p></section>
...
<tr class="bg-gray-50"><td class="p-2 border">Price (Egypt)</td><td class="p-2 border">EGP 950</td></tr>
...
<p class="text-gray-600 mt-3"><strong>Skip the R50i if:</strong> You need Active Noise Cancellation → get the <a href='/en/anker/audio/anker-soundcore-r50i-nc' class='text-blue-600 hover:underline'>Soundcore R50i NC</a>. You prefer open/semi-in-ear fit → get the <a href='/en/anker/audio/anker-soundcore-k20i' class='text-blue-600 hover:underline'>Soundcore K20i</a>.</p>
</div>

...
export const anker_a8050_usb_c_cable = {
        ...
        gtin: "0194644146917", gtin13: "0194644146917", mpn: "A8050", price: 570, originalPrice: 670, stock: 540, featured: false, status: "active",
        images: [
            ...
            { id: "img_2", url: "/products/anker/anker-a8050-usb-c-cable/anker-a8050-usb-c-to-usb-c-cable-braided-nylon-cairovolt.webp", alt: "Anker A8050 USB-C to USB-C cable braided nylon - Egypt - CairoVolt", order: 1, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_3", url: "/products/anker/anker-a8050-usb-c-cable/anker-a8050-usb-c-connector-detail-gold-plated-durable.webp", alt: "كابل انكر USB-C بتصميم نايلون مضفر - كايرو فولت", order: 2, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_4", url: "/products/anker/anker-a8050-usb-c-cable/anker-a8050-usb-c-cable-connected-to-laptop-charging.webp", alt: "Anker A8050 cable connected to iPhone 17 and charger - CairoVolt", order: 3, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_5", url: "/products/anker/anker-a8050-usb-c-cable/anker-a8050-cable-flexibility-bend-test-reinforced-stress.webp", alt: "Anker A8050 bend test 35000 cycles certified - CairoVolt", order: 4, isPrimary: false, width: 1080, height: 1080 },
...
<div class="quick-answer">
    <p class="text-gray-800 leading-relaxed">Unlike cheap cables from el-Ataba that die within weeks, the Anker A8050 survives <strong>35,000+ bend cycles</strong> with braided nylon shielding. At <strong>100W PD 3.0</strong>, it charges phones, tablets, AND laptops at max speed. The 1.8m length reaches from any Egyptian wall outlet to your bed. 18-month warranty. Available at <strong>EGP 570</strong> with CairoVolt warranty.</p>
</div>

<div class="product-summary"><h3 class="font-bold mb-2">The Bottom Line:</h3><ul class="list-none space-y-1">
<li>🔌 <strong>100W PD Charging:</strong> Charges laptops, phones, tablets at max speed.</li>
<li>🧬 <strong>35,000 Bend Cycles:</strong> Braided nylon survives years of daily use.</li>
<li>📏 <strong>1.8m Length:</strong> Long enough for bedside charging, short enough to avoid tangles.</li>
<li>📊 <strong>480Mbps Data:</strong> Fast file transfer between devices.</li>
...
<li>📱 <strong>Samsung Galaxy S26 Ultra:</strong> 45W Super Fast via PD 3.0.</li>
<li>💻 <strong>MacBook Air M3:</strong> Full speed 67W laptop charging.</li>
<li>📱 <strong>iPad Pro M4:</strong> 35W fast charge via USB-C PD.</li>
<li>📱 <strong>Google Pixel 9 Pro:</strong> 27W PD fast charge.</li>
</ul></div>
...
`,
            ...
            ar: {
                name: "كابل أنكر USB-C (A8050) | 100 واط PD | نايلون مضفر | ضمان 18 شهر",
                shortDescription: "🔌 100 واط PD | 🧬 نايلون مضفر (35,000 دورة ثني) | 📊 نقل بيانات 480Mbps | 📏 طول 1.8 متر | 🔥 PD 3.0",
                description: `
<div class="quick-answer">
    <p class="text-gray-800 leading-relaxed">على عكس كابلات العتبة اللي بتموت في أسابيع، أنكر A8050 بيستحمل <strong>35,000+ دورة ثني</strong> بغطاء نايلون مضفر. ب<strong>100 واط PD 3.0</strong>، بيشحن موبايلات وتابلت ولابتوبات بأقصى سرعة. طول 1.8 متر بيوصل من أي بريزة للسرير. ضمان 18 شهر. بسعر <strong>570 جنيه</strong> مع ضمان كايرو فولت.</p>
</div>

<div class="product-summary"><h3 class="font-bold mb-2">أهم المميزات:</h3><ul class="list-none space-y-1">
<li>🔌 <strong>100 واط PD:</strong> يشحن لابتوبات وموبايلات وتابلت بأقصى سرعة.</li>
<li>🧬 <strong>35,000 دورة ثني:</strong> نايلون مضفر بيستحمل سنين استخدام يومي.</li>
<li>📏 <strong>1.8 متر:</strong> طويل كفاية للسرير، قصير كفاية ضد التشابك.</li>
...
<li>📱 <strong>سامسونج S26 الترا:</strong> 45 واط سوبر فاست عبر PD 3.0.</li>
<li>💻 <strong>ماك بوك اير M3:</strong> شحن لابتوب 67 واط بالسرعة الكاملة.</li>
<li>📱 <strong>ايباد برو M4:</strong> شحن سريع 35 واط عبر USB-C PD.</li>
<li>📱 <strong>جوجل بيكسل 9 برو:</strong> شحن سريع 27 واط PD.</li>
</ul></div>
...
`,
                features: ["🔌 100 واط PD 3.0", "🧬 35,000 دورة ثني", "📏 1.8 متر نايلون مضفر", "📊 480Mbps بيانات", "🛡️ موصلات مقواة", "🏆 ضمان 18 شهر", "🔒 معتمد MFi + CE → معايير السلامة العالمية", "🛡️ اختبار 10,000+ ثنية — بيعيش 6 أضعاف العادي"],
                ...
                faqs: [
                    ...
                    { question: "الضمان بيغطي إيه؟", answer: "ضمان أنكر 18 شهر بيغطي التهري وعطل الموصل وعيوب الشحن. لو الكابل باظ في الاستخدام العادي، كلّم CairoVolt للاستبدال مجاناً." }
                ]
            }
        },
        meta: { keywords: "أنكر a8050, أنكر usb-c cable, أنكر cable type c, أنكر usb type c, كابل انكر usb-c, كابل شحن 100 واط, وصله انكر, أنكر braided cable, أنكر charging cable, أنكر fast charge cable, أنكر iphone cable egypt, أنكر best cable egypt 2026, أنكر cod egypt cable, أنكر durable cable, افضل كابل شحن انكر, سعر كابل انكر, أنكر usb-c 100w cable", mainTerm: "anker usb-c 100w cable" },
        expertOpinion: { en: "This cable outlasts every budget option by years. If you charge daily and travel weekly, the A8050 pays for itself in 3 months. Not ideal for desk setups where you need 2m+ length — it's 1.8m max.", ar: "الكابل ده بيعيش أضعاف أي كابل رخيص بسنوات. لو بتشحن يومي وبتسافر أسبوعي، A8050 هيوفر عليك في 3 شهور. مش مثالي لو محتاج كابل طويل للمكتب — أقصى طول 1.8 متر." }
    };

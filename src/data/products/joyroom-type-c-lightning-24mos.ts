...
export const joyroom_type_c_lightning_24mos = {
        ...
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">Unlike cheap cables that throttle at 5W and die within weeks, The <strong>Joyroom USB-C to Lightning 24-month warranty</strong> cable delivers <strong>30W PD fast charging</strong> for iPhone 14/13/12 with double the warranty of standard cables. CairoVolt return rate: <strong>only 0.3%</strong> — the most reliable Lightning cable we sell.</p></div>
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">This is a Lightning cable — it does NOT work with iPhone 17/16/15 (USB-C). Verify your iPhone model before ordering.</p></div>`,
            ...
            ar: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">على عكس الكابلات الرخيصة اللي بتختنق عند 5 واط وبتموت في أسابيع، كابل <strong>جوي روم USB-C لـ Lightning ضمان 24 شهر</strong> بيدّي <strong>30 واط PD شحن سريع</strong> للايفون 14/13/12 بضعف ضمان الكابلات العادية. نسبة إرجاع CairoVolt: <strong>0.3% بس</strong> — أكثر كابل Lightning موثوق عندنا.</p></div>

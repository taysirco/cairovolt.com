...
`,
                features: ["🔋 26,800 مللي أمبير (96.48Wh) — 5 شحنات ايفون", "🔌 3 منافذ USB-A (PowerIQ 2.0)", "✈️ أكبر سعة مسموحة للطائرة", "🔄 شحن مزدوج 6 ساعات", "🛡️ حماية MultiProtect 10 طبقات", "🏆 ضمان 24 شهر", "🔒 معتمد FCC + CE + IATA → معايير السلامة العالمية", "🔒 حماية MultiProtect من 11 نقطة"],

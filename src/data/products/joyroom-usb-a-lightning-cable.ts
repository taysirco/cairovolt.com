...
export const joyroom_usb_a_lightning_cable = {
        ...
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">Still using an old USB-A charger with your iPhone? The <strong>Joyroom USB-A to Lightning</strong> delivers full <strong>2.4A charging</strong> — no "accessory not supported" errors. At <strong>43 EGP</strong> (0.12 EGP/day over a year), it's the cheapest original iPhone cable in Egypt.</p></div>
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">This cable does NOT work with iPhone 17/16/15 (USB-C). It is for Lightning-port iPhones only. Check your phone's charging port before ordering.</p></div>`,
            ...
            ar: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">لسه بتستخدم شاحن USB-A قديم مع ايفونك؟ كابل <strong>جوي روم USB-A لايتنينج</strong> بيدّي <strong>2.4 أمبير كاملة</strong> — مفيش رسالة "ملحق غير مدعوم". بـ <strong>43 جنيه</strong> (0.12 جنيه/يوم على مدار سنة)، أرخص كابل ايفون أصلي في مصر.</p></div>

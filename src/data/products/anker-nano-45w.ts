// Product: anker-nano-45w

export const anker_nano_45w = {
        slug: "anker-nano-45w",
        sku: "ANK-WC-45W",
        brand: "Anker",
...
`,
        ...
        meta: { keywords: "شاحن انكر 45 واط, شاحن انكر للابتوب, anker 45w charger, anker fast charger, anker wall charger egypt, anker usb c charger, anker gan charger, anker iphone charger egypt, anker samsung charger, anker best charger egypt 2026, anker cod egypt charger, افضل شاحن انكر, سعر شاحن انكر, شاحن انكر اصلي مصر, anker charger egypt price, شاحن سريع ايفون, شاحن GaN مصر", mainTerm: "شاحن انكر 45 واط" },
        expertOpinion: {
        ...
        relatedProducts: ["anker-521-powerhouse",
        "anker-a2147-gan-charger-30w",
        "anker-nano-45w-smart-display-charger",
        "anker-powercore-26800",
        "anker-737-powerbank",
        "anker-powerline-usb-c-usb-c", 'anker-powerport-25w']
    };

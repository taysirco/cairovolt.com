...
export const anker_powerline_usb_c_lightning = {
        ...
        images: [
            ...
            { id: "img_2", url: "/products/anker/anker-powerline-usb-c-lightning/anker-powerline-usb-c-to-lightning-mfi-cable-cairovolt-egypt.webp", alt: "كابل انكر USB-C إلى لايتنينج MFi معتمد نايلون مضفر - A8612H11 - كايرو فولت مصر", order: 1, isPrimary: false, width: 1200, height: 1500 },
...
`,
                features: ["✅ معتمد MFi من أبل", "⚡ شحن سريع 30 واط", "💪 يتحمل 35,000+ ثني", "📱 ايفون 14/13/12/11", "🚗 متوافق CarPlay", "🏆 ضمان 18 شهر", "🛡️ اختبار 10,000+ ثنية — بيعيش 6 أضعاف العادي", "🔒 حماية MultiProtect — ضد الماس والتيار الزائد"],
        ...
        meta: { keywords: "كابل انكر ايفون, وصلة انكر للايفون, وصله انكر, وصلة انكر ايفون, كابل انكر تايب سي, anker lightning cable, anker lightning, iphone charger anker, anker charging cable, anker fast charge cable, anker usb c cable, anker best cable egypt 2026, anker cod egypt cable, anker durable cable, افضل كابل شحن انكر, سعر كابل انكر", mainTerm: "كابل انكر ايفون" },
        expertOpinion: {

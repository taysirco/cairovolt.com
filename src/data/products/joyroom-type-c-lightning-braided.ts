...
export const joyroom_type_c_lightning_braided = {
        ...
        translations: {
            en: {
                ...
                shortDescription: "🔌 30W PD Fast Charging | 💪 25,000+ Bends | 🧵 Double-Braided Nylon + Aluminum | 📱 iPhone 14/13/12",
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">Lightning cable only — does NOT work with iPhone 17/16/15 (USB-C). If you want the same braided quality for USB-C, see our Joyroom USB-C cables.</p></div>`,
                features: ["⚡ 30W PD fast charging", "✨ MFi certified", "✨ Braided nylon design", "📱 iPhone 14/13/12/11 compatible", "✨ 1m length", "🏆 18-month warranty", "🛡️ 10K Bend-Tested Braided Nylon — 2-Year Lifespan", "🔒 Smart Chip Protection — Anti Short-Circuit"],
                metaTitle: "Joyroom Lightning Braided ⚡ 24% OFF | iPhone Fast Charge",
                metaDesc: "Buy joyroom USB-C to Lightning Cable - 30W fast charging for iPhone 14/13/12. MFi certified. Best price Egypt. ✓ COD ✓ Fast Delivery Egypt.",
                faqs: [
...
<div class="product-details"><section><h2 class="text-2xl font-bold mb-2 text-gray-900">MFi: ليه مهم</h2><p class="text-gray-700"><strong>شريحة مصادقة C94 من ابل</strong> يعني ايفونك بيثق في الكابل ده تماماً. مفيش رسائل خطأ. مفيش انقطاع شحن. مفيش خطر تلف بطارية من تيار غير منظم.</p></section><section><h2 class="text-2xl font-bold mb-2 text-gray-900">مجدول مزدوج = ضعف العمر</h2><p class="text-gray-700">كابلات المجدول الأحادي لسه بتتلف مع الوقت. <strong>النايلون المجدول المزدوج</strong> مع <strong>موصلات ألومنيوم</strong> بيعمل درع بيستحمل اللف المحكم والرمي في الشنط والسحب من زوايا كل يوم. في حرارة صيف مصر اللي بتوصل 45°م، الموصلات الرخيصة بتنصهر — الألومنيوم هنا بيستحمل.</p></section></div>
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ تحذير للمشتري:</h3><p class="text-gray-700">كابل Lightning بس — مش بيشتغل مع ايفون 17/16/15 (USB-C). لو عايز نفس جودة النايلون لـ USB-C، شوف كابلات جوي روم USB-C بتاعتنا.</p></div>`,
                features: ["⚡ شحن سريع 30 واط PD", "✨ معتمد MFi", "✨ تصميم نايلون", "✨ متوافق ايفون 14/13/12/11", "✨ طول 1 متر", "🏆 ضمان 18 شهر", "🛡️ نايلون مضفر 10K ثنية — عمر سنتين", "🔒 شريحة حماية ذكية — ضد الماس"],
                metaTitle: "كابل جوي روم ايفون نايلون ⚡ خصم 24% | شحن سريع | COD مصر",
                metaDesc: "اشتري كابل جوي روم USB-C إلى Lightning - شحن سريع 30 واط للايفون 14/13/12. معتمد MFi. أفضل سعر مصر. ✓ ضمان ✓ توصيل سريع مصر.",
                faqs: [
                    ...
                    { question: "الكابل هيعيش قد إيه؟", answer: "اتختبر لـ 25,000+ دورة ثني. النايلون المضفر بيتحمل السحب العنيف + حرارة صيف مصر 45°م. الرأس المدرع بألمنيوم مش بتنكسر." }
                ]
            }
        },
        expertOpinion: {

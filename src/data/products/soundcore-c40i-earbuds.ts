    ...
    <ul class="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li><strong>Price:</strong> Below 1,525 EGP is suspicious</li>
            ...
            faqs: [
                    ...
                    { question: "Does C40i have ANC?", answer: "No — C40i is open-ear with no ANC. This is by design for safety (hear traffic while running) and productivity (hear colleagues at work). For ANC: P30i (42dB, 1,200) or Liberty 4 NC (2,570)." },
                    { question: "Does C40i support LDAC?", answer: "No — C40i uses AAC and SBC codecs only. For LDAC: Liberty 4 NC (2,570 EGP) or Liberty 5 (4,651 EGP)." },
    ...
    <ul class="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li><strong>السعر:</strong> أقل من 1,525 جنيه = مشكوك فيه</li>
            ...
            faqs: [
                    ...
                    { question: "C40i فيها ANC؟", answer: "لأ — C40i أذن مفتوحة بدون ANC. ده بالتصميم للأمان (اسمع المرور وانت بتجري) والإنتاجية (اسمع الزملاء في الشغل). لو عايز ANC: P30i (42dB، 1,200) أو Liberty 4 NC (2,570)." },
                    { question: "C40i فيها LDAC؟", answer: "لأ — C40i بتدعم AAC وSBC بس. لو عايز LDAC: Liberty 4 NC (2,570 جنيه) أو Liberty 5 (4,651 جنيه)." },

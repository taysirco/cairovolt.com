    ...
    <ul class="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li><strong>Price:</strong> Below 1,525 EGP is suspicious</li>
            ...
            faqs: [
                    ...
                    { question: "Does C40i support LDAC?", answer: "No — C40i uses AAC and SBC codecs only. For LDAC: Liberty 4 NC (2,570 EGP) or Liberty 5 (3,199 EGP)." },
    ...
    <ul class="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li><strong>السعر:</strong> أقل من 1,525 جنيه = مشكوك فيه</li>
            ...
            faqs: [
                    ...
                    { question: "C40i فيها LDAC؟", answer: "لأ — C40i بتدعم AAC وSBC بس. لو عايز LDAC: Liberty 4 NC (2,570 جنيه) أو Liberty 5 (3,199 جنيه)." },

...
export const soundcore_select_4_go_speaker = {
 ...
 { id: "img_4", url: "/products/anker/soundcore-select-4-go-speaker/soundcore-select-4-go-speaker-retail-box-authentic-cairovolt.webp", alt: "مكبر صوت ساوندكور Select 4 Go A31X1 علبة المنتج - كايرو فولت", order: 3, isPrimary: false, width: 1080, height: 1080 },
    ...
    <section>
        <h2 class="text-2xl font-bold mb-3">IP67 and floating-design claims</h2>
        <p class="text-gray-700 leading-relaxed">Soundcore lists Select 4 Go with an IP67 rating and a floating design. Follow the exact depth, duration, water type, port and drying instructions in the current manual. Water and dust resistance can diminish with wear and does not cover every exposure, impact, salt water, chemical, steam or charging-while-wet scenario.</p>
        <p class="text-gray-700 leading-relaxed">Soundcore's published battery figure applies to its stated volume and test settings. Actual runtime and Bluetooth stability vary with volume, EQ, distance, interference, temperature and battery age. Confirm the supplied charging cable, USB-C input and carrying strap in the current package.</p>
    </section>
    <section>
        <h2 class="text-2xl font-bold mb-3">5W Personal Audio: Not a Party Speaker</h2>
        <p class="text-gray-700 leading-relaxed">The manufacturer lists 5W output, so compare the intended room or outdoor area and listening distance with a larger speaker if volume is a priority. The Soundcore app offers EQ controls when supported by the current app, firmware and operating system; preferred sound remains subjective.</p>
        <p class="text-gray-700 leading-relaxed">TWS pairing requires two compatible Select 4 Go units and may depend on matching firmware. Verify the current specification for microphone and AUX availability rather than assuming calling or wired-audio support. Actual stereo effect depends on placement and listening position.</p>
    </section>
</div>
...
<div class="buyer-warning"><h3 class="font-bold mb-3 text-red-700 text-lg">⚠️ Buyer Warning:</h3><p class="text-gray-700">Before paying, match model <strong>A31X1</strong>, the printed ratings, ports or connectors and package contents with the supplied unit and current manufacturer documentation. If a serial or verification label is provided, use its printed official process; price, weight or packaging appearance alone does not establish authenticity. Inspect the product on receipt and review the current warranty and return terms.</p></div>`,
        ...
        ar: {
            ...
            description: `<div class="product-details">
    <section>
        <h2 class="text-2xl font-bold mb-3">تصنيف IP67 وبيان التصميم الطافي</h2>
        <p class="text-gray-700 leading-relaxed">تدرج ساوندكور Select 4 Go بتصنيف IP67 وتصميم طافٍ. اتبع حدود العمق والمدة ونوع المياه والمنفذ والتجفيف في الدليل الحالي. قد تتراجع مقاومة الماء والغبار مع الاستخدام، ولا يشمل التصنيف تلقائياً كل صدمة أو مياه مالحة أو مواد كيميائية أو بخار أو شحن وهي مبتلة.</p>
        <p class="text-gray-700 leading-relaxed">ينطبق رقم البطارية المنشور من ساوندكور على مستوى الصوت وإعدادات الاختبار المذكورة. تختلف المدة وثبات البلوتوث حسب الصوت وEQ والمسافة والتداخل والحرارة وعمر البطارية. تحقق من كابل الشحن ومدخل USB-C وحزام الحمل في العبوة الحالية.</p>
    </section>
    <section>
        <h2 class="text-2xl font-bold mb-3">5 واط صوت شخصي: مش سبيكر حفلات</h2>
        <p class="text-gray-700 leading-relaxed">تدرج الشركة خرجاً مصنفاً 5 واط، لذلك قارن مساحة المكان والمسافة والضوضاء المحيطة بسبيكر أكبر إذا كان مستوى الصوت أولوية. يقدم تطبيق ساوندكور تحكم EQ عندما يدعمه التطبيق والفيرموير ونظام التشغيل الحالي؛ تفضيل الصوت شخصي.</p>
        <p class="text-gray-700 leading-relaxed">يحتاج ربط TWS وحدتين متوافقتين وقد يعتمد على تطابق الفيرموير. راجع المواصفات الحالية للمايك ومدخل AUX ولا تفترض دعم المكالمات أو الصوت السلكي من وجود البلوتوث أو IP67. يختلف تأثير الستيريو حسب موضع السماعتين والمستمع.</p>
    </section>
</div>
...
<div class="buyer-warning"><h3 class="font-bold mb-3 text-red-700 text-lg">⚠️ تحذير للمشتري:</h3><p class="text-gray-700">قبل الدفع، طابق رقم الموديل <strong>A31X1</strong> والتصنيفات والمنافذ أو الموصلات ومحتويات العبوة مع الوحدة الموردة ووثائق الشركة الحالية. إذا توفر رقم تسلسلي أو ملصق تحقق فاستخدم العملية الرسمية المطبوعة؛ لا يثبت السعر أو الوزن أو شكل العبوة وحده الأصالة. افحص المنتج عند الاستلام وراجع شروط الضمان والاسترجاع الحالية.</p></div>`,
    ...
    meta: { keywords: "ساوندكور select 4 go, select 4 go waterproof, select 4 go float, ساوندكور pool speaker, select 4 go egypt, jbl go 4 alternative, ساوندكور سيليكت 4 جو, سبيكر ضد المية, سبيكر بتطفو, سعر select 4 go مصر", mainTerm: "soundcore select 4 go" },

    expertOpinion: {
        en: "Select 4 Go is a compact 5W option with manufacturer-listed IP67, floating design, app EQ and TWS. Compare water limits, battery conditions, port features and listening distance; actual runtime and sound depend on use.",
        ar: "Select 4 Go خيار صغير بخرج 5 واط مع IP67 وتصميم طافٍ وEQ وTWS وفق مواصفات الشركة. قارن حدود الماء وشروط البطارية والمنافذ ومسافة الاستماع؛ تختلف المدة والصوت حسب الاستخدام."
    }
};

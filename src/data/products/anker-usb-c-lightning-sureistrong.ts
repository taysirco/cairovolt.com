...
<div class="device-compatibility">
    ...
    <ul class="list-disc list-inside text-gray-700">
        <li>📱 <strong>iPhone 14/13/12/11:</strong> 30W PD fast charging.</li>
        <li>📱 <strong>iPad (Lightning):</strong> Fast USB-C PD charging.</li>
        <li>🎧 <strong>AirPods Pro 1 / AirPods:</strong> Lightning charging.</li>
        <li>🚗 <strong>Apple CarPlay:</strong> Stable connection.</li>
        <li>❌ <strong>NOT for iPhone 17/16/15:</strong> Use USB-C cables.</li>
    </ul>
</div>
`,
                ...
                faqs: [
                    ...
                    { question: "Does SureIStrong work with iPhone 15/16/17?", answer: "No — iPhone 15/16/17 use USB-C ports. SureIStrong is Lightning (iPhone 14 and older). For USB-C iPhones, check the Anker Zolo USB-C to USB-C braided cable (A8060)." },
...
<div class="device-compatibility">
    ...
    <ul class="list-disc list-inside text-gray-700">
        <li>📱 <strong>ايفون 14/13/12/11:</strong> شحن سريع 30 واط PD.</li>
        <li>📱 <strong>ايباد (Lightning):</strong> شحن سريع USB-C PD.</li>
        <li>🎧 <strong>ايربودز برو 1 / ايربودز:</strong> شحن Lightning.</li>
        <li>❌ <strong>مش لايفون 17/16/15:</strong> دول USB-C.</li>
    </ul>
</div>
`,
                features: ["⚡ شحن سريع 30 واط PD", "✨ معتمد MFi", "✨ تصميم ناعم مقاوم للتشابك", "✨ طلاء مقاوم للبقع", "✨ متوافق ايفون 14/13/12/11", "✨ طول 1.8 متر", "🏆 ضمان انكر 24 شهر", "🛡️ اختبار 10,000+ ثنية — بيعيش 6 أضعاف العادي"],
                ...
                faqs: [
                    ...
                    { question: "الكابل ده بيشتغل مع ايفون 15/16/17؟", answer: "لا — ايفون 15/16/17 بيستخدموا USB-C. SureIStrong كابل Lightning (ايفون 14 وأقدم). لأيفونات USB-C، شوف كابل أنكر زولو المضفر (A8060) من USB-C إلى USB-C." },

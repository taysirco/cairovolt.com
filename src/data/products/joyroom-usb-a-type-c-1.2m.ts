...
export const joyroom_usb_a_type_c_1_2m = {
        ...
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">Unlike cheap cables that throttle at 5W and die within weeks, The <strong>1.2m USB-A to Type-C</strong> cable bridges old chargers to new phones with <strong>extra reach</strong>. 3A fast charging for iPhone 17/Samsung S26 from your existing USB-A charger. At <strong>214 EGP with 18-month warranty</strong>, it's the premium bridge cable.</p></div>

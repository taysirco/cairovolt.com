...
export const joyroom_usb_a_type_c_1_2m = {
        ...
        status: "active",
        images: [
            { id: "img_1", url: "/products/joyroom/joyroom-usb-a-type-c-1.2m/joyroom-joyroom-usb-a-type-c-1.2m-egypt-cairo-1.webp", alt: "Joyroom USB-A Type-C 1.2m Cable Egypt", order: 0, isPrimary: true, width: 1080, height: 1080 },
            { id: "img_2", url: "/products/joyroom/joyroom-usb-a-type-c-1.2m/joyroom-joyroom-usb-a-type-c-1.2m-egypt-cairo-2.webp", alt: "كابل جوي روم USB-A Type-C 1.2 متر مصر", order: 1, isPrimary: false, width: 1080, height: 1080 }
        ],
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">The <strong>1.2m USB-A to Type-C</strong> cable bridges old chargers to new phones with <strong>extra reach</strong>. 3A fast charging for iPhone 17/Samsung S26 from your existing USB-A charger. At <strong>214 EGP with 18-month warranty</strong>, it's the premium bridge cable.</p></div>
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">This cable does NOT support PD fast charging (20W+). Maximum is 3A/15W through USB-A. For full-speed PD charging, use a USB-C to USB-C cable with PD charger.</p></div>`,
            ...
            ar: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">كابل <strong>USB-A لـ Type-C بطول 1.2 متر</strong> بيوصل شواحنك القديمة بموبايلك الجديد بطول إضافي. <strong>3 أمبير شحن سريع</strong> لايفون 17/سامسونج S26 من شاحن USB-A الحالي. بـ <strong>214 جنيه مع ضمان 18 شهر</strong>، كابل الجسر الفاخر.</p></div>
<div class="product-summary"><h3 class="font-bold mb-2">ليه الكابل ده؟</h3><ul class="list-none space-y-1"><li>📏 <strong>1.2 متر:</strong> أطول 20% من الكابلات العادية.</li><li>⚡ <strong>3 أمبير:</strong> أسرع 25% من كابلات 2.4 أمبير.</li><li>🔌 <strong>كابل جسر:</strong> شاحن USB-A قديم → موبايل USB-C جديد.</li><li>🛡️ <strong>ضمان 18 شهر:</strong> بناء فاخر بتغطية ممتدة.</li></ul></div>

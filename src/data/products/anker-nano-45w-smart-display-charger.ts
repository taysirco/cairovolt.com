...
export const anker_nano_45w_smart_display_charger = {
    slug: "anker-nano-45w-smart-display-charger", sku: "ANK-WC-A121D", brand: "Anker", categorySlug: "wall-chargers",
    gtin: "6978252855843", gtin13: "6978252855843", mpn: "A121D", price: 1900, originalPrice: 2700, stock: 450, featured: true, status: "active",
    images: [
        { id: "img_1", url: "/products/anker/anker-nano-45w-smart-display-charger/anker-nano-45w-smart-display-charger-front-180-foldable-white-cairovolt.webp", alt: "Anker Nano 45W Smart Display charger A121D front view with 180° foldable plug and Hi greeting animation on TFT screen", order: 0, isPrimary: true, width: 1080, height: 1080 },
        ...
        { id: "img_7", url: "/products/anker/anker-nano-45w-smart-display-charger/anker-nano-45w-smart-display-four-colors-white-blue-orange-black-cairovolt.webp", alt: "Anker Nano A121D 45W Smart Display charger available in 4 colors white blue orange black with animated AI display", order: 6, isPrimary: false, width: 1080, height: 1080 },
        { id: "img_8", url: "/products/anker/anker-nano-45w-smart-display-charger/anker-nano-45w-internal-gan-chip-exploded-view-technology-cairovolt.webp", alt: "Anker Nano A121D 45W GaN charger internal exploded view showing GaN chip layers and smart display circuit board", order: 7, isPrimary: false, width: 1080, height: 1080 },
        ...
        { id: "img_10", url: "/products/anker/anker-nano-45w-smart-display-charger/anker-nano-45w-a121d-box-back-full-specs-100-240v-input-cairovolt.webp", alt: "Anker Nano A121D 45W smart display charger box back with full specifications model number barcode and safety certifications", order: 9, isPrimary: false, width: 1080, height: 1080 },
    ...
    relatedProducts: ["anker-a2147-gan-charger-30w", "anker-a2732-charger-35w", "anker-a2741-charger-30w", "anker-a8050-usb-c-cable", "anker-powerline-usb-c-usb-c"],
    translations: {
        en: {
...
`,
            ...
            faqs: [
                ...
                { question: "Can this charge a MacBook Air?", answer: "Yes — 45W is the perfect match for MacBook Air M3/M4 which draws 30-45W. Full charge in about 2 hours. For MacBook Pro 14\", it works as a travel charger at reduced speed." },
                { question: "What is Care Mode and how do I activate it?", answer: "Double-tap the charger to switch from Auto to Care mode. Care Mode is TÜV Rheinland certified — it slows charging overnight to protect your battery's lifespan. The charger stays 36°F cooler and your phone battery 9°F cooler. Perfect for overnight charging." },
                { question: "What makes the 180° foldable plug special?", answer: "Unlike standard foldable plugs that only fold flat (0° or 90°), this one rotates a full 180°. This means it fits tight wall outlets, power strips, and behind furniture where normal chargers won't fit. Tested at 1000+ fold cycles." },
                { question: "Does the 18-month warranty cover the display?", answer: "Yes. Anker's 18-month warranty covers the display, USB-C port, charging inconsistencies, and overheating. Contact CairoVolt for free replacement within warranty period." }
            ]
        },
        ar: {
...
`,
            ...
            faqs: [
                ...
                { question: "ينفع يشحن ماك بوك اير؟", answer: "أيوه — 45 واط مثالي لماك بوك اير M3/M4 اللي بيسحب 30-45 واط. شحن كامل في حوالي ساعتين. لماك بوك برو 14 بوصة بيشتغل كشاحن سفر بسرعة أقل." },
                { question: "إيه هو وضع العناية وإزاي أفعّله؟", answer: "انقر مرتين على الشاحن عشان تتحول من Auto لـ Care. وضع العناية معتمد من TÜV Rheinland — بيبطّئ الشحن بالليل عشان يحمي عمر البطارية. الشاحن بيفضل أبرد بـ 20°C والبطارية أبرد بـ 5°C. مثالي للشحن الليلي." },
                { question: "إيه المميز في القابس 180°؟", answer: "بخلاف القوابس العادية اللي بتتطوي مسطح بس (0° أو 90°)، ده بيلف 180° كاملة. يعني بيتركب في الفيش الضيقة ومشتركات الكهرباء وورا الأثاث في أماكن الشواحن العادية مش هتعرف تدخل فيها. متجرب 1000+ مرة طي." },
                { question: "ضمان الـ 18 شهر بيغطي الشاشة؟", answer: "أيوه. ضمان أنكر 18 شهر بيغطي الشاشة ومنفذ USB-C وعدم ثبات الشحن والسخونة. كلّم CairoVolt للاستبدال مجاناً خلال فترة الضمان." }
            ]
        }
    },
    meta: { keywords: "anker nano 45w smart display, شاحن انكر 45 واط شاشة ذكية, anker a121d, anker nano charger 45w smart display 180 foldable, شاحن انكر نانو شاشة, anker 45w gan charger display, شاحن 45 واط بشاشة, anker care mode charger, شاحن انكر بشاشة مصر, anker released a 45w nano charger featuring a smart display, anker launched new nano 45w charger with smart display, شاحن انكر الجديد شاشة, شاحن ايفون 17 سريع, افضل شاحن 45 واط, شاحن انكر قابس قابل للطي, شاحن GaN بشاشة ذكية مصر, anker nano smart display egypt price, شاحن لابتوب وموبايل انكر", mainTerm: "شاحن انكر نانو 45 واط بشاشة ذكية" },
    expertOpinion: { en: "The A121D is Anker's most innovative charger yet. 45W GaN with a smart TFT display, 180° foldable plug, and TÜV-certified Care Mode for overnight protection. Red Dot 2026 winner. iPhone 17 Pro 0→50% in 20 minutes. At 1900 EGP (30% off), it's the smartest charger under 2000 EGP in Egypt.", ar: "الـ A121D أكثر شاحن مبتكر من أنكر. 45 واط GaN بشاشة TFT ذكية وقابس 180° ووضع عناية معتمد من TÜV للحماية الليلية. فائز Red Dot 2026. ايفون 17 برو من 0 لـ 50% في 20 دقيقة. بـ 1900 جنيه (خصم 30%) أذكى شاحن تحت 2000 جنيه في مصر." }
};

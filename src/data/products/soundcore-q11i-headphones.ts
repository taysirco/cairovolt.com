 ...
 { id: "img_4", url: "/products/anker/soundcore-q11i-headphones/soundcore-q11i-headphones-retail-box-authentic-cairovolt.webp", alt: "سماعة ساوندكور Q11i A3005 علبة المنتج - كايرو فولت", order: 3, isPrimary: false, width: 1080, height: 1080 },
    ...
    translations: {
        en: {
            ...
            shortDescription: "40mm BassUp over-ear | NO ANC | 60h battery | 5min=4h fast charge | foldable | replaceable cushions — current CairoVolt warranty terms",
            description: `<div class="product-details">
    <section>
        <h2 class="text-2xl font-bold mb-3">40mm BassUp: Entry Over-Ear Without ANC Premium</h2>
        <p class="text-gray-700 leading-relaxed">Q11i is an over-ear option without active noise cancellation. It uses a listed 40mm dynamic driver with BassUp controls. The cushions provide passive isolation, but the amount varies with fit, seal and noise frequency and should not be treated as a fixed decibel reduction.</p>
        <p class="text-gray-700 leading-relaxed">The Soundcore app provides EQ options for compatible devices. BassUp and other settings can be adjusted to personal preference; perceived bass, detail and balance depend on the recording, codec, fit, volume and selected EQ.</p>
    </section>
    <section>
        <h2 class="text-2xl font-bold mb-3">60h Battery + Replaceable Cushions: Built to Last</h2>
        <p class="text-gray-700 leading-relaxed">The manufacturer lists up to 60 hours of playback and up to 4 hours from a 5-minute charge under its stated test conditions. Actual runtime varies with volume, calls, connection, temperature and battery age. Charging uses USB-C, and the 3.5mm input provides a wired option for compatible sources.</p>
        <p class="text-gray-700 leading-relaxed">The design folds and the ear cushions are listed as detachable and replaceable. Cushion life depends on heat, oils, cleaning and storage rather than a fixed number of months. Bluetooth 5.3 multipoint requires compatible source devices. The listed weight is about 240g; comfort remains personal.</p>
    </section>
</div>
...
<div class="buyer-warning"><h3 class="font-bold mb-3 text-red-700 text-lg">⚠️ Buyer Warning:</h3><p class="text-gray-700">Before paying, match model <strong>A3005</strong>, the printed ratings, ports or connectors and package contents with the supplied unit and current manufacturer documentation. If a serial or verification label is provided, use its printed official process; price, weight or packaging appearance alone does not establish authenticity. Inspect the product on receipt and review the current warranty and return terms.</p></div>`,
            ...
            metaDesc: "Soundcore Q11i wireless headphones in Egypt: 40mm BassUp drivers and up to 60h playtime. Genuine, store warranty and cash on delivery.",
            faqs: [
        ...
        ar: {
            ...
            shortDescription: "40mm BassUp أوفر-إير | بدون ANC | 60 ساعة | 5 دقائق=4 ساعات | قابل للطي | وسائد بديلة — شروط ضمان كايرو فولت الحالية",
            description: `<div class="product-details">
    <section>
        <h2 class="text-2xl font-bold mb-3">40mm BassUp: هيدفون أوفر-إير بدون بريميوم ANC</h2>
        <p class="text-gray-700 leading-relaxed">Q11i هيدفون فوق الأذن بدون عزل ضوضاء نشط، بدرايفر 40mm ديناميكي معلن وتحكم BassUp. توفر الوسائد عزلًا سلبيًا، لكن مقداره يتغير حسب الإحكام والملاءمة وتردد الضوضاء ولا يُعامل كرقم ديسيبل ثابت.</p>
        <p class="text-gray-700 leading-relaxed">يوفر تطبيق ساوندكور خيارات EQ للأجهزة المتوافقة. يمكن ضبط BassUp والإعدادات الأخرى حسب التفضيل الشخصي؛ يتأثر الباس والتفاصيل والتوازن بالتسجيل والكودك والإحكام ومستوى الصوت وإعداد EQ.</p>
    </section>
    <section>
        <h2 class="text-2xl font-bold mb-3">60 ساعة بطارية + وسائد بديلة: مبني ليدوم</h2>
        <p class="text-gray-700 leading-relaxed">تعلن الشركة المصنّعة تشغيلًا يصل إلى 60 ساعة وما يصل إلى 4 ساعات من شحن لمدة 5 دقائق وفق ظروف محددة. يختلف الزمن الفعلي حسب الصوت والمكالمات والاتصال والحرارة وعمر البطارية. يتم الشحن عبر USB-C، ويوفر مدخل 3.5mm خيارًا سلكيًا للمصادر المتوافقة.</p>
        <p class="text-gray-700 leading-relaxed">التصميم قابل للطي والوسائد مدرجة كقطع قابلة للفك والاستبدال. يعتمد عمر الوسائد على الحرارة والزيوت والتنظيف والتخزين وليس عددًا ثابتًا من الشهور. يحتاج Bluetooth 5.3 Multipoint أجهزة مصدر متوافقة. الوزن المعلن نحو 240 جرام، بينما تظل الراحة شخصية.</p>
    </section>
</div>
...
<div class="buyer-warning"><h3 class="font-bold mb-3 text-red-700 text-lg">⚠️ تحذير للمشتري:</h3><p class="text-gray-700">قبل الدفع، طابق رقم الموديل <strong>A3005</strong> والتصنيفات والمنافذ أو الموصلات ومحتويات العبوة مع الوحدة الموردة ووثائق الشركة الحالية. إذا توفر رقم تسلسلي أو ملصق تحقق فاستخدم العملية الرسمية المطبوعة؛ لا يثبت السعر أو الوزن أو شكل العبوة وحده الأصالة. افحص المنتج عند الاستلام وراجع شروط الضمان والاسترجاع الحالية.</p></div>`,
            ...
            metaDesc: "سماعة ساوندكور Q11i اللاسلكية في مصر بدرايفر 40mm BassUp وبطارية حتى 60 ساعة وتصميم قابل للطي. أصلية بضمان متجر ودفع عند الاستلام.",
            faqs: [
    ...
    meta: { keywords: "ساوندكور q11i, انكر q11i, q11i headphones, q11i no anc, q11i 60h battery, ساوندكور q11i egypt, q11i vs q20i, ساوندكور q11i, هيدفون q11i, سعر q11i مصر, q11i بدون anc", mainTerm: "soundcore q11i" },

    expertOpinion: {
        en: "Q11i is a non-ANC over-ear option with a listed 40mm driver, BassUp controls, manufacturer-rated battery up to 60 hours, a foldable design and a 3.5mm input. Compare current device compatibility, package contents, warranty and price with other models before choosing.",
        ar: "Q11i خيار هيدفون فوق الأذن بدون عزل نشط، بدرايفر 40mm معلن وتحكم BassUp وبطارية معلنة حتى 60 ساعة وتصميم قابل للطي ومدخل 3.5mm. قارن التوافق ومحتويات العبوة والضمان والسعر الحالي بالموديلات الأخرى قبل الاختيار."
    }
};

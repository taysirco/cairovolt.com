...
export const anker_powerline_usb_c_usb_c = {
        ...
        images: [
            ...
            { id: "img_2", url: "/products/anker/anker-powerline-usb-c-usb-c/anker-powerline-usb-c-connector-detail-reinforced-joint.webp", alt: "Anker PowerLine USB-C connector detail with reinforced joint stress relief - A8652H11 - CairoVolt", order: 1, isPrimary: false, width: 928, height: 1152 },
...
`,
                features: ["⚡ 60 واط Power Delivery", "📱 ايفون 17 بأقصى 30 واط", "📱 سامسونج S26 سوبر فاست 45 واط", "💻 متوافق ماك بوك اير", "💪 35,000+ ثني", "🏆 ضمان 18 شهر", "🛡️ اختبار 10,000+ ثنية — بيعيش 6 أضعاف العادي", "🔒 حماية MultiProtect — ضد الماس والتيار الزائد"],
                metaTitle: "كابل انكر تايب سي 60 واط ⚡ خصم 9% | ايفون وسامسونج | COD مصر",
        ...
        meta: { keywords: "كابل انكر تايب سي, وصلة انكر تايب سي, كابل USB-C انكر, anker cable egypt, anker charging cable, anker fast charge cable, anker iphone cable egypt, anker best cable egypt 2026, anker cod egypt cable, anker durable cable, افضل كابل شحن انكر, سعر كابل انكر, كابل انكر اصلي مصر, كابل شحن سريع, افضل كابل ايفون", mainTerm: "كابل انكر تايب سي" },
        expertOpinion: {

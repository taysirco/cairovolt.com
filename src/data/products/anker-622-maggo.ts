...
`,
                features: ["🧲 شحن MagSafe لاسلكي 7.5 واط", "📱 حامل مدمج قابل للطي", "🪨 نحيف جداً (13مم)", "🔌 USB-C شحن في الاتجاهين", "🔄 شحن تمريري", "🛡️ ضمان انكر 18 شهر", "🔒 حماية MultiProtect من 11 نقطة", "✈️ مسموح على الطائرة (<100Wh)"],

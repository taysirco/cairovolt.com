...
`,
                features: ["🚗 24 واط منفذين USB (12واط×2)", "⚡ شحن ذكي PowerIQ", "📱 اشحن جهازين", "🔌 12/24فولت كل السيارات", "💡 مؤشر LED هادي", "🏆 ضمان 18 شهر", "🔒 معتمد FCC → معيار السلامة الفيدرالي الأمريكي لإلكترونيات السيارات"],

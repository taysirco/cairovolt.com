...
export const anker_soundcore_k20i = {
        slug: "anker-soundcore-k20i", sku: "ANK-AU-K20I", brand: "Soundcore", categorySlug: "audio",
        ...
        images: [
            ...
            { id: "img_3", url: "/products/anker/anker-soundcore-k20i/anker-soundcore-k20i-wearing-in-ear-fit-comfort-lifestyle.webp", alt: "Soundcore K20i earbuds close-up showing 13mm driver detail - CairoVolt", order: 2, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_4", url: "/products/anker/anker-soundcore-k20i/anker-soundcore-k20i-charging-case-open-led-indicator.webp", alt: "Soundcore K20i charging case with earbuds USB-C port - CairoVolt", order: 3, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_5", url: "/products/anker/anker-soundcore-k20i/anker-soundcore-k20i-touch-controls-earbud-surface-detail.webp", alt: "Soundcore K20i worn in ear comfortable semi-in-ear fit - CairoVolt", order: 4, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_6", url: "/products/anker/anker-soundcore-k20i/anker-soundcore-k20i-bluetooth-pairing-phone-connection.webp", alt: "Soundcore K20i box contents and accessories - CairoVolt", order: 5, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_7", url: "/products/anker/anker-soundcore-k20i/anker-soundcore-k20i-usb-c-charging-port-case-detail.webp", alt: "Soundcore K20i BassUp technology demonstration - CairoVolt", order: 6, isPrimary: false, width: 1080, height: 1080 },
            { id: "img_8", url: "/products/anker/anker-soundcore-k20i/anker-soundcore-k20i-package-contents-eartips-cable-manual.webp", alt: "ساوندكور K20i استخدام في المترو القاهرة - كايرو فولت", order: 7, isPrimary: false, width: 1080, height: 1080 },

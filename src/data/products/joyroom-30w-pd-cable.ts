...
export const joyroom_30w_pd_cable = {
        ...
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">The <strong>Joyroom 30W PD cable</strong> matches iPhone 17's maximum charging speed at a fraction of Apple's cable price. At <strong>94 EGP</strong>, it delivers the same 0→50% in 25 minutes as cables costing 3× more. The extra <strong>1.2m length</strong> reaches from floor outlet to bed.</p></div>
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">⚠️ Buyer Warning:</h3><p class="text-gray-700">If you charge Samsung S26 (needs 45W for Super Fast) or a laptop, choose the 60W cable instead. 30W is optimized specifically for iPhone users.</p></div>`,
            ...
            ar: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">كابل <strong>جوي روم 30 واط PD</strong> بيطابق أقصى سرعة شحن ايفون 17 بجزء بسيط من سعر كابل ابل. بـ <strong>94 جنيه</strong>، بيدّي نفس 0→50% في 25 دقيقة زي كابلات بـ 3 أضعاف السعر. طول <strong>1.2 متر</strong> بيوصل من البريزة الأرضية للسرير.</p></div>

...
export const anker_zolo_usb_c_braided_cable = {
        ...
        images: [
            ...
            { id: "img_2", url: "/products/anker/anker-zolo-usb-c-braided-cable/anker-zolo-usb-c-braided-cable-ultra-fast-240w-macbook.webp", alt: "كابل انكر زولو USB-C المضفر يشحن ماك بوك بقوة فائقة 240 واط — CairoVolt", order: 1, isPrimary: false, width: 1080, height: 1080 },
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">Before You Buy:</h3><p class="text-gray-700">Match model <strong>A8060</strong>, length and rated power on the cable or package. A USB-C connector does not mean every cable supports the same power or data rate. Use only a charger and device profile within the printed rating. If a serial or verification label is supplied, follow the current process on <a href="https://www.anker.com/verify" class="text-blue-600 hover:underline">Anker's verification page</a>. Stop if the jacket or connector is damaged or unusually hot.</p></div>
<div class="product-summary"><h3 class="font-bold mb-2">The Bottom Line:</h3><ul class="list-none space-y-1"><li>⚡ <strong>Listed USB-PD 3.1 rating:</strong> verify the maximum for this exact A8060 SKU.</li><li>🧬 <strong>E-marker:</strong> supports cable identification during compatible USB-PD negotiation.</li><li>🔁 <strong>Braided construction:</strong> manufacturer bend figures are test conditions, not a fixed life.</li><li>📏 <strong>1.5m listed length:</strong> confirm the supplied variant.</li><li>💰 <strong>Current listing:</strong> review price, stock and warranty terms.</li></ul></div>
<div class="expert-review"><h2 class="text-xl font-bold mb-3 text-blue-800">How to verify this model before buying</h2><p class="text-gray-700 leading-relaxed text-lg">For <strong>A8060</strong>, compare the printed rated power, voltage/current limit, length, E-marker statement and data capability with your laptop or phone. The lowest-rated part of the charger-cable-device chain limits power. Any compliance claim should be checked in current manufacturer documentation for the exact model.</p></div>
...
<div class="device-compatibility"><h3 class="font-bold mb-2">Compatibility Guide:</h3><ul class="list-disc list-inside text-gray-700"><li>💻 <strong>USB-C laptops:</strong> only the shared profile supported by charger, cable and laptop.</li><li>📱 <strong>Phones and tablets:</strong> the device selects its accepted rate.</li><li>📊 <strong>Data:</strong> confirm the printed data specification; charging power does not imply high-speed video or data.</li></ul></div>`,
  ...
  "🏆 Current Anker Warranty Terms"
                ...
                faqs: [
                    ...
                    { question: "Can it charge a laptop and phone?", answer: "It can be used with compatible USB-C laptops and phones, but each device selects a supported rate and actual time varies." },
                    { question: "Does high charging power mean fast data?", answer: "No. Confirm the separate data-rate and video-support specifications printed for A8060." },
                    { question: "How durable is the braid?", answer: "Manufacturer bend figures describe controlled test conditions. Actual life depends on storage, pulling, heat and connector care." }
                ]
            },
            ar: {
...
<div class="buyer-warning"><h3 class="font-bold mb-2 text-red-700">قبل الشراء:</h3><p class="text-gray-700">طابق الموديل <strong>A8060</strong> والطول والقدرة على الكابل أو العبوة. لا تعني وصلة USB-C أن كل الكابلات تقدم القدرة أو البيانات نفسها. إذا كانت هناك علامة تحقق، فاتبع الإجراء الحالي في <a href="https://www.anker.com/verify" class="text-blue-600 hover:underline">صفحة التحقق الرسمية</a>. استخدم بروفايلاً داخل التصنيف المطبوع وتوقف عند تلف الغلاف أو الموصل أو السخونة غير المعتادة.</p></div>
<div class="product-summary"><h3 class="font-bold mb-2">الخلاصة:</h3><ul class="list-none space-y-1"><li>⚡ <strong>تصنيف USB-PD 3.1 مدرج:</strong> تحقق من الحد الأقصى لنسخة A8060 نفسها.</li><li>🧬 <strong>E-marker:</strong> يساعد في تعريف الكابل أثناء تفاوض USB-PD المتوافق.</li><li>🔁 <strong>غلاف مضفر:</strong> أرقام الثني شروط اختبار من الشركة وليست عمراً ثابتاً.</li><li>📏 <strong>طول مدرج 1.5 متر:</strong> أكد النسخة الموردة.</li><li>💰 <strong>بيانات الشراء:</strong> راجع السعر والمخزون والضمان الحالي.</li></ul></div>
<div class="expert-review"><h2 class="text-xl font-bold mb-3 text-blue-800">طريقة التحقق قبل الشراء</h2><p class="text-gray-700 leading-relaxed text-lg">للموديل <strong>A8060</strong>، قارن القدرة وحد الجهد والتيار والطول وبيان E-marker ونقل البيانات بمتطلبات اللابتوب أو الهاتف. يحدد أقل مكوّن تصنيفاً في الشاحن والكابل والجهاز القدرة. تحقق من أي ادعاء مطابقة في وثائق الشركة الحالية للموديل نفسه.</p></div>
...
<div class="device-compatibility"><h3 class="font-bold mb-2">دليل التوافق:</h3><ul class="list-disc list-inside text-gray-700"><li>💻 <strong>لابتوب USB-C:</strong> فقط البروفايل المشترك بين الشاحن والكابل واللابتوب.</li><li>📱 <strong>هواتف وتابلت:</strong> الجهاز يختار المعدل المقبول.</li><li>📊 <strong>البيانات:</strong> أكد مواصفة البيانات المطبوعة؛ قدرة الشحن لا تعني فيديو أو بيانات عالية السرعة.</li></ul></div>`,
  ...
  "🏆 راجع شروط ضمان انكر الحالية"
                ...
                faqs: [
                    ...
                    { question: "هل يشحن لابتوب وهاتف؟", answer: "يمكن استخدامه مع أجهزة USB-C متوافقة، لكن كل جهاز يختار المعدل المدعوم وتتغير المدة الفعلية." },
                    { question: "هل قدرة الشحن تعني بيانات سريعة؟", answer: "لا. تحقق من مواصفة معدل البيانات ودعم الفيديو المطبوعة للموديل A8060." },
                    { question: "ما متانة الغلاف؟", answer: "تصف أرقام الثني من الشركة شروط اختبار محددة. العمر الفعلي يعتمد على التخزين والسحب والحرارة والعناية بالموصل." }
                ]
            }
        },

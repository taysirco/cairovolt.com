...
export const joyroom_25w_fast_charger = {
        ...
        images: [
            ...
            { id: "img_2", url: "/products/joyroom/joyroom-25w-fast-charger/joyroom-joyroom-25w-fast-charger-egypt-cairo-4.webp", alt: "شاحن جوي روم 25 واط اصلي في مصر - توصيل سريع القاهرة - JR-TCF25 - كايرو فولت", order: 1, isPrimary: false, width: 1080, height: 1080 },
...
`,
                features: ["⚡ شحن سريع 25 واط PD 3.0", "📱 ايفون 17: 0→50% في 25 دقيقة", "📱 سامسونج سوبر فاست", "🛡️ حماية 5 طبقات", "🔌 تصميم صغير للسفر", "🌍 AC 100-240V عالمي", "🏆 ضمان 36 شهر", "🔒 معتمد CE للسلامة → معيار السلامة الأوروبي للشحن السريع"],
                metaTitle: "شاحن جوي روم 25 واط ⚡ ايفون + سامسونج أصلي | COD مصر",

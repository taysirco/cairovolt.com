...
export const joyroom_usb_a_type_c_cable = {
        ...
        translations: {
            en: {
                ...
                description: `<div class="quick-answer"><p class="text-gray-800 leading-relaxed">Unlike buying an expensive new charger, got a new iPhone 17 or Samsung S26 but still have old USB-A chargers? The <strong>Joyroom USB-A to Type-C</strong> bridges the gap with <strong>3A fast charging</strong> — no new charger needed. CairoVolt 365-day durability test: passed. Available at <strong>EGP 86</strong> with CairoVolt warranty. CairoVolt return rate: <strong>only 0.4%</strong> across 1,200+ units sold.</p></div>

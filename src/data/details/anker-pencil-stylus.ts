...
export const anker_pencil_stylus_detail: ProductDetail = {
    ...
    specifications: {
        ...
        'Tilt Sensitivity': { en: 'Yes', ar: 'نعم' },
        'Pressure Sensitivity': { en: 'No (Apple Pencil exclusive)', ar: 'لا (حصري Apple Pencil)' },
        'Palm Rejection': { en: 'Yes', ar: 'نعم' },
        'Magnetic': { en: 'N52 Neodymium (storage only)', ar: 'N52 نيوديميوم (تخزين فقط)' },
        'Bluetooth': { en: '5.3', ar: '5.3' },
        'Battery': { en: '~8 hours continuous', ar: '~8 ساعات متواصلة' },
        'Charging': { en: 'USB-C (25 min full charge)', ar: 'USB-C (25 دقيقة شحن كامل)' },
        'Weight': { en: '15.4g', ar: '15.4 جرام' },

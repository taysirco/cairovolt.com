// Details for: joyroom-3-in-1-wireless-charging-station
import type { ProductDetail } from './_types';

export const joyroom_3_in_1_wireless_charging_station_detail: ProductDetail = {
        ...
        specifications: { 'iPhone Output': { en: '15W wireless', ar: '15 واط لاسلكي' }, 'AirPods Output': { en: '5W wireless', ar: '5 واط لاسلكي' }, 'Watch Output': { en: '3W magnetic', ar: '3 واط مغناطيسي' }, 'Input': { en: '30W USB-C', ar: '30 واط USB-C' }, 'Compatibility': { en: 'Qi2 / MagSafe', ar: 'Qi2 / MagSafe' }, 'Dimensions': { en: '150 × 100 × 80 mm', ar: '150 × 100 × 80 ملم' }, 'Weight': { en: '220g', ar: '220 جرام' }, 'Safety': { en: 'FOD + OVP + OTP protection', ar: 'حماية FOD + OVP + OTP' } },
        labVerified: {

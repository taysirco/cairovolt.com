// Details for: soundcore-r50i-vi-earbuds  (Soundcore R50i Vi / R50i VI, model A3969)
// Lab sheet: CV-EB-A3969-001 — §7.5 ELEVATED gold deepen (Wave Adj/Mid).
// CRITICAL SKU hygiene: A3969 ≠ A3949 (P20i / retail R50i / P25i) ≠ A3959 (P30i / R50i NC).
// Do NOT paste A3949 9h28/28h12 or A3959 9h41/~43h onto this page — THIS sample stopwatch is source of truth.
// Official SPECS: support.soundcore.com R50i VI User Guide (A3969) PDF — NOT the A3949 shared guide.
// Elevated bar: ≥170 lines · ≥18 results · 5+5 aiTldr · Battery physics + §11 red-flag · Omar · 2026-07-24.
...
export const soundcore_r50i_vi_earbuds_detail: ProductDetail = {
    ...
    localContext: {
        en: 'R50i Vi (A3969) is the “voice-assistant + knitted lanyard” budget daily driver — buy it for Cairo commute + WhatsApp calls, not as an ANC upgrade or a silent rename of A3949. Six Cairo scenarios on THIS measured sample (CV-EB-A3969-001). RIGHT FOR: (1) UNIVERSITY / OFFICE commute — Metro Line 3 / New Cairo microbus: 9h 48 min measured single-bud @50% covers a full class or office day; case tops back up between morning and evening. (2) SWEAT GYM — IPX5 vendor rating handles Cairo summer perspiration; wipe dry before docking (never charge damp; case NOT rated). (3) UBER / CAREEM driver-side calls — AI 2-mic path intelligible on WhatsApp 60s at ~60 km/h AC-on windows-up; open-window wind still bleeds (no invented SNR). (4) KEYCHAIN / BAG CLIP — knitted lanyard on the A3969 square case is the practical differentiator vs bare A3949 pebble cases; clip to backpack zipper on campus. (5) ZOOM FROM CAFÉ (Zamalek / Sheikh Zayed) — AAC on iPhone 15 held to ~10m indoor line-of-sight tape; café Wi-Fi noise did not drop the BT link. (6) PRAYER QUICK-OFF — double-tap pause; one bud in the case pauses; passive isolation drops enough that adhan stays audible. Also: (7) BUYERS CONFUSED BY “R50i” NAME — match A3969 on carton; A3949 is a different family guide; A3959 is the ANC twin (R50i NC / P30i). A/B honesty: vs retail R50i A3949 gold (CV-EB-A3949-R50I-001) — Vi THIS is +20 min single-bud / +53 min system vs R50i’s 9h 28 / 28h 12 — SEPARATE MPN/guide + case geometry; stopwatch rows not pasted either way. vs P20i gold (CV-EB-A3949Z11-001) — Vi +13 / +35 min vs 9h 35 / 28h 30; still not the same carton. vs P30i / R50i NC A3959 (CV-EB-A3959-001) — DIFFERENT MPN: A3959 adds genuine playback ANC + multipoint + BT 5.4 + ~43h case reserve; do not paste A3959 hours here. WRONG FOR: (8) FLIGHT / METRO BRAKE SCREECH — no ANC; jet drone and brake squeal bleed. Buy A3959 or P40i if ANC is the job. (9) AUDIOPHILE / HI-RES — SBC+AAC only; no LDAC / aptX. (10) PROLONGED 100% BASS — measured single-bud dropped to 5h 35 min. (11) POOL / SHOWER — IPX5 is splash, not submersion. HEAT: buds + case stayed cool to the cheek after 90 min play in 28.7°C lab air; no thermal shutdown. RECALL: A3969 NOT on Anker earbuds recall lists — verified anker.com/product-recalls + service.soundcore.com on 2026-07-24 (active families A1257/A1263/A1647/A1652/A1681/A1689 are power banks).',
        ar: 'R50i Vi (A3969) هي «المساعد الصوتي + الحبل المحبوك» اليومية الرخيصة — اشترِها لتنقل القاهرة ومكالمات واتساب، لا كترقية ANC أو إعادة تسمية صامتة لـ A3949. ستة سيناريوهات قاهرية على هذه العيّنة المقاسة (CV-EB-A3969-001). مناسب لـ: (1) جامعة / مكتب — مترو الخط الثالث / ميكروباص التجمع: 9 ساعات و48 دقيقة مقاسة لسماعة مفردة @50% تغطي يوم محاضرات أو مكتب؛ العلبة تعيد الشحن بين الصباح والمساء. (2) صالة بعرق — IPX5 المعلن يتعامل مع عرق صيف القاهرة؛ امسح جافًا قبل الإرجاع (لا تشحن وهي مبللة؛ العلبة بلا تصنيف). (3) مكالمات سائق أوبر / كريم — مسار AI بمايكين مفهوم على واتساب 60 ثانية عند ~60 كم/س بتكييف ونوافذ مغلقة؛ رياح النوافذ المفتوحة ما زالت تتسرب (بلا SNR مخترع). (4) سلسلة مفاتيح / مشبك حقيبة — الحبل المحبوك على علبة A3969 المربعة هو الفارق العملي مقابل علب A3949 الحصوية العارية؛ اربطه بسحّاب الشنطة في الحرم. (5) زووم من كافيه (الزمالك / الشيخ زايد) — AAC على iPhone 15 ثبت حتى نحو 10 أمتار داخلي بشريط؛ ضوضاء واي-فاي الكافيه لم تُسقط الرابط. (6) رفع سريع للصلاة — نقرتان للإيقاف؛ سماعة في العلبة توقف مؤقتًا؛ يسقط العزل كفاية ليبقى الأذان مسموعًا. أيضًا: (7) مشترٍ مرتبك باسم «R50i» — طابق A3969 على الكرتونة؛ A3949 عائلة دليل مختلفة؛ A3959 التوأم بـ ANC (R50i NC / P30i). صدق أ/ب: مقابل ذهب R50i تجزئة A3949 (CV-EB-A3949-R50I-001) — Vi هذه أطول +20 دقيقة سماعة / +53 دقيقة نظام مقابل 9س28 / 28س12 — MPN/دليل منفصل + هندسة علبة؛ الصفوف غير ملصوقة بأي اتجاه. مقابل ذهب P20i (CV-EB-A3949Z11-001) — Vi +13 / +35 دقيقة مقابل 9س35 / 28س30؛ ما زالت ليست نفس الكرتونة. مقابل P30i / R50i NC A3959 (CV-EB-A3959-001) — MPN مختلف: A3959 يضيف ANC تشغيلي حقيقي + multipoint + BT 5.4 + احتياطي علبة ~43 ساعة؛ لا تلصق ساعات A3959 هنا. غير مناسبة لـ: (8) طيران / صرير فرامل المترو — بلا ANC. اشترِ A3959 أو P40i إن كان ANC هو المهمة. (9) عاشق صوت / Hi-Res — SBC+AAC فقط؛ لا LDAC / aptX. (10) باس ثقيل طويل عند 100% — هبط زمن السماعة إلى 5 ساعات و35 دقيقة. (11) مسبح / دش — IPX5 رشّ لا غمر. الحرارة: بقيت السماعات والعلبة باردة على الخد بعد 90 دقيقة في هواء مختبر 28.7°م؛ بلا إغلاق حراري. الاستدعاء: A3969 غير موجود على قوائم استدعاء سماعات انكر — تحقّق anker.com/product-recalls + service.soundcore.com في 2026-07-24 (عائلات A1257/A1263/A1647/A1652/A1681/A1689 باور بانك).',
    },
    specifications: {
        'Model': { en: 'Soundcore R50i Vi / R50i VI (Anker MPN A3969 · retail suffixes e.g. A3969D11 black — match carton print)', ar: 'ساوندكور R50i Vi / R50i VI (MPN أنكر A3969 · لواحق تجزئة مثل A3969D11 أسود — طابق طباعة الكرتونة)' },
        'Naming honesty / aliases': { en: 'A3969 ≠ A3949 ≠ A3959. A3949 = shared P20i/R50i/P25i guide. A3959 = P30i/R50i NC (ANC). A3969 = R50i Vi only — own SPECS PDF on support.soundcore.com. Do not treat Vi as a silent rename of A3949.', ar: 'A3969 ≠ A3949 ≠ A3959. A3949 = دليل مشترك P20i/R50i/P25i. A3959 = P30i/R50i NC (ANC). A3969 = R50i Vi فقط — PDF مواصفات خاص على support.soundcore.com. لا تعتبر Vi إعادة تسمية صامتة لـ A3949.' },
        'Driver': { en: '10mm dynamic driver, 16Ω impedance, 20Hz–20kHz response, 5mW rated output (A3969 SPECS)', ar: 'محرك ديناميكي 10 ملم، مقاومة 16 أوم، استجابة 20 هرتز–20 كيلوهرتز، خرج اسمي 5 مللي واط (SPECS A3969)' },
        ...
        'Playtime (CairoVolt measured @ 50%)': { en: '9h 48 min single-bud · 29h 05 min with case — sample CV-EB-A3969-001', ar: '9 ساعات و48 دقيقة لسماعة مفردة · 29 ساعة و5 دقائق مع العلبة — عيّنة CV-EB-A3969-001' },
        'Quick Charge (vendor marketing)': { en: '10 min → up to 2 h playback (Anker-brand A3969 retail listings) — NOT printed in A3969 user-guide SPECS block; CairoVolt still stopwatch-tested the yield', ar: '10 دقائق → حتى ساعتين تشغيل (قوائم تجزئة Anker لـ A3969) — غير مطبوع في كتلة SPECS بدليل A3969؛ CairoVolt قاس العائد بساعة إيقاف رغم ذلك' },
        'Multipoint': { en: 'Not listed in A3969 user guide; Soundcore App exposes no multipoint toggle for this SKU. CairoVolt bench: pairing a second device disconnects the first. (A3959 HAS multipoint — different SKU.)', ar: 'غير مذكور في دليل A3969؛ تطبيق ساوندكور لا يعرض مفتاح multipoint لهذا SKU. اختبار CairoVolt: إقران جهاز ثانٍ يقطع الأول. (A3959 يدعم multipoint — SKU مختلف.)' },
        'App': { en: 'Soundcore App (iOS + Android): gaming mode, Find Device, EQ tuning, firmware updates, customizable controls (A3969 guide)', ar: 'تطبيق ساوندكور (iOS + Android): وضع ألعاب، إيجاد الجهاز، ضبط EQ، تحديثات فيرموير، تحكم قابل للتخصيص (دليل A3969)' },
        'Weight per Earbud (vendor listing)': { en: '~4.55g (A3969 regional retail sheets) — CairoVolt Kkmoon 0.01g: 4.6g each', ar: 'نحو 4.55 جرام (أوراق تجزئة إقليمية A3969) — CairoVolt Kkmoon 0.01g: 4.6 جرام لكل واحدة' },
        'Weight — Charging Case (vendor listing)': { en: '~46g case (A3969 regional retail sheets) — CairoVolt Kkmoon 0.01g: 46.1g case alone · 55.3g buds + case', ar: 'نحو 46 جرام للعلبة (أوراق إقليمية A3969) — CairoVolt Kkmoon 0.01g: 46.1 جرام للعلبة وحدها · 55.3 جرام سماعات + علبة' },
        'Dimensions (case, vendor listing)': { en: '5.7 × 5.7 × 2.8 cm (A3969 regional sheets) — CairoVolt steel tape: 57 × 57 × 28 mm', ar: '5.7 × 5.7 × 2.8 سم (أوراق إقليمية A3969) — شريط CairoVolt الفولاذي: 57 × 57 × 28 ملم' },
        'In the Box': { en: 'R50i Vi earbuds + charging case (knitted lanyard on retail A3969 units) + 3 sizes silicone tips + USB-C cable + quick start / safety docs — verify sealed carton', ar: 'سماعات R50i Vi + علبة شحن (حبل محبوك على وحدات تجزئة A3969) + 3 مقاسات أطراف سيليكون + كابل USB-C + أدلة بدء/سلامة — تحقق من الكرتونة المغلقة' },
        'How A3969 differs from A3949 (P20i/R50i/P25i)': { en: 'Separate MPN + separate user guide. Similar 60/430 mAh and 10h/30h envelope, but different case geometry (square ~57×57×28 mm vs A3949 pebble ~62×45×27 mm), knitted lanyard, and voice-assistant left double-tap mapping. Do NOT paste A3949 measured rows onto A3969.', ar: 'MPN منفصل + دليل منفصل. مظروف طاقة مشابه 60/430 مللي أمبير و10/30 ساعة، لكن هندسة علبة مختلفة (مربعة ~57×57×28 ملم مقابل حصوة A3949 ~62×45×27 ملم)، وحبل محبوك، وتعيين مساعد صوتي بنقرتين يسار. لا تلصق صفوف A3949 المقاسة على A3969.' },
        'How A3969 differs from A3959 (R50i NC / P30i)': { en: 'A3959 adds Active Noise Cancellation, multipoint, BT 5.4, IP54, larger case (~700mAh / ~43h measured system). A3969 has none of those. If the listing says “R50i NC”, that is A3959 — not this SKU.', ar: 'A3959 يضيف إلغاء ضوضاء نشط وmultipoint وBT 5.4 وIP54 وعلبة أكبر (~700 مللي أمبير / ~43 ساعة نظام مقاس). A3969 بلا ذلك. إن قالت القائمة «R50i NC» فهي A3959 — ليس هذا الـ SKU.' },
        ...
        equipment: [
            {
                ...
                use: { en: 'Per-earbud + case-alone + buds+case weight', ar: 'وزن السماعة الواحدة + العلبة وحدها + السماعات مع العلبة' },
            ...
            },
            {
                ...
                use: { en: 'USB-C input to the A3969 case: verified ~5V / 0.42A / ~2.1W — matches A3969 SPECS 5V/0.43A band', ar: 'دخل USB-C إلى علبة A3969: مؤكد ~5V / 0.42A / ~2.1 واط — يطابق نطاق SPECS A3969 5V/0.43A' },
            ...
            },
            {
                ...
                name: 'Apple iPhone 15 (BT 5.3, iOS latest, battery health 92%)',

                use: { en: 'Primary AAC source, isolation notes, mic playback, voice-assistant double-tap check', ar: 'مصدر AAC رئيسي، ملاحظات عزل، تشغيل المايك، فحص نقرة المساعد الصوتي' },

            },
            {

                name: 'Samsung Galaxy A54 (BT 5.3, One UI, battery health 96%)',

                use: { en: 'Android cross-check, force-to-SBC confirmation, multipoint attempt second host', ar: 'تحقق أندرويد، تأكيد إجبار SBC، مضيف ثانٍ لمحاولة multipoint' },
            ...
            },
            {
                ...
                name: 'Anker A2147 30W wall charger (verified in earlier CV bench)',

                use: { en: 'Case USB-C charging source; drew ~5V only — case is a 5V input device', ar: 'مصدر شحن USB-C للعلبة؛ سحب ~5V فقط — العلبة جهاز دخل 5V' },
            ...
            },
            {
                ...
                use: { en: 'Codec verification (SBC vs AAC), firmware version, EQ / gaming-mode control', ar: 'التحقق من الكودكات (SBC مقابل AAC)، إصدار الفيرموير، التحكم في EQ / وضع الألعاب' },

            },
        ],
        results: [
            {
               param: { en: 'Rated battery — per earbud (A3969 SPECS)', ar: 'البطارية الاسمية — لكل سماعة (SPECS A3969)' },
               rated: '60mAh / 0.222Wh',
               measured: '—',
               note: { en: 'A3969 SPECS block; 3.7V nominal math — NOT copied from A3949', ar: 'كتلة SPECS A3969؛ حساب 3.7V اسمي — غير منسوخ من A3949' } },
            },
            {
               param: { en: 'Rated battery — charging case (A3969 SPECS)', ar: 'البطارية الاسمية — علبة الشحن (SPECS A3969)' },
               rated: '430mAh / 1.591Wh',
               measured: '—',
               note: { en: 'A3969 SPECS — NOT the A3959 700mAh / 2.66Wh P30i case', ar: 'SPECS A3969 — ليست علبة P30i A3959 بـ 700 مللي أمبير / 2.66Wh' } },
            },
            {
               param: { en: 'System total energy', ar: 'إجمالي طاقة النظام' },
               rated: '~2.035Wh (2 × 0.222 + 1.591)',
               measured: '—',
               note: { en: 'well under 100Wh airline threshold — always cabin-safe', ar: 'أقل بكثير من حد الطيران 100Wh — دائمًا آمن في المقصورة' } },
            },
            {
            ...
            },
            {
               ...
               measured: '5h 35 min',
               note: { en: '~57% of the 50%-vol figure — louder drive raises current draw; expected DSP tax', ar: 'نحو 57% من رقم 50% حجم — قيادة أعلى ترفع سحب التيار؛ ضريبة DSP متوقعة' } },
            },
            {
            ...
            },
            {
               ...
               rated: 'up to 2h (combined A3969 SPECS)',
               measured: '1h 38 min',
               note: { en: 'Timer+; A3969 guide gives one combined charge figure — not the A3949 1.5h split', ar: 'Timer+؛ دليل A3969 يعطي رقم شحن موحّد — وليس تقسيم 1.5 ساعة الخاص بـ A3949' } },
            },
            {
               param: { en: 'Case charge time 0→100% via USB-C', ar: 'زمن شحن العلبة 0→100% عبر USB-C' },
               rated: 'up to 2h',
               measured: '1h 58 min',
               note: { en: 'FNB58 sustained ~5V / 0.42A / ~2.1W — inside A3969 SPECS 5V/0.43A; PD irrelevant', ar: 'FNB58 مستمر ~5V / 0.42A / ~2.1 واط — داخل SPECS A3969 5V/0.43A؛ PD غير ذي صلة' } },
            },
            {
            ...
            },
            {
               ...
               rated: { en: 'not listed by vendor', ar: 'غير مذكور من البائع' },
               measured: { en: 'NOT SUPPORTED — pairing Samsung A54 disconnects iPhone 15; no simultaneous dual-host', ar: 'غير مدعوم — إقران Samsung A54 يفصل iPhone 15؛ لا استضافة مزدوجة متزامنة' },
               note: { en: 'consistent with A3969 guide silence — A3959 HAS multipoint (different SKU)', ar: 'متسق مع صمت دليل A3969 — A3959 يدعم multipoint (SKU مختلف)' } },
            },
            {
               param: { en: 'Codecs verified in Soundcore App', ar: 'الكودكات المؤكدة في تطبيق ساوندكور' },
               rated: 'SBC + AAC',
               measured: { en: 'SBC + AAC only — no LDAC / no aptX offered by the endpoint', ar: 'SBC + AAC فقط — لا LDAC / لا aptX يعرضها الطرف' },
               note: { en: 'iPhone 15 = AAC; Samsung A54 = AAC default, SBC on force', ar: 'iPhone 15 = AAC؛ Samsung A54 = AAC افتراضي، SBC عند الإجبار' } },
            },
            {
               param: { en: 'ANC', ar: 'ANC' },
               rated: 'None (passive)',
            ...
            },
            {
               ...
               rated: { en: 'double-tap L activates assistant', ar: 'نقرتان يسار تفعّل المساعد' },
               measured: { en: 'Confirmed on iPhone 15 — Siri invoked; assistant quality depends on phone, not buds', ar: 'مؤكد على iPhone 15 — استُدعيت Siri؛ جودة المساعد تعتمد على الهاتف لا السماعة' },
               note: { en: 'A3969 controls table — distinct mapping callout vs bare A3949 listings', ar: 'جدول تحكم A3969 — تمييز عن قوائم A3949 العارية' } },
            },
            {
               param: { en: 'Weight per earbud', ar: 'وزن السماعة الواحدة' },
               rated: '~4.55g (retail sheet)',
               measured: '4.6g (Kkmoon 0.01g)',
               note: { en: '+0.05g vs vendor sheet — inside scale tolerance · THIS A3969 sample', ar: '+0.05 جرام مقابل ورقة البائع — داخل تسامح الميزان · عيّنة A3969 هذه' } },
            },
            {
               param: { en: 'Weight — case alone', ar: 'وزن العلبة وحدها' },
               rated: '~46g (retail sheet)',
               measured: '46.1g (Kkmoon 0.01g)',
               note: { en: 'A3969 square case — not the A3949 ~47g buds+case pebble total', ar: 'علبة A3969 المربعة — ليست إجمالي حصوة A3949 ~47 جرام سماعات+علبة' } },
            },
            {
               param: { en: 'Weight total (buds + case)', ar: 'الوزن الإجمالي (سماعات + علبة)' },
               rated: '~55.1g (4.55×2 + 46)',
               measured: '55.3g (Kkmoon 0.01g)',
               note: { en: '+0.2g vs sheet math — inside scale tolerance', ar: '+0.2 جرام مقابل حساب الورقة — داخل تسامح الميزان' } },
            },
            {
               param: { en: 'Case dimensions (steel tape)', ar: 'أبعاد العلبة (شريط فولاذي)' },
               rated: '5.7 × 5.7 × 2.8 cm (retail sheet)',
               measured: '57 × 57 × 28 mm',
               note: { en: 'near-square case with knitted lanyard — not A3949 pebble / not A3959 stand case', ar: 'علبة شبه مربعة مع حبل محبوك — ليست حصوة A3949 / ليست حامل A3959' } },
            },
            {
               param: { en: 'A/B vs retail R50i A3949 (sibling disclosure only)', ar: 'أ/ب مقابل R50i تجزئة A3949 (إفصاح شقيق فقط)' },
               measured: { en: 'R50i: 9h 28 single / 28h 12 system @50% — Vi THIS: 9h 48 / 29h 05 (+20 / +53 min). SEPARATE MPN + guide + square lanyard case — rows not pasted either way', ar: 'R50i: 9س28 مفرد / 28س12 نظام @50% — Vi هذه: 9س48 / 29س05 (+20 / +53 دقيقة). MPN + دليل + علبة مربعة بحبل منفصلة — الصفوف غير ملصوقة بأي اتجاه' },
               note: { en: 'citation only — CV-EB-A3949-R50I-001 owns R50i numbers', ar: 'استشهاد فقط — CV-EB-A3949-R50I-001 يملك أرقام R50i' } },
            },
            {
               param: { en: 'A/B vs P20i A3949Z11 (sibling disclosure only)', ar: 'أ/ب مقابل P20i A3949Z11 (إفصاح شقيق فقط)' },
               measured: { en: 'P20i: 9h 35 / 28h 30 — Vi THIS: 9h 48 / 29h 05 (+13 / +35 min). Same ~60/430 mAh class, different MPN/guide — do not rubber-stamp', ar: 'P20i: 9س35 / 28س30 — Vi هذه: 9س48 / 29س05 (+13 / +35 دقيقة). نفس فئة ~60/430 مللي أمبير، MPN/دليل مختلف — لا تلصق' },
               note: { en: 'citation only — CV-EB-A3949Z11-001 owns P20i numbers', ar: 'استشهاد فقط — CV-EB-A3949Z11-001 يملك أرقام P20i' } },
            },
            {
               param: { en: 'A/B vs P30i / R50i NC A3959 (different MPN)', ar: 'أ/ب مقابل P30i / R50i NC A3959 (MPN مختلف)' },
               measured: { en: 'A3959: ANC path + multipoint + BT 5.4 + ~43h system @50% ANC-off — A3969 has NONE of those. “R50i NC” on a listing is A3959, not Vi', ar: 'A3959: مسار ANC + multipoint + BT 5.4 + ~43 ساعة نظام @50% بلا ANC — A3969 بلا أي من ذلك. «R50i NC» في قائمة = A3959 لا Vi' },
            ...
            },
            {
               ...
               note: { en: 'anker.com/product-recalls + service.soundcore.com — A3969 outside A1257/A1263/A1647/A1652/A1681/A1689 (all power-bank SKUs)', ar: 'anker.com/product-recalls + service.soundcore.com — A3969 خارج A1257/A1263/A1647/A1652/A1681/A1689 (كلها SKUs باور بانك)' } },
            },
        ],
        verdict: {
            en: 'R50i Vi A3969 delivered 9h 48min single-bud @50% and 29h 05min system total — inside vendor band. SBC/AAC only, no ANC, no multipoint, no LDAC. Distinct MPN from A3949/A3959. Battery Wh physics clear. Not recalled. Match A3969 on carton; buy A3959 if you need ANC.',
            ar: 'R50i Vi A3969 أخرجت 9 ساعات و48 دقيقة لسماعة مفردة @50% وإجمالي نظام 29 ساعة و5 دقائق — داخل نطاق البائع. SBC/AAC فقط، بلا ANC، بلا multipoint، بلا LDAC. MPN منفصل عن A3949/A3959. فيزياء Wh البطارية واضحة. لا استدعاء. طابق A3969 على الكرتونة؛ اشترِ A3959 إن احتجت ANC.',
        },
        pros: [
            {

                en: '9h 48min measured single-bud @50% on CV-EB-A3969-001 — only 12 min short of the 10h vendor claim (Timer+, AAC/iPhone 15)',

                ar: '9 ساعات و48 دقيقة مقاسة لسماعة مفردة @50% على CV-EB-A3969-001 — أقل 12 دقيقة فقط من ادعاء البائع 10 ساعات (Timer+، AAC/iPhone 15)',
            ...
            },
            {
                ...
                en: '4.6g per bud + 46.1g case on 0.01g Kkmoon — light daily wear; knitted lanyard keeps the square case on a bag zipper',

                ar: '4.6 جرام لكل سماعة + 46.1 جرام للعلبة على ميزان Kkmoon 0.01g — ارتداء يومي خفيف؛ الحبل المحبوك يُبقي العلبة المربعة على سحّاب الحقيبة',

            },
            {

                en: 'Case charges in 1h 58min from a ~5V/0.42A USB-C source — any 2W+ phone charger works; PD wall tax irrelevant',

                ar: 'العلبة تشحن في 1 ساعة و58 دقيقة من مصدر USB-C ~5V/0.42A — أي شاحن هاتف 2 واط+ يعمل؛ ضريبة PD غير ذات صلة',
            ...
            },
            {
                ...
                en: 'Left double-tap voice-assistant control confirmed on iPhone 15 per A3969 controls map',

                ar: 'تحكم المساعد الصوتي بنقرتين يسار مؤكد على iPhone 15 وفق خريطة تحكم A3969',
            ...
            },
            {
                ...
                ar: 'لا استدعاء — تحقّق 2026-07-24 مقابل anker.com/product-recalls + service.soundcore.com',
        ...
        limits: [
            {
                ...
                en: 'A3969 is NOT A3949 — similar 60/430 mAh envelope does not make them the same hardware family. Match the printed MPN before comparing street prices to P20i/P25i/R50i.',

                ar: 'A3969 ليست A3949 — تشابه مظروف 60/430 مللي أمبير لا يجعلهما نفس عائلة العتاد. طابق MPN المطبوع قبل مقارنة أسعار الشارع بـ P20i/P25i/R50i.',

            },
            {

                en: 'Do NOT paste retail R50i (9h 28 / 28h 12) or P30i/R50i NC (~43h ANC-off system) stopwatch rows onto this page — THIS sample owns 9h 48 / 29h 05.',

                ar: 'لا تلصق صفوف ساعة إيقاف R50i تجزئة (9س28 / 28س12) أو P30i/R50i NC (~43س نظام بلا ANC) على هذه الصفحة — هذه العيّنة تملك 9س48 / 29س05.',

            },
            {

                en: 'No ANC — passive silicone-tip isolation only. Metro brake screech and jet drone will bleed through. For ANC under the “R50i” name, that is A3959 R50i NC — a different SKU.',

                ar: 'بلا ANC — عزل سلبي بأطراف السيليكون فقط. صرير فرامل المترو وهدير المحرك سيتسربان. لـ ANC تحت اسم «R50i» فهذا A3959 R50i NC — SKU مختلف.',

            },
            {

                en: 'SBC + AAC only — no LDAC, no aptX / aptX HD / aptX Adaptive. Hi-res streams downsample. Verified twice via Soundcore App developer panel.',

                ar: 'SBC + AAC فقط — لا LDAC، لا aptX / aptX HD / aptX Adaptive. تدفقات Hi-res تُخفض العينة. مؤكد مرتين عبر لوحة مطوّر تطبيق ساوندكور.',

            },
            {

                en: 'No multipoint — pairing a second device disconnects the first. Phone Zoom + laptop call needs manual re-pair (A3959 has multipoint — different SKU).',

                ar: 'بلا multipoint — إقران جهاز ثانٍ يفصل الأول. زووم هاتف + مكالمة لابتوب يحتاج إعادة إقران يدوي (A3959 يدعم multipoint — SKU مختلف).',

            },
            {

                en: 'Playtime at 100% volume drops to 5h 35min (~57% of 50%-vol figure) — loud bass EQ is not free.',

                ar: 'زمن التشغيل عند 100% حجم يهبط إلى 5 ساعات و35 دقيقة (نحو 57% من رقم 50%) — EQ الباس العالي ليس مجانيًا.',

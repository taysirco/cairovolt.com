...
export const anker_powerport_25w_detail: ProductDetail = {
        ...
        specifications: { 'Output': { en: '25W USB-C PPS/PD', ar: '25 واط USB-C PPS/PD' }, 'Input': { en: '100-240V AC', ar: '100-240 فولت AC' }, 'Ports': { en: '1× USB-C', ar: '1× USB-C' }, 'Compatibility': { en: 'Samsung Galaxy S/Note/A series + iPhone', ar: 'سامسونج جالاكسي S/Note/A + ايفون' }, 'Weight': { en: '32g', ar: '32 جرام' }, 'Dimensions': { en: '30 × 30 × 32 mm', ar: '30 × 30 × 32 ملم' }, 'Safety': { en: 'MultiProtect + Samsung PPS certified', ar: 'MultiProtect + معتمد Samsung PPS' } },
        labVerified: {

// Details for: joyroom-t03s-pro-earbuds
import type { ProductDetail } from './_types';

export const joyroom_t03s_pro_earbuds_detail: ProductDetail = {
        ...
        specifications: { 'Driver': { en: '13mm dynamic driver', ar: 'سماعة ديناميكية 13mm' }, 'Battery Life': { en: '6h + 24h (case)', ar: '6 ساعات + 24 ساعة (العلبة)' }, 'Connectivity': { en: 'Bluetooth 5.3', ar: 'بلوتوث 5.3' }, 'Water Resistance': { en: 'IPX5', ar: 'IPX5' }, 'Weight': { en: '4.5g per earbud', ar: '4.5 جرام للسماعة' }, 'Dimensions': { en: '62 × 48 × 30 mm (case)', ar: '62 × 48 × 30 ملم (العلبة)' }, 'Safety': { en: 'IPX5 sweat-proof + ANC', ar: 'IPX5 مقاوم للعرق + ANC' } },
        labVerified: {

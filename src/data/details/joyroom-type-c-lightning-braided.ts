...
export const joyroom_type_c_lightning_braided_detail: ProductDetail = {
        ...
        specifications: { 'Length': { en: '1.2m', ar: '1.2 متر' }, 'Max Charging': { en: '27W PD', ar: '27 واط PD' }, 'Material': { en: 'Double-braided nylon + aluminum', ar: 'نايلون مزدوج + ألومينيوم' }, 'Connector': { en: 'USB-C to Lightning', ar: 'USB-C إلى Lightning' }, 'Durability': { en: '25,000+ bends', ar: '25,000+ انحناءة' } },
        labVerified: {

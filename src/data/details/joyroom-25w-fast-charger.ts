// Details for: joyroom-25w-fast-charger  (Joyroom JR-TCF23, 25W USB-C PD+PPS, single-port wall charger)
import type { ProductDetail } from './_types';

export const joyroom_25w_fast_charger_detail: ProductDetail = {
    aiTldr: {
        en: [
            'Joyroom JR-TCF23 (store SKU JC01, GTIN 6956116750046, ~342 EGP): single USB-C 25W wall brick. FNB58 decoded fixed PDOs 5V/3A + 9V/2.77A plus PPS 3.3–5.9V/3A and 3.3–11V/2.25A — this is the Samsung 25W Super Fast Charging envelope, unlike sibling JR-TCF20 (PD-only, no PPS).',
            'CairoVolt peak on the 9V fixed rail: 24.4W (8.91V/2.74A). PPS held at 11V/2.22A ≈ 24.4W for 5 min on JUWEI — ≥97% of the 25W label on our sample.',
            'Real phones: Galaxy S24 base negotiated PPS Super Fast Charging and peaked ~24.1W (0→100% ≈ 67 min). iPhone 15 stayed in Apple\'s ~20W PD cap (~19.6W peak; 0→50% ≈ 28 min) — extra wattage above 20W does not unlock faster iPhone wired charge.',
            'Not JR-TCF30: that SKU is dual-port USB-C + USB-A shared 30W. JR-TCF23 is one USB-C only. Cable not in the CairoVolt retail pack — bring a 3A USB-C cable.',
            'Surface 58.7°C after 15 min at ~24W (ambient 28.1°C). No AC-input analyzer on this pass — we publish no efficiency %. Single unit recalled 2026-07-24; batches may vary.',
        ],
        ar: [
            'جوي روم JR-TCF23 (SKU المتجر JC01، GTIN 6956116750046، ~342 جنيه): شاحن حائط بمنفذ USB-C واحد 25 واط. FNB58 فكّ PDO ثابتة 5V/3A + 9V/2.77A مع PPS 3.3–5.9V/3A و3.3–11V/2.25A — هذا ظرف Samsung 25W Super Fast Charging، بخلاف الشقيق JR-TCF20 (PD فقط بلا PPS).',
            'ذروة CairoVolt على منفذ 9V الثابت: 24.4 واط (8.91V/2.74A). PPS ثبت عند 11V/2.22A ≈ 24.4 واط لمدة 5 دقائق على JUWEI — ≥97% من ملصق 25 واط على عيّنتنا.',
            'هواتف حقيقية: Galaxy S24 القاعدي تفاوض PPS Super Fast Charging وذروة ~24.1 واط (0→100% ≈ 67 دقيقة). iPhone 15 بقي ضمن سقف آبل ~20 واط PD (~19.6 واط ذروة؛ 0→50% ≈ 28 دقيقة) — الواط الزائد فوق 20 لا يسرّع شحن الآيفون السلكي.',
            'ليس JR-TCF30: ذلك الموديل منفذان USB-C + USB-A بقدرة مشتركة 30 واط. JR-TCF23 منفذ USB-C واحد فقط. الكابل غير مرفق في عبوة كايرو فولت — أحضر كابل USB-C 3A.',
            'السطح 58.7°م بعد 15 دقيقة عند ~24 واط (محيط 28.1°م). بلا محلّل دخل AC في هذه الجولة — لا ننشر نسبة كفاءة %. وحدة واحدة مسترجعة 2026-07-24؛ قد تختلف الدفعات.',
        ],
    },
    localContext: {
        en:
            ...
            'ELECTRICITY: 25W for one hour ≈ 0.025 kWh → a few piastres on EgyptERA residential tariffs. No vampire/efficiency numbers here — we did not run PZEM on this sample.',
        ar:
            ...
            'الكهرباء: 25 واط لساعة ≈ 0.025 كيلوواط·ساعة → قروش على تعريفة EgyptERA السكنية. بلا أرقام vampire/كفاءة هنا — لم نشغّل PZEM على هذه العيّنة.',
    },
    specifications: {
        ...
        'GTIN / MPN': { en: 'GTIN 6956116750046 · MPN JR-TCF23', ar: 'GTIN 6956116750046 · MPN JR-TCF23' },
        'Rated Output': { en: '25W Max (single USB-C)', ar: '25 واط كحد أقصى (USB-C واحد)' },
        'PD Fixed Profiles (vendor + FNB58)': { en: '5V/3A (15W) · 9V/2.77A (~24.9W) — decoded on our sample', ar: '5V/3A (15 واط) · 9V/2.77A (~24.9 واط) — فُكّت على عيّنتنا' },
        ...
        'Plug (EU sample)': { en: 'EU Type-C 2-pin (Europlug) — direct fit for Egyptian wall sockets', ar: 'قابس أوروبي Type-C بسنّين (Europlug) — يدخل مباشرة في الفيش المصري' },
        ...
        'In the Box (CairoVolt listing)': { en: 'Charger only — USB-C cable not included in this SKU pack', ar: 'الشاحن فقط — كابل USB-C غير مرفق في عبوة هذا المنتج' },
        'Vs JR-TCF20 (candid)': { en: 'JR-TCF20 = 20W PD + QC3.0, NO PPS — Samsung SFC will not engage. JR-TCF23 = 25W with PPS 3.3–11V/2.25A — Samsung 25W SFC engages on our S24 sample.', ar: 'JR-TCF20 = 20 واط PD + QC3.0 بلا PPS — Samsung SFC لن يعمل. JR-TCF23 = 25 واط مع PPS 3.3–11V/2.25A — Samsung 25W SFC يعمل على عيّنة S24 لدينا.' },
        'Vs JR-TCF30 (candid)': { en: 'JR-TCF30 = dual USB-C + USB-A, shared 30W class. JR-TCF23 = single USB-C 25W PPS phone brick. Different jobs.', ar: 'JR-TCF30 = منفذا USB-C + USB-A بقدرة مشتركة فئة 30 واط. JR-TCF23 = منفذ USB-C واحد 25 واط PPS لهاتف. وظيفتان مختلفتان.' },
        'Recall Status': { en: 'No CPSC or Joyroom safety recall found for JR-TCF23 as of 2026-07-24 (cpsc.gov search returned zero hits for this MPN)', ar: 'لا يوجد استدعاء من CPSC أو Joyroom للطراز JR-TCF23 حتى 2026-07-24 (بحث cpsc.gov أعاد صفر نتائج لهذا الـ MPN)' },
    ...
    benchTest: {
        ...
        conditions: {
            en: 'One retail-stock unit (store SKU JC01) · CairoVolt lab, New Cairo · ambient 28.1°C · humidity 47% RH (HTC-2) · mains 222V (UT61E) · EU Europlug sample',
            ar: 'وحدة واحدة من مخزون التجزئة (SKU المتجر JC01) · مختبر كايرو فولت، القاهرة الجديدة · حرارة محيطة 28.1°م · رطوبة 47% (HTC-2) · جهد الحائط 222 فولت (UT61E) · عيّنة بقابس أوروبي',
        },
        methodology: {
            en:
                'JR-TCF23 was run under CairoVolt wall-charger protocol §7.1 on sample CV-CH-JRTCF23-001 (2026-07-24). ' +
                '(A) FNB58 fw v1.3 PD Info decode with no load — enumerated fixed PDOs and both PPS APDO windows. Critical check vs marketing: confirm PPS rails exist before claiming Samsung 25W SFC. ' +
                '(B–C) Each fixed rail and peak rail loaded on JUWEI 35W for 2 minutes; logged FNB58 V·A·W. ' +
                '(E) PPS programmed holds: 8.5V/2.5A, then 9.24V/2.71A, then 11V/2.22A for 5 minutes — voltage stability noted. ' +
                ...
                '(H) OCP: JUWEI request >3.0A on 9V rail. (K) Kkmoon 0.01g weight + Mitutoyo caliper. (L) Visual plug confirmation: EU Europlug 2-pin. ' +
            ...
            ar:
                ...
                '(A) فك FNB58 fw v1.3 لـ PD Info بلا حمل — أحصينا PDO الثابتة ونافذتَي PPS APDO. فحص حرج مقابل التسويق: تأكيد وجود منافذ PPS قبل ادعاء Samsung 25W SFC. ' +
                '(B–C) كل منفذ ثابت ومنفذ الذروة حُمّل على JUWEI 35W لدقيقتين؛ سجّلنا V·A·W من FNB58. ' +
                '(E) تثبيتات PPS مبرمجة: 8.5V/2.5A ثم 9.24V/2.71A ثم 11V/2.22A لمدة 5 دقائق — مع تسجيل ثبات الجهد. ' +
                ...
                '(H) OCP: طلب JUWEI >3.0A على منفذ 9V. (K) وزن Kkmoon 0.01 جرام + قدمة Mitutoyo. (L) تأكيد بصري للقابس: أوروبي Europlug بسنّين. ' +
        ...
        results: [
            { param: { en: 'PDOs decoded (FNB58)', ar: 'PDO المفكوكة (FNB58)' }, rated: '5V/3A · 9V/2.77A', measured: { en: '5V/3A + 9V/2.77A — matched vendor sheets (no phantom 12V/15V/20V)', ar: '5V/3A + 9V/2.77A — مطابق لكتيّبات الموزعين (بلا منفذ 12V/15V/20V وهمي)' }, note: { en: 'Fixed-rail set only two PDOs — 25W class via 9V/2.77A', ar: 'مجموعة ثابتة بمنفذين فقط — فئة 25 واط عبر 9V/2.77A' } },
            { param: { en: 'PPS APDO windows (FNB58)', ar: 'نوافذ PPS APDO (FNB58)' }, rated: '3.3–5.9V/3A · 3.3–11V/2.25A', measured: { en: 'BOTH present — confirmed on handshake; Samsung 25W SFC envelope available', ar: 'الاثنتان موجودتان — مؤكّدتان في المصافحة؛ ظرف Samsung 25W SFC متاح' }, note: { en: 'Critical vs JR-TCF20: that sibling has NO PPS. Claiming SFC without this decode would be false.', ar: 'حرج مقابل JR-TCF20: ذلك الشقيق بلا PPS. ادعاء SFC بلا هذا الفك يكون كاذبًا.' } },
            { param: { en: 'Peak 5V/3A rail', ar: 'ذروة منفذ 5V/3A' }, rated: '15W', measured: '14.7W (5.02V/2.93A)', note: { en: 'JUWEI 2 min hold — ≥95% of rated', ar: 'تثبيت JUWEI دقيقتان — ≥95% من الاسمي' } },
            ...
            { param: { en: 'Surface temp @~24W (15 min)', ar: 'حرارة السطح عند ~24 واط (15 دقيقة)' }, measured: '58.7°C', note: { en: 'Hottest of 4 IR points (center face); ambient 28.1°C. Warm for a compact PC brick — keep uncovered; add ~5°C in Cairo July rooms ~35°C', ar: 'أعلى نقطة من 4 قراءات IR (منتصف الوجه)؛ محيط 28.1°م. دافئ لشاحن PC مدمج — اتركه مكشوفًا؛ أضف ~5°م في غرف يوليو بالقاهرة ~35°م' } },
            { param: { en: 'Over-current protection (OCP)', ar: 'حماية التيار الزائد (OCP)' }, measured: { en: 'Cut in ~2.5 s when JUWEI requested >3.0A on 9V rail', ar: 'فصل خلال ~2.5 ثانية عند طلب JUWEI >3.0A على منفذ 9V' }, note: { en: 'Protection exercised on highest fixed PDO', ar: 'اختُبرت الحماية على أعلى PDO ثابت' } },
            { param: { en: 'Plug type (visual)', ar: 'نوع القابس (بصري)' }, rated: { en: 'EU Type-C Europlug (2-pin)', ar: 'أوروبي Type-C Europlug بسنّين' }, measured: { en: 'Confirmed — seats in Egyptian wall sockets without adapter', ar: 'مؤكّد — يدخل الفيش المصري بلا محوّل' }, note: { en: 'UK variant exists on joyroom.com (64g); our sample is EU', ar: 'نسخة UK موجودة على joyroom.com (64 جرامًا)؛ عيّنتنا EU' } },
            ...
            { param: { en: 'Dimensions (EU body)', ar: 'الأبعاد (جسم EU)' }, rated: '85.2 × 28 × 40 mm', measured: '85.0 × 28.1 × 40.2 mm', note: { en: 'Mitutoyo caliper — elongated Europlug brick, not a 32 mm cube', ar: 'قدمة Mitutoyo — قالب Europlug مستطيل، وليس كيوب 32 ملم' } },
            { param: { en: 'Wall efficiency / no-load draw', ar: 'كفاءة الحائط / الاستهلاك بلا حمل' }, measured: { en: 'NOT MEASURED — no PZEM AC analyzer on this pass', ar: 'غير مقيس — بلا محلّل PZEM AC في هذه الجولة' }, note: { en: 'Silence over invention — protocol §11.3', ar: 'الصمت أقوى من الاختراع — البروتوكول §11.3' } },
            { param: { en: 'Recall check (2026-07-24)', ar: 'فحص الاستدعاء (2026-07-24)' }, measured: { en: 'Not listed on cpsc.gov for JR-TCF23', ar: 'غير مدرج على cpsc.gov لـ JR-TCF23' }, note: { en: 'Joyroom official recall page not as centralized as Anker; we report CPSC zero-hit + no Joyroom notice found', ar: 'صفحة استدعاء Joyroom الرسمية أقل مركزية من أنكر؛ نذكر صفر نتائج CPSC + عدم العثور على إشعار Joyroom' } },
        ],
        verdict: {
        ...
        pros: [
            ...
            { en: '9V fixed rail delivered 24.4W (8.91V/2.74A) — ~98% of the 9V/2.77A PDO on JUWEI', ar: 'منفذ 9V الثابت أوصل 24.4 واط (8.91V/2.74A) — ~98% من PDO 9V/2.77A على JUWEI' },
            ...
            { en: 'Clear step-up from Joyroom JR-TCF20 for Samsung owners — TCF20 has no PPS; TCF23 does (measured)', ar: 'ترقية واضحة من Joyroom JR-TCF20 لأصحاب سامسونج — TCF20 بلا PPS؛ TCF23 يملكه (مقاس)' },
        ...
        limits: [
            ...
            { en: 'Single unit tested (CV-CH-JRTCF23-001) — production batches may vary', ar: 'وحدة واحدة مُختبرة (CV-CH-JRTCF23-001) — قد تختلف دفعات الإنتاج' },
        ],
    },
};

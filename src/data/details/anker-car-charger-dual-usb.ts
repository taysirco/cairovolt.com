// Details for: anker-car-charger-dual-usb
...
export const anker_car_charger_dual_usb_detail: ProductDetail = {
        ...
        specifications: { 'Total Output': { en: '48W (24W per port)', ar: '48 واط (24 واط لكل منفذ)' }, 'Ports': { en: '2× USB-A', ar: '2× USB-A' }, 'Input Voltage': { en: '12-24V DC', ar: '12-24 فولت DC' }, 'Technology': { en: 'PowerIQ 3.0', ar: 'PowerIQ 3.0' }, 'Material': { en: 'Aluminum alloy', ar: 'سبيكة ألومنيوم' }, 'Dimensions': { en: '62 × 30 × 30 mm', ar: '62 × 30 × 30 ملم' }, 'Weight': { en: '32g', ar: '32 جرام' }, 'Safety': { en: 'MultiProtect (OV/OC/OT/SC)', ar: 'MultiProtect (OV/OC/OT/SC)' } },
        labVerified: {

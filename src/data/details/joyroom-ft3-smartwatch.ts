// Details for: joyroom-ft3-smartwatch
...
export const joyroom_ft3_smartwatch_detail: ProductDetail = {
        ...
        specifications: { 'Display': { en: '1.85" HD IPS', ar: '1.85 بوصة HD IPS' }, 'Battery Life': { en: '7 days (14 days standard)', ar: '7 أيام (14 يوم عادي)' }, 'Water Resistance': { en: 'IP68', ar: 'IP68' }, 'Sensors': { en: 'Heart rate + SpO2 + Accelerometer', ar: 'نبض القلب + أكسجين الدم + مقياس تسارع' }, 'Connectivity': { en: 'Bluetooth 5.2', ar: 'بلوتوث 5.2' }, 'Dimensions': { en: '44 × 38 × 10.5 mm', ar: '44 × 38 × 10.5 ملم' }, 'Weight': { en: '38g', ar: '38 جرام' }, 'Safety': { en: 'IP68 waterproof + medical-grade sensor', ar: 'IP68 مقاوم للماء + حساس طبي' } },
        labVerified: {

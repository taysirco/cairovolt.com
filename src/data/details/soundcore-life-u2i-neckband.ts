...
export const soundcore_life_u2i_neckband_detail: ProductDetail = {
    ...
    specifications: {
        ...
        'Driver': { en: '10mm Graphene-Enhanced + BassUp', ar: '10mm جرافين + BassUp' },
        'ANC': { en: 'None (passive seal isolation)', ar: 'بدون (عزل سلبي بالسيل)' },
        'Codecs': { en: 'AAC, SBC', ar: 'AAC, SBC' },
        'Battery': { en: '22 hours', ar: '22 ساعة' },
        'Fast Charge': { en: '10 min = 3h playback', ar: '10 دقائق = 3 ساعات تشغيل' },
        'Bluetooth': { en: '5.0', ar: '5.0' },
        'Mic': { en: 'AI-enhanced noise reduction for calls', ar: 'مايك AI لعزل ضوضاء المكالمات' },
        'Water': { en: 'IPX5 (sweat + rain)', ar: 'IPX5 (عرق + مطر)' },
        'Weight': { en: '~28g', ar: '~28 جرام' },
        'Design': { en: 'Flexible neckband, magnetic earbuds', ar: 'نيكباند مرن، سماعات مغناطيسية' },
        'Safety': { en: 'FCC, CE Certified', ar: 'معتمد FCC, CE' },
    },
    labVerified: {
        result: { en: '10mm graphene + BassUp: bass response better than expected for neckband. Clear mids for podcasts/calls. 22h battery confirmed at 50% volume. 10min=2.8h measured. Neckband comfortable after 4h — sits on collarbone naturally. Magnetic earbuds snap together when not in use (auto-pause). IPX5: survived 45-min sweat-heavy gym.', ar: '10mm جرافين + BassUp: استجابة باس أحسن من المتوقع للنيكباند. ميد واضح للبودكاست/المكالمات. 22 ساعة بطارية متأكدة على 50% صوت. 10 دقائق=2.8 ساعة مقاسة. نيكباند مريح بعد 4 ساعات — بيقعد على عظمة الترقوة بشكل طبيعي. سماعات مغناطيسية بتتشبك مع بعض لما مش بتستخدمها (إيقاف تلقائي). IPX5: نجحت في 45 دقيقة جيم عرق شديد.' },
        conditions: { en: 'CairoVolt Lab + gym, Cairo — May 2026', ar: 'معمل كايرو فولت + جيم، القاهرة — مايو 2026' },

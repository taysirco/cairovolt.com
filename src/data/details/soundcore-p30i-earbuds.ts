...
export const soundcore_p30i_earbuds_detail: ProductDetail = {
    ...
    localContext: {
        ...
        ar: 'P30i هي النقطة المثالية بين P20i (بدون ANC) والـ P40i (ANC بريميوم). بـ 1,200 جنيه، أرخص من Liberty 4 NC (2,999) بـ 60% وبرضو فيها 42dB ANC، BassUp، وعلبة ستاند الموبايل الفريدة. أفضل لركاب مواصلات القاهرة اللي عايزين ANC محترم بدون ما يصرفوا 3K+.',
    },
    specifications: {
        'Product Type': { en: 'True Wireless (TWS) In-Ear', ar: 'لاسلكية حقيقية TWS داخل الأذن' },
        'Driver': { en: '10mm Dynamic + BassUp', ar: '10mm ديناميك + BassUp' },
        'ANC': { en: 'Adaptive ANC up to 42dB + Transparency', ar: 'ANC تكيّفي حتى 42dB + وضع شفافية' },

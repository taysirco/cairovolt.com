// Details for: anker-powerline-usb-c-lightning
import type { ProductDetail } from './_types';

export const anker_powerline_usb_c_lightning_detail: ProductDetail = {
        ...
        specifications: { 'Length': { en: '1.8m (6ft)', ar: '1.8 متر' }, 'Max Charging': { en: '30W PD', ar: '30 واط PD' }, 'Certification': { en: 'Apple MFi Certified', ar: 'معتمد من Apple MFi' }, 'Durability': { en: '30,000+ bends tested', ar: '30,000+ انحناءة مختبرة' }, 'Connector': { en: 'USB-C to Lightning', ar: 'USB-C إلى Lightning' }, 'Dimensions': { en: '0.9m length', ar: 'طول 0.9 متر' }, 'Weight': { en: '18g', ar: '18 جرام' }, 'Safety': { en: 'MFi certified + 12,000 bend lifespan', ar: 'معتمد MFi + عمر 12,000 انحناء' } },
        labVerified: {

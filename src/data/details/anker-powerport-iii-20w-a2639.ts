...
export const anker_powerport_iii_20w_a2639_detail: ProductDetail = {
  ...
  "ar": "في صيف القاهرة البريزة ممكن تعدّي 240 فولت والمروحة والراوتر على نفس المشترك، وده بالظبط وقت ما الشاحن الضعيف بيسخن. دايرة Superior Safety في الـ A2639 بتقيس الحرارة آلاف المرات في الثانية وبتحد الخرج، فطالب في المعادي يقدر يسيب الايفون بيشحن في عصر 41 درجة من غير راس ساخنة بتزن."
    ...
    specifications: {
  "Product Type": {
    "en": "USB-C Wall Charger (Cube)",
    "ar": "شاحن حائط USB-C (كيوب)"
  },
  "Total Output": {
    "en": "20W Max (5V/3A · 9V/2.22A · 12V/1.67A)",
    "ar": "20 واط كحد أقصى (5V/3A · 9V/2.22A · 12V/1.67A)"
  },
  "Technology": {
    "en": "USB-C Power Delivery 3.0 (PD) fast charging",
    "ar": "USB-C Power Delivery 3.0 شحن سريع"
  },
  "Ports": {
    "en": "1 × USB-C (PD)",
    "ar": "1 × USB-C (PD)"
  ...
  "Dimensions": {
    "en": "3.6 × 3.6 × 3.6 cm cube with fold-away prongs",
    "ar": "3.6 × 3.6 × 3.6 سم كيوب بقابس بيتطوي"
  },
  "Weight": {
    "en": "40 g",
    "ar": "40 جرام"

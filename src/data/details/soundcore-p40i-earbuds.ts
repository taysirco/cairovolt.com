...
export const soundcore_p40i_earbuds_detail: ProductDetail = {
    ...
    localContext: {
        ...
        ar: 'الـ P40i بين P20i الاقتصادية (699 جنيه، بدون ANC) والـ R50i NC البريميوم (1,199 جنيه، 42dB ANC). بـ 2,052 جنيه، هي فعلاً أغلى من R50i NC بس بتوفر 60 ساعة بطارية (مقابل 45 لـ R50i) وعلبة حامل موبايل. درايفر 11mm بيدي باس أقوى من 10mm بتاعة R50i. للمصريين اللي أولويتهم البطارية والباس، P40i هي الاختيار.',
    },
    specifications: {
        'Product Type': { en: 'True Wireless Earbuds (TWS)', ar: 'سماعة لاسلكية (TWS)' },
        'Driver': { en: '11mm Composite (BassUp)', ar: '11mm مركب (BassUp)' },
        'ANC': { en: 'Adaptive ANC (auto-adjusting)', ar: 'ANC تكيّفي (تلقائي)' },
        'Codecs': { en: 'AAC, SBC', ar: 'AAC, SBC' },
        'Battery (Earbuds)': { en: '12 hours (ANC off)', ar: '12 ساعة (بدون ANC)' },
        'Battery (Total)': { en: '60 hours', ar: '60 ساعة' },
    ...
    labVerified: {
        result: { en: '60h total battery confirmed. Adaptive ANC reduces ~25dB on Metro engine noise. 6-mic call quality clear in office environment (tested on Zoom). Phone stand case holds iPhone 17 Pro at stable viewing angle. BassUp effective on 11mm composite driver.', ar: '60 ساعة بطارية إجمالي متأكد منها. ANC تكيّفي بيقلل ~25dB صوت محرك المترو. جودة مكالمات 6 مايكات واضحة في بيئة مكتب (مختبر على Zoom). علبة حامل الموبايل بتمسك iPhone 17 Pro بزاوية مشاهدة مستقرة. BassUp فعّال على درايفر 11mm.' },
        conditions: { en: 'CairoVolt Lab, Cairo — May 2026, 80h testing cycle', ar: 'معمل كايرو فولت، القاهرة — مايو 2026، دورة اختبار 80 ساعة' },

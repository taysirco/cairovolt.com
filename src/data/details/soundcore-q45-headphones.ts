...
export const soundcore_q45_headphones_detail: ProductDetail = {
    ...
    localContext: {
        ...
        ar: 'العاملون عن بُعد في القاهرة بيواجهوا تحدي مزدوج: بيئات منزلية مزعجة (بناء، مرور، عيلة) وجلسات سماع طويلة (8+ ساعات). ساوندكور سبيس Q45 بتقدم عزل 98% تكيفي للعزل من الضوضاء، وسائد جلد بروتين لراحة طول اليوم، و50 ساعة بطارية ANC. بـ 4,685 جنيه، هي هيدفون المكتب المنزلي المحترف — جزء من سعر Sony WH-1000XM5 أو Bose 700.',
    },
    specifications: {
        'Product Type': { en: 'Over-Ear Closed-Back Headphones', ar: 'هيدفون فوق الأذن مغلق' },
        'Driver': { en: '40mm Silk+Ceramic Dual-Layer', ar: '40mm حرير+سيراميك مزدوج الطبقات' },
        'ANC': { en: '98% Adaptive (5 levels via app)', ar: '98% تكيفي (5 مستويات من التطبيق)' },
        'Codecs': { en: 'LDAC, AAC, SBC', ar: 'LDAC, AAC, SBC' },
        'Battery (ANC on)': { en: '50 hours', ar: '50 ساعة' },
        'Battery (ANC off)': { en: '65 hours', ar: '65 ساعة' },
    ...
    labVerified: {
        result: { en: '50h battery (ANC on) confirmed. 98% ANC verified across Metro, office, and simulated airplane noise. Protein leather cushion 8-hour comfort test passed. LDAC 990kbps audio quality verified on Samsung Galaxy S26 Ultra.', ar: 'بطارية 50 ساعة (مع ANC) متأكد منها. عزل 98% متأكد منه في المترو والمكتب وضوضاء طيارة محاكاة. اختبار راحة وسائد جلد بروتين 8 ساعات ناجح. جودة صوت LDAC 990kbps متأكد منها على سامسونج S26 الترا.' },
        conditions: { en: 'CairoVolt Lab, Cairo — May 2026, 96h testing cycle including comfort endurance and multi-environment ANC', ar: 'معمل كايرو فولت، القاهرة — مايو 2026، دورة اختبار 96 ساعة تشمل اختبار راحة وعزل متعدد البيئات' },

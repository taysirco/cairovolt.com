...
export const joyroom_magnetic_power_bank_10000_detail: ProductDetail = {
    ...
    benchTest: {
        ...
        equipment: [
            ...
            { name: 'BENETECH GM320 IR thermometer (ε=0.95)', use: { en: 'Pack top + iPhone back surface temperature — wired-only vs MagSafe 7.5W after 15 min', ar: 'حرارة سطح الحزمة وظهر الآيفون — سلكي فقط مقابل MagSafe 7.5 واط بعد 15 د' } },

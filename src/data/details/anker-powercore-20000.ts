...
// Lab sheet: CV-PB-A1260-001 — §7.3 gold-depth deepen (Port1/Port2 asymmetry · 61.4Wh consistency · Egypt/airline)
...
export const anker_powercore_20000_detail: ProductDetail = {
    ...
    benchTest: {
        ...
        conditions: {
            en: 'One retail-stock A1260011 unit · CairoVolt lab · ambient 27.8–28.5°C · Micro-USB recharge via Anker PowerPort+ 1 (A2013, QC 3.0 18W) · recall re-verified 2026-07-24',

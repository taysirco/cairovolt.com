...
export interface CategoryDiscoveryPresentation {
    ...
    imageBase: string;
    provenance: 'catalogue-cutout' | 'ai-assisted';
    tone: DiscoveryTone;
...
export const categoryDiscovery: Record<DiscoveryCollectionKey, CategoryDiscoveryCollection> = {
    anker: {
        ...
        title: {
            ar: 'اختر قسم منتجات انكر المناسب لجهازك',
        ...
        items: {
            '/anker/power-banks': {
                ...
                action: { ar: 'تصفّح باور بانك انكر', en: 'Browse Anker power banks' },
                signal: { ar: '10K–25K mAh', en: '10K–25K mAh' },
                alt: {
                    ar: 'باور بانك انكر Zolo أسود بكابل مدمج',
                    en: 'Black Anker Zolo power bank with a built-in cable',
                },
                imageBase: '/images/categories/anker/anker-power-banks-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'sky',
                visual: 'tall',
            },
            '/anker/wall-chargers': {
                ...
                action: { ar: 'تصفّح شواحن انكر', en: 'Browse Anker chargers' },
                signal: { ar: '20W–100W GaN', en: '20W–100W GaN' },
                alt: {
                    ar: 'شاحن انكر Nano أبيض بمنفذ USB-C',
                    en: 'White Anker Nano charger with a USB-C port',
                },
                imageBase: '/images/categories/anker/anker-wall-chargers-category-card-cairovolt-egypt-v2',
            ...
            '/anker/cables': {
                ...
                action: { ar: 'تصفّح كابلات انكر', en: 'Browse Anker cables' },
                signal: { ar: 'USB-C · Lightning', en: 'USB-C · Lightning' },
                alt: {
                    ar: 'كابل انكر USB-C أبيض مجدول',
                    en: 'White braided Anker USB-C cable',
                },
                imageBase: '/images/categories/anker/anker-cables-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'sand',
                visual: 'white',
            },
            '/anker/car-chargers': {
                ...
                action: { ar: 'تصفّح شواحن سيارة انكر', en: 'Browse Anker car chargers' },
                signal: { ar: 'MagSafe · USB-C PD', en: 'MagSafe · USB-C PD' },
                alt: {
                    ar: 'حامل وشاحن سيارة انكر مغناطيسي مع ملحقاته',
                    en: 'Anker magnetic car mount and charger kit with accessories',
                },
                imageBase: '/images/categories/anker/anker-car-chargers-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'mint',
                visual: 'wide',
            },
            '/soundcore': {
                headline: { ar: 'الصوت من عائلة انكر', en: 'Sound from the Anker family' },
                description: {
                    ar: 'ايربودز وهيدفون وسبيكرات ساوندكور للتركيز والمواصلات والبيت.',
                    en: 'Soundcore earbuds, headphones, and speakers for focus, travel, and home.',
                },
                action: { ar: 'استكشف ساوندكور', en: 'Explore Soundcore' },
                signal: { ar: 'موديلات مختارة · ANC وHi-Res', en: 'Select models · ANC + Hi-Res' },
                alt: {
                    ar: 'سماعات ساوندكور R50i NC السوداء مع علبة الشحن',
                    en: 'Black Soundcore R50i NC earbuds with their charging case',
                },
                imageBase: '/images/categories/anker/anker-soundcore-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'violet',
                visual: 'white',
            },
    ...
    joyroom: {
        ...
        items: {
            '/joyroom/audio': {
                ...
                imageBase: '/images/categories/joyroom/joyroom-audio-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'violet',
                visual: 'balanced',
            },
            '/joyroom/power-banks': {
                ...
                imageBase: '/images/categories/joyroom/joyroom-power-banks-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'sky',
                visual: 'white',
            },
            '/joyroom/wall-chargers': {
                ...
                imageBase: '/images/categories/joyroom/joyroom-wall-chargers-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'peach',
                visual: 'white',
            },
            '/joyroom/cables': {
                ...
                imageBase: '/images/categories/joyroom/joyroom-cables-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'mint',
                visual: 'white',
            },
            '/joyroom/smart-watches': {
                ...
                imageBase: '/images/categories/joyroom/joyroom-smart-watches-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'rose',
                visual: 'white',
            },
            '/joyroom/car-holders': {
                ...
                imageBase: '/images/categories/joyroom/joyroom-car-holders-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'cyan',
                visual: 'balanced',
            },
    ...
    jbl: {
        ...
        items: {
            '/jbl/speakers': {
                ...
                alt: {
                    ar: 'سماعة JBL Charge 5 سوداء على خلفية استوديو بيضاء',
                    en: 'Black JBL Charge 5 speaker on a white studio background',
                },
                imageBase: '/images/categories/jbl/jbl-speakers-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'peach',
                visual: 'balanced',
            },
            '/jbl/partybox': {
                ...
                alt: {
                    ar: 'بازوكا JBL PartyBox Stage 320 بإضاءة خضراء وعجلات',
                    en: 'JBL PartyBox Stage 320 with green lightshow and trolley handle',
                },
                imageBase: '/images/categories/jbl/jbl-partybox-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'violet',
                visual: 'tall',
            },
            '/jbl/headphones': {
                ...
                alt: {
                    ar: 'هيدفون JBL Tune 770NC لاسلكي فوق الأذن',
                    en: 'JBL Tune 770NC wireless over-ear headphones',
                },
                imageBase: '/images/categories/jbl/jbl-headphones-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'indigo',
                visual: 'white',
            },
            '/jbl/earbuds': {
                ...
                alt: {
                    ar: 'ايربودز JBL Tune Buds بعزل الضوضاء مع علبة الشحن',
                    en: 'JBL Tune Buds ANC earbuds with their charging case',
                },
                imageBase: '/images/categories/jbl/jbl-earbuds-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'cyan',
                visual: 'white',
            },
    ...
    soundcore: {
        ...
        title: {
            ar: 'عائلتان من ساوندكور لكل لحظة صوت',
        ...
        items: {
            '/soundcore/audio': {
                ...
                action: { ar: 'تصفّح سماعات ساوندكور', en: 'Browse Soundcore audio' },
                signal: { ar: 'موديلات مختارة · ANC وLDAC', en: 'Select models · ANC + LDAC' },
                alt: {
                    ar: 'سماعات ساوندكور Liberty 5 السوداء',
                    en: 'Black Soundcore Liberty 5 earbuds',
                },
                imageBase: '/images/categories/soundcore/soundcore-audio-category-card-cairovolt-egypt-v2',
                provenance: 'catalogue-cutout',
                tone: 'peach',
                visual: 'wide',
            },
            '/soundcore/speakers': {
                ...
                action: { ar: 'تصفّح سبيكرات ساوندكور', en: 'Browse Soundcore speakers' },
                signal: { ar: 'موديلات مختارة · IP67 وPartyCast', en: 'Select models · IP67 + PartyCast' },
                alt: {
                    ar: 'سبيكر ساوندكور Select 4 Go أسود محمول',
                    en: 'Black portable Soundcore Select 4 Go speaker',
                },
                imageBase: '/images/categories/soundcore/soundcore-speakers-category-card-cairovolt-egypt-v2',
                provenance: 'ai-assisted',
                tone: 'violet',
                visual: 'white',
            },

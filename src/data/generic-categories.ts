        ...
        content: {
            ar: {
                ...
                buyingTips: [
                    ...
                    'للابتوب: اختر Anker Prime 27650mAh — اختبار CairoVolt: MacBook Pro 16" من 0→50% في 28 دقيقة (250W)',
    ...
    },
    {
        ...
        content: {
            ar: {
                ...
                buyingTips: [
                    'إلغاء ضوضاء (ANC): Soundcore Liberty 4 NC — اختبار CairoVolt في مترو القاهرة: خفضت ضوضاء القطار 98dB إلى 42dB',
    ...
    },
    {
        ...
        content: {
            ...
            en: {
                ...
                buyingTips: [
                    'For iPhone 17: USB-C to USB-C with PD — CairoVolt test: PD cable delivers 60W actual (regular cable only 5W!)',
                    'Durability test: Anker PowerLine survived 25,000 bends — generic cable broke at 3,200 bends',
                    'Braided nylon: 365-day CairoVolt test — Anker cable stayed new, plastic cable degraded at 4 months',
                    'Right length: 1m for car/desk, 2m for bed — our test: zero charging speed difference between 1m and 2m',
                ],
            },
        },
        faq: {

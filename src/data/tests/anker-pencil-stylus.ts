...
export const anker_pencil_stylus_lab: ProductLabData = {
    labTests: [
        {
            scenario: { en: 'Anker Pencil A7139 — tilt sensitivity accuracy test across 5 iPad models', ar: 'قلم أنكر A7139 — اختبار دقة حساسية الميل على 5 موديلات آيباد' },
        ...
        {
            scenario: { en: 'Anker Pencil A7139 — palm rejection accuracy test (left-hand and right-hand)', ar: 'قلم أنكر A7139 — اختبار دقة رفض لمس الكف (يد شمال ويمين)' },
        ...
        {
            scenario: { en: 'Anker Pencil A7139 — battery endurance and charge speed test', ar: 'قلم أنكر A7139 — اختبار تحمل بطارية وسرعة شحن' },
    ...
    voiceFaqEn: [
        ...
        { question: 'Better than Apple Pencil?', answer: 'No — Apple Pencil is better with pressure sensitivity. But at 30% of the price, the Anker Pencil delivers 80% of the features. For students and notes, Anker is sufficient and sensible.' },
    ],
    isAccessoryFor: [

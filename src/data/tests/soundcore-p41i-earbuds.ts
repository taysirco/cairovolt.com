...
export const soundcore_p41i_earbuds_lab: ProductLabData = {
    ...
    voiceFaqAr: [
        ...
        { question: 'فيها LDAC؟', answer: 'لأ — P41i بتدعم AAC وSBC بس. لو محتاج LDAC: Liberty 4 NC (2,999 جنيه) أو Liberty 5 (2,499 جنيه).' },
    ],
    voiceFaqEn: [
        ...
        { question: 'Does it have LDAC?', answer: 'No — P41i supports AAC and SBC only. For LDAC: Liberty 4 NC (2,999 EGP) or Liberty 5 (2,499 EGP).' },
    ],
    isAccessoryFor: [

...
export const soundcore_life_u2i_neckband_lab: ProductLabData = {
    ...
    voiceFaqAr: [
        { question: 'ليه نيكباند مش TWS؟', answer: '3 أسباب: 1) مش بتضيع سماعة أبداً — بتتعلق على رقبتك. 2) أرخص: 739 جنيه أقل سعر ساوندكور. 3) بطارية 22 ساعة بدون علبة شحن. العيب: مش ديسكريت زي TWS.' },

    ...
    author: {
        ...
        translations: {
            ar: {
                ...
                metaDescription: 'اعرف الحقيقة العلمية الكاملة: هل الشحن السريع بيدمر بطارية الموبايل؟ اختبار 6 أشهر على 3 هواتف + نصائح حماية Battery Health. تابع التفاصيل والمقارنة بمصر.',

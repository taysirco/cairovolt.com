...
export const anker_original_website_verify_barcode_guide: BlogArticle = {
...
<h3>على الكارتون الخارجي</h3>
<p>دور على الملصق الأبيض على جانب أو قفا الكارتون. هتلاقي فيه:</p>
<ul style="line-height: 1.9; margin-right: 20px;">
<li>اسم المنتج (Product Name)</li>
<li>رقم الموديل (Model: مثلاً A2741)</li>
<li>شريط باركود</li>
<li>الرقم التسلسلي تحت الباركود مباشرة (مكتوب S/N أو Serial No.)</li>
</ul>

<h3>على المنتج نفسه</h3>
...
<h2>الخطوة 3 — إدخال الرقم والتحقق</h2>
...
<th style="padding: 12px; text-align: right;">النتيجة</th>
<th style="padding: 12px; text-align: right;">المعنى</th>
<th style="padding: 12px; text-align: right;">ماذا تفعل؟</th>
</tr>
</thead>
<tbody>
...
<h2>لو فشل التحقق — خطوات عملية</h2>

<h3>أولاً: تأكد من صحة الإدخال</h3>
<ul style="line-height: 1.9; margin-right: 20px;">
<li>تأكد إنك أدخلت الرقم التسلسلي مش رقم الموديل</li>
<li>تأكد إن كل الأحرف صح — الحرف O مش الصفر 0، الحرف I مش الرقم 1</li>
<li>بعض الأرقام بتكون عليها طبقة بلاستيك شفافة تخليها صعبة القراءة — استخدم التكبير</li>
</ul>
...
<p>للفهم الكامل لنظام Anker Verify وكيف تكشف التقليد المتطور، اقرأ مقالنا التفصيلي: <a href="/blog/anker-verify-serial-number-security-check">خطورة شواحن انكر التقليد — شرح نظام Anker Verify من الداخل</a>.</p>
...
<div style="background:linear-gradient(135deg,#eff6ff 0%,#dbeafe 100%);padding:18px;border-radius:12px;border-right:4px solid #2563eb;margin:20px 0;"><p style="margin:0;color:#1e40af;font-weight:600;">🛒 منتجات أنكر أصلية 100% بضمان كايرو فولت 18 شهر:</p><p style="margin:8px 0 0 0;color:#1e3a5f;line-height:2;">شواحن أصلية قابلة للتحقق: <a href="/anker/car-chargers/anker-a2741-charger-30w" style="color:#2563eb;font-weight:600;">شاحن أنكر 30 واط نانو</a> · <a href="/anker/wall-chargers/anker-nano-45w-smart-display-charger" style="color:#2563eb;font-weight:600;">شاحن أنكر 45 واط بشاشة</a> · <a href="/anker/cables/anker-a8050-usb-c-cable" style="color:#2563eb;font-weight:600;">كابل أنكر الأصلي USB-C</a>.</p></div>`,
        ...
        en: {
            ...
            faq: [
                {
                    question: 'Where do I find the Serial Number on an Anker product?',
                    answer: 'The serial number appears in two places: (1) on a label on the back or side of the product itself (labeled "S/N" or "Serial No.") — though not all products have this, and (2) on the outer packaging box — look for a white sticker with "Model," a barcode, and the serial number printed directly below the barcode.',
                },
                {
            ...
            content: `<p>Bought an Anker product and want to confirm it's genuine? Anker provides an official verification tool directly on their website, and this guide is dedicated purely to that walkthrough — every step on the official site: how to find the right number, how to enter it, what each result means, and what to do if verification fails.</p>

<p>If you haven't located the number itself yet, start with <a href="/en/blog/anker-serial-number-location-format-explained">where to find the Anker serial number and what its format looks like</a> — and for the full picture of every identification method, see <a href="/en/blog/how-to-identify-original-anker">the complete 5-method guide to identifying original Anker products</a>.</p>
...
<p>Before visiting the website, you need the serial number. It appears in two places:</p>

<h3>On the Outer Box</h3>
<p>Look for a white sticker on the side or back of the box containing:</p>
<ul style="line-height: 1.9; margin-left: 20px;">
<li>Product name</li>
<li>Model number (e.g., A2741)</li>
<li>A barcode</li>
<li>Serial number printed directly below the barcode (labeled S/N or Serial No.)</li>
</ul>

<h3>On the Product Itself</h3>
...
<li>Open your browser on your phone or computer</li>
<li>Navigate to: <a href="https://www.anker.com/verify" target="_blank" rel="noopener noreferrer">https://www.anker.com/verify</a></li>
<li>The page will display an input field for the serial number</li>
</ol>

<h2>Step 3 — Entering the Number and Verifying</h2>
...
<h2>If Verification Fails — Practical Steps</h2>

<h3>First: Verify Your Input</h3>
<ul style="line-height: 1.9; margin-left: 20px;">
<li>Confirm you're entering the serial number, not the model number</li>
<li>Check each character carefully — letter O vs. zero 0, letter I vs. number 1</li>
<li>Some labels have a plastic film over them that makes them harder to read — use phone zoom</li>
</ul>
...
<p>For a deep dive into what makes Anker serial numbers valid and how to identify sophisticated fakes, read: <a href="/en/blog/anker-verify-serial-number-security-check">Counterfeit Anker Danger — Inside the Anker Verify Security System</a>.</p>

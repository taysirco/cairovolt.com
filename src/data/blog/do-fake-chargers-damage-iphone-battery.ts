...
export const do_fake_chargers_damage_iphone_battery: BlogArticle = {
        ...
        translations: {
            ar: {
                ...
                quickAnswer: 'نعم، الشواحن التقليد تضر بطارية الايفون. التيار غير المنتظم يسبب سخونة زيادة تقلل عمر البطارية 30-50%. الحل: استخدم شاحن معتمد MFi مثل <a href="/anker/wall-chargers/anker-powerport-20w" style="color:#2563eb">Anker 20W</a> (400 جنيه) لحماية جهازك.',
                content: `
                                            <h2> الإجابة المختصرة: نعم، الشواحن التقليد ممكن تدمر بطارية الايفون </h2>
                                                <div class="quick-answer-inline" style = "background:#fef2f2;border-right:4px solid #ef4444;padding:14px 18px;border-radius:8px;margin:12px 0 20px;font-size:14px;color:#7f1d1d" role = "complementary" aria - label="تحذير مهم" >
                                                    <p><strong>❗ باختصار: </strong> نعم، الشواحن التقليد بتضر بطارية الايفون فعلاً — Battery Health بتنزل أسرع 2-3× من الطبيعي. الحل: شاحن Anker 20W (400 ج.م) أو <a href="/joyroom/wall-chargers/joyroom-20w-usb-c-charger" style="color:#2563eb">Joyroom 20W</a> (أقل من 200 ج.م).</p>
                                                        </div>
            ...
            en: {
                ...
                quickAnswer: 'Yes, fake chargers damage iPhone batteries. Irregular current causes overheating, reducing battery lifespan by 30-50%. Solution: use an MFi-certified charger like Anker 20W (EGP 400) to protect your device.',
                content: `
                                                                                                                                                                            <h2> Short Answer: Yes, Fake Chargers Can Destroy iPhone Battery </h2>
                                                                                                                                                                                <div class="quick-answer-inline" style = "background:#fef2f2;border-left:4px solid #ef4444;padding:14px 18px;border-radius:8px;margin:12px 0 20px;font-size:14px;color:#7f1d1d" role = "complementary" aria - label="Important Warning" >
                                                                                                                                                                                    <p><strong>❗ In short: </strong> Yes, fake chargers do harm iPhone batteries. Battery Health drops 2-3x faster than normal. Solution: Use an Anker 20W (EGP 400) or Joyroom 20W (under EGP 200) certified charger.</p>
                                                                                                                                                                                        </div>

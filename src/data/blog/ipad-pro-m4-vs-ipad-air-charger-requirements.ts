...
export const ipad_pro_m4_vs_ipad_air_charger_requirements: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'iPad Pro M4 (11" و 13") بيقبل شحن سريع لحد 38W عبر USB-C PD. iPad Air M2 بيقبل لحد 30W. Apple مش بتحط شاحن في العلبة — كابل USB-C بس. أفضل شاحن: Anker Nano 45W بـ 790 جنيه (يشحن الاتنين بأقصى سرعة). لو ميزانيتك أقل: Anker 30W بـ 430 جنيه كافي لـ iPad Air وهيشحن Pro بـ 30W (79% من أقصى سرعة).',

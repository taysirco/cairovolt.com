...
export const anker_serial_number_location_format_explained: BlogArticle = {
...
<h2>أولاً — الفرق بين سيريال نمبر ورقم الموديل</h2>
<p>كتير من الناس بيخلطوا بين رقمين مهمين على منتج انكر:</p>

<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead>
        <tr style="background:#f3f4f6;">
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">النوع</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">مثال</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">وظيفته</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">فين بيكون؟</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;font-weight:bold;color:#2563eb;">رقم الموديل (Model Number)</td>
            <td style="padding:12px;border:1px solid #d1d5db;font-family:monospace;">A2741, A2147, A1651</td>
            <td style="padding:12px;border:1px solid #d1d5db;">يحدد نوع المنتج — نفس الرقم في كل النسخ من نفس المنتج</td>
            <td style="padding:12px;border:1px solid #d1d5db;">واجهة المنتج أو العلبة</td>
        </tr>
...
<h3>1. شواحن انكر الحائط والسيارة</h3>
<p>الشواحن عادةً أصغر حجماً فمكان السيريال نمبر بيكون في واحد من مكانين:</p>
...
<div class="expert-callout" style="background:#fef3c7;border:1px solid #fcd34d;border-right:4px solid #f59e0b;padding:20px;margin:32px 0;border-radius:8px;">
    <p style="margin:0 0 8px 0;font-size:15px;color:#92400e;font-weight:bold;">💡 نصيحة عملية للشواحن:</p>
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        لو الشاحن صغير جداً والنص مش واضح — التقط صورة بالكاميرا وكبّر. كاميرا الموبايل بتقدر تقرأ نص حجمه 0.5مم على بلاستيك أبيض بسهولة عند التكبير. متحاولش تقرأه بالعين المجردة لو الإضاءة مش كويسة.
    </p>
</div>

<h3>2. باور بانكات انكر</h3>
<p>الباور بانك أكبر = أسهل في إيجاد السيريال. دوّر في 3 أماكن بالترتيب:</p>

<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:12px;"><strong>المكان الأول (الأكثر شيوعاً) — الجهة السفلية:</strong> ملصق يحتوي على اسم الموديل، السعة، الجهد، والسيريال نمبر في سطر "S/N" أو "Serial No.".</li>
    <li style="margin-bottom:12px;"><strong>المكان الثاني — الجهة الخلفية:</strong> بعض الموديلات بتحط السيريال في الوسط أو في ركن الجهة الخلفية.</li>
...
<h2>First — The Difference Between Serial Number and Model Number</h2>
<p>Many people confuse two important numbers on an Anker product:</p>

<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead>
        <tr style="background:#f3f4f6;">
            <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Type</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Example</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Purpose</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Location</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;font-weight:bold;color:#2563eb;">Model Number</td>
            <td style="padding:12px;border:1px solid #d1d5db;font-family:monospace;">A2741, A2147, A1651</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Identifies the product type — same number on every unit of that model</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Front of product or box</td>
        </tr>
        <tr style="background:#f9fafb;">
...
<h3>1. Anker Wall and Car Chargers</h3>
<p>Chargers are smaller, so the serial number location is one of two places:</p>
...
<div class="expert-callout" style="background:#fef3c7;border:1px solid #fcd34d;border-left:4px solid #f59e0b;padding:20px;margin:32px 0;border-radius:8px;">
    <p style="margin:0 0 8px 0;font-size:15px;color:#92400e;font-weight:bold;">💡 Practical tip for chargers:</p>
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        If the charger is very small and the text is unclear — take a photo with your camera and zoom in. A phone camera can easily read 0.5mm text on white plastic when zoomed. Do not try to read it with the naked eye in poor lighting.
    </p>
</div>

<h3>2. Anker Power Banks</h3>
<p>Power banks are larger = easier to find the serial. Check three locations in order:</p>

<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:12px;"><strong>Location #1 (most common) — Bottom:</strong> A sticker containing the model name, capacity, voltage, and serial number in a line labeled "S/N" or "Serial No."</li>
    <li style="margin-bottom:12px;"><strong>Location #2 — Back:</strong> Some models place the serial in the center or corner of the back panel.</li>
    <li style="margin-bottom:12px;"><strong>Location #3 — Inside the box:</strong> If not found on the device, look for it on a sticker inside the cardboard box or on the side of the outer packaging.</li>
</ul>

<h3>3. Soundcore Earbuds and Headphones from Anker</h3>
<p>Earbuds pose a greater challenge due to their small size. Common locations:</p>

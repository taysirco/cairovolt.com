...
export const anker_authentic_charger_price_list_egypt: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'أسعار شواحن انكر الأصلية في مصر 2026: شواحن حائط 20-30W: 350-650 جنيه. شواحن حائط 45-65W GaN: 750-1,200 جنيه. شواحن 100W+ GaN متعدد منافذ: 1,400-2,200 جنيه. شواحن سيارة: 350-650 جنيه. أي سعر أقل من 60% من السعر الرسمي = شاحن مقلد على الأغلب.',
            content: `<p>بتدور على شاحن انكر وبتلاقي أسعار مختلفة جداً — نفس الموديل بـ 250 جنيه في مكان وبـ 700 جنيه في مكان تاني. الفرق مش في البائع — الفرق في الأصالة. شاحن انكر أصلي ليه نطاق سعر واضح في مصر. أي سعر تحته بكتير = مشكلة. وده الدليل الكامل بالأرقام.</p>
...
<div class="quick-answer-inline" style="background:#fef2f2;border-right:4px solid #dc2626;padding:16px 20px;margin:24px 0;border-radius:8px;">
    <p style="margin:0;color:#991b1b;font-size:15px;line-height:1.8;">
        <strong>⚠️ قاعدة 60%:</strong> لو الشاحن بيُباع بأقل من 60% من السعر الرسمي، احتمال إنه مزيف عالي جداً. مثال: شاحن انكر 45W أصله 850 جنيه — لو بتلاقيه بـ 350 جنيه على Facebook أو OLX، السؤال الصح مش "هل ده عرض كويس؟" السؤال الصح هو "هل ده أصلي؟"
    </p>
</div>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    ...
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;font-weight:bold;">السعر أقل من 60% من الرسمي</td>
            <td style="padding:12px;border:1px solid #d1d5db;">المكونات الداخلية مقلّدة أو رديئة — هيبوظ سريع وهيضر التليفون</td>
        </tr>
        <tr style="background:#f9fafb;">
            ...
            <td style="padding:12px;border:1px solid #d1d5db;">انكر الأصلي بيطبع بدقة شديدة — أي خطأ في الكتابة = مزيف</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;font-weight:bold;">مفيش رقم سيريال أو باركود على العلبة</td>
            <td style="padding:12px;border:1px solid #d1d5db;">كل منتج انكر أصلي فيه سيريال نمبر للتحقق عبر anker.com</td>
        </tr>
        <tr style="background:#f9fafb;">
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;font-weight:bold;">بيسخن كتير من أول استخدام</td>
            <td style="padding:12px;border:1px solid #d1d5db;">الشاحن الأصلي فيه دائرة حماية حرارية — المقلّد مفيهاش</td>
        </tr>
        <tr>
        ...
        كل الشواحن المذكورة في هذا الدليل متاحة على <strong>كايرو فولت.كوم</strong> بالسعر الرسمي مع ضمان 18 شهر. لا تزيد ولا تنقص — السعر اللي شايفه هو السعر المعلن على المتجر بضمان مكتوب. توصيل لكل المحافظات + دفع عند الاستلام.
            ...
            faq: [
                ...
                },
                {
                    ...
                    answer: 'نعم في أغلب الحالات. شاحن GaN أصغر حجماً بـ 30-40%، يسخن أقل بـ 20-30%، وأكثر كفاءة في استهلاك الكهرباء. لو محتاج شاحن سفر أو مكتب — GaN يستحق. للاستخدام المنزلي الثابت، الشاحن العادي يكفي.'
                },
                {
...
<div class="quick-answer-inline" style="background:#fef2f2;border-left:4px solid #dc2626;padding:16px 20px;margin:24px 0;border-radius:8px;">
    <p style="margin:0;color:#991b1b;font-size:15px;line-height:1.8;">
        <strong>⚠️ The 60% Rule:</strong> If a charger is selling for less than 60% of the official price, the probability of it being counterfeit is very high. Example: an Anker 45W charger officially costs 850 EGP — if you find it for 350 EGP on Facebook or OLX, the right question is not "Is this a good deal?" The right question is "Is this real?"
    </p>
</div>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    ...
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;font-weight:bold;">Price below 60% of official</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Internal components are counterfeit or substandard — will fail fast and can damage your phone</td>
        </tr>
        <tr style="background:#f9fafb;">
            ...
            <td style="padding:12px;border:1px solid #d1d5db;">Genuine Anker packaging is precisely printed — any text error means counterfeit</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;font-weight:bold;">No serial number or barcode on the box</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Every genuine Anker product has a serial number verifiable at anker.com</td>
        </tr>
        <tr style="background:#f9fafb;">
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;font-weight:bold;">Gets very hot from first use</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Genuine chargers have thermal protection circuits — counterfeits do not</td>
        </tr>
        <tr>
        ...
        All chargers in this guide are available on <strong>CairoVolt.com</strong> at official pricing with an 18-month warranty. No markups, no shortcuts — the price you see is the listed store price backed by a written warranty. Delivery to all governorates + cash on delivery.
            ...
            faq: [
                ...
                },
                {
                    ...
                    answer: 'Yes in most cases. A GaN charger is 30-40% smaller, runs 20-30% cooler, and is more energy-efficient. If you need a travel or desk charger — GaN is worth the premium. For fixed home use, a standard charger is sufficient.'
                },
                {

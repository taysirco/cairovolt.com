...
export const chargers_ramadan_night_long_charging_sessions: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            metaDescription: 'دليل شامل لشحن الموبايل بالليل في رمضان بأمان. إزاي تختار شاحن بحماية حرارية متقدمة يتحمل 8+ ساعات شحن بدون ما يضر بطاريتك — بأرقام حقيقية.',

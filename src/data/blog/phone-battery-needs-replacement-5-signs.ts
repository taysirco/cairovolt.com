...
export const phone_battery_needs_replacement_5_signs: BlogArticle = {
...
<h2>العلامة 1: البطارية بتخلص في نص اليوم — رغم إنك مش بتستخدم الموبايل كتير</h2>

<p>دي أول علامة الناس بتلاحظها — وأكترها شيوعاً. الموبايل اللي كان بيكمّل اليوم كامل ببطاريته — دلوقتي بيوصل الضهر وهو عند 20%. مش لأنك بتستخدمه أكتر — لأن البطارية مش بتخزّن نفس كمية الطاقة اللي كانت بتخزّنها وهي جديدة.</p>
...
<p><strong>نقطة مهمة:</strong> قبل ما تحكم — تأكد إن مفيش تطبيقات بتاكل البطارية في الخلفية. روح إعدادات البطارية وشوف أكتر التطبيقات استهلاكاً. لو في تطبيق واحد بياكل 30-40% — المشكلة في التطبيق مش في البطارية. بس لو الاستهلاك متوزع طبيعي والبطارية لسه بتخلص بسرعة — البطارية هي السبب.</p>

<h2>العلامة 2: الموبايل بيقفل فجأة عند 20-30% شحن</h2>

<p>دي من أوضح العلامات — وأكترها إزعاجاً. البطارية بتقول 25% — وفجأة الموبايل بيتطفي كإنه وصل 0%. بتوصّله بالشاحن — بيفتح وبيقول 22%. إيه اللي حصل؟</p>
...
<p>كل موبايل بيسخن شوية أثناء الشحن أو اللعب — ده طبيعي. اللي مش طبيعي إن الموبايل يسخن وإنت بس بتقرأ واتساب أو بتتصفح فيسبوك. السخونة الزيادة في الاستخدام العادي ممكن تكون علامة على:</p>

<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:10px;">🔋 <strong>بطارية متقادمة:</strong> المقاومة الداخلية (Internal Resistance) بتزيد مع الوقت — وده بيحوّل جزء أكبر من الطاقة لحرارة بدل ما يوصّلها للمعالج والشاشة.</li>
    <li style="margin-bottom:10px;">🔥 <strong>بطارية بدأت تتلف كيميائياً:</strong> لو السخونة مصحوبة بانتفاخ (العلامة 5) — ده أخطر وممكن يكون علامة على تحلل كيميائي داخلي.</li>
</ul>

<p><strong>إزاي تفرّق:</strong> لو الموبايل بيسخن بس مع الألعاب الثقيلة والشحن السريع — ده طبيعي غالباً (خصوصاً في صيف مصر). بس لو بيسخن وإنت مش بتعمل حاجة تقيلة — ده السخونة جاية من البطارية نفسها.</p>

<h2>العلامة 4: البطارية بتنزل وهي بتشحن — أو مش بتثبت حتى</h2>

<p>وصّلت الشاحن — البطارية عند 45% — وبعد 10 دقايق بصيت: 43%. الشاحن متوصل بس البطارية بتنزل! أو في أحسن الحالات — بتثبت على نفس الرقم ومش بتزيد. ده بيحصل لما:</p>
...
<p>دي العلامة الوحيدة اللي <strong>مش محتاج تستنى عليها أو تختبرها</strong> — لو شفتها اتصرف فوراً. البطارية المنتفخة (Swollen Battery) معناها إن تفاعل كيميائي غير طبيعي حصل جوا الخلايا وأنتج غاز — والغاز ده بيضغط على الغلاف الخارجي للبطارية وبيدفع الظهر أو الشاشة للبرا.</p>

<p><strong>العلامات:</strong></p>
<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:8px;">📐 الظهر مش مسطح — فيه نتوء أو انحناء واضح (حط الموبايل على سطح مسطح — لو بيتأرجح، في انتفاخ).</li>
    <li style="margin-bottom:8px;">📱 الشاشة بدأت تتفصل عن الفريم — خصوصاً من الجوانب أو من تحت.</li>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead><tr style="background:#f3f4f6;">
        <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">الخيار</th>
        <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">التكلفة التقريبية</th>
        <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">مناسب لو</th>
    </tr></thead>
    <tbody>
    <tr>
...
<h2>Sign 1: Battery Dies by Midday — Despite Light Usage</h2>

<p>This is the first sign people notice — and the most common. The phone that used to last a full day now hits 20% by noon. Not because you're using it more — because the battery simply can't store the same amount of energy it could when new.</p>
...
<p><strong>Important note:</strong> Before judging — check if any apps are draining battery in the background. Go to battery settings and see which apps consume the most. If one app is eating 30-40% — the problem is the app, not the battery. But if consumption is distributed normally and the battery still drains fast — the battery is the cause.</p>

<h2>Sign 2: Phone Shuts Down Suddenly at 20-30% Charge</h2>

<p>This is one of the clearest signs — and the most annoying. The battery reads 25% — and suddenly the phone powers off as if it hit 0%. You plug it in — it turns on showing 22%. What happened?</p>
...
<p>Every phone gets slightly warm during charging or gaming — that's normal. What's not normal is the phone heating up while you're just reading WhatsApp or browsing Facebook. Excess heat during normal use can indicate:</p>

<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:10px;">🔋 <strong>Aging battery:</strong> Internal Resistance increases over time — converting more energy to heat instead of delivering it to the processor and screen.</li>
    <li style="margin-bottom:10px;">🔥 <strong>Chemically degrading battery:</strong> If heat is accompanied by swelling (Sign 5) — this is more dangerous and may indicate internal chemical decomposition.</li>
</ul>

<p><strong>How to distinguish:</strong> If the phone heats up only during heavy gaming and fast charging — that's usually normal (especially in Egyptian summers). But if it heats up when you're not doing anything intensive — the heat is coming from the battery itself.</p>

<h2>Sign 4: Battery Percentage Drops While Charging — Or Won't Even Hold Steady</h2>

<p>You plugged in the charger — battery at 45% — and 10 minutes later you check: 43%. The charger is connected but the battery is dropping! Or at best — it stays at the same number and won't increase. This happens when:</p>
...
<p>This is the one sign you <strong>don't need to wait on or test</strong> — if you see it, act immediately. A swollen battery means an abnormal chemical reaction has occurred inside the cells, producing gas — and that gas pushes against the battery's outer casing, forcing the back panel or screen outward.</p>

<p><strong>The signs:</strong></p>
<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:8px;">📐 The back isn't flat — there's a visible bump or curve (place the phone on a flat surface — if it wobbles, there's swelling).</li>
    <li style="margin-bottom:8px;">📱 The screen is starting to separate from the frame — especially from the sides or bottom.</li>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead><tr style="background:#f3f4f6;">
        <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Option</th>
        <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Approximate Cost</th>
        <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Best When</th>
    </tr></thead>
    <tbody>
    <tr>

...
export const phone_battery_needs_replacement_5_signs: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            metaDescription: 'بطارية موبايلك بتخلص بسرعة أو بتقفل لوحدها؟ 5 علامات واضحة إنها محتاجة تتغيّر — وإزاي تتأكد قبل ما تدفع فلوس في بطارية جديدة.',

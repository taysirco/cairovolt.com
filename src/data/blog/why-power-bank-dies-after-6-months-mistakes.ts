...
export const why_power_bank_dies_after_6_months_mistakes: BlogArticle = {
...
<div class="expert-callout" style="background:#f9fafb;border:1px solid #e5e7eb;border-right:4px solid #059669;padding:20px;margin:32px 0;border-radius:8px;">
    <p style="margin:0 0 8px 0;font-size:15px;color:#059669;font-weight:bold;">🔬 اختبار كايرو فولت — بيانات 18 شهر:</p>
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        تتبعنا 312 باور بانك مباع لعملائنا من يناير 2025 لمايو 2026. قسّمنا العملاء حسب عاداتهم.
        <strong>النتيجة:</strong> اللي اتبعوا قواعد الشحن الصحيحة — 94% من الأجهزة لسه بتشتغل بكفاءة فوق 85% من السعة الأصلية. اللي كانوا بيسيبوا الباور بانك يوصل 0% يومياً وبيشحنوه في العربية — 41% اشتكوا من فقدان ملحوظ في السعة بعد 6-8 شهور بس.
    </p>
</div>

<h2>الخطأ #1 — تفريغ الباور بانك لـ 0% كل مرة</h2>
<p>ده أكتر خطأ منتشر في مصر. بتفضل تستخدم الباور بانك لحد ما يطفي تماماً — وبعدين تشحنه. "أنا بحب أستنفد كل الشحن الأول". المشكلة؟ خلايا الليثيوم مش بتحب الأطراف — لا 0% ولا 100%.</p>

<p>العلم وراها بسيط: كل خلية ليثيوم أيون فيها عمر محسوب بعدد الدورات (Cycle Count). الدورة = تفريغ من 100% لـ 0% وشحن تاني. لكن — وده المهم — لو فرّغتها من 100% لـ 20% بس وشحنتها، ده بيتحسب 0.8 دورة مش دورة كاملة. يعني بتكسب 20% عمر إضافي في كل استخدام.</p>
...
<p>الطريقة الصحيحة بالتفصيل موجودة في <a href="/blog/how-to-charge-power-bank-correctly" style="color:#2563eb;font-weight:600;">دليل شحن الباور بانك الصحيح</a>.</p>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead>
        <tr style="background:#f3f4f6;">
            ...
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">تفسيرها</th>
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">الإجراء</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">بيشحن الموبايل مرة بدل مرتين</td>
            <td style="padding:12px;border:1px solid #d1d5db;">السعة الفعلية نزلت 40-50%</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#ca8a04;">⚠️ لسه ينفع — غيّر عاداتك</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">بيسخن جداً أثناء الشحن (فوق 50°م)</td>
            <td style="padding:12px;border:1px solid #d1d5db;">خلايا متدهورة أو دائرة حماية ضعيفة</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;">🔴 توقف عن استخدامه فوراً</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">بينتفخ (الغلاف بيتحدب)</td>
            <td style="padding:12px;border:1px solid #d1d5db;">غازات داخلية — خطر انفجار</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;">🔴 ارميه فوراً بطريقة آمنة</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">بيفصل فجأة عند 20-30%</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Fuel Gauge غير معاير أو خلايا ضعيفة</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#ca8a04;">⚠️ جرّب إعادة معايرة (شحن كامل + تفريغ كامل مرة واحدة)</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">وقت الشحن زاد الضعف</td>
            <td style="padding:12px;border:1px solid #d1d5db;">مقاومة داخلية عالية</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;">🔴 استبدله — مش هيتحسن</td>
        </tr>
    </tbody>
</table>
            ...
            faq: [
                {
                    ...
                    answer: 'نادر جداً مع البراندات الأصلية (Anker/Joyroom) لإن فيهم رقاقات حماية بتقطع التيار عند 60°م. لكن الباور بانكات المقلّدة (من OLX أو الرصيف) ممكن فعلاً تنتفخ أو تشتعل — لإن مفيهاش حماية حرارية. القاعدة: متسيبش أي باور بانك في عربية مقفولة صيفاً، أصلي أو مقلّد.'
                },
                {
                    question: 'لو الباور بانك فقد نص سعته، أقدر أرجعه زي الأول؟',
                    answer: 'لا. فقدان سعة الليثيوم دائم — مفيش طريقة تعيد الخلايا لحالتها الأصلية. اللي تقدر تعمله: (1) إعادة معايرة Fuel Gauge (شحن 100% + تفريغ لـ 5% مرة واحدة) — ده بيصلح قراءة الشاشة مش الخلايا. (2) تغيير عاداتك لإبطاء التدهور. لو السعة نزلت تحت 60%، الأوفر تشتري جديد.'
                },
                {
                ...
                },
                {
                    ...
                    answer: 'لو الباور بانك بيدعم الشحن السريع رسمياً (زي Anker ZOLO A1681 بدعم 45W) — لا، مش بيضره. الرقاقة الداخلية بتنظم التيار. لكن لو استخدمت شاحن 65W على باور بانك أقصاه 18W — الشاحن هيطلع 18W بس (الباور بانك بيفاوض تلقائياً). المشكلة الحقيقية في الشواحن المقلّدة اللي مش بتفاوض وبتدفع جهد غير مستقر.'
                }
            ]
        },
        en: {
...
<h2>Mistake #1 — Draining the Power Bank to 0% Every Time</h2>
<p>This is the most common mistake in Egypt. You use the power bank until it shuts off completely — then charge it. "I like to use every last drop first." The problem? Lithium cells hate extremes — neither 0% nor 100%.</p>

<p>The science is straightforward: every lithium-ion cell has a lifespan measured in cycle count. One cycle equals draining from 100% to 0% and charging back. But — and this is crucial — if you drain from 100% to only 20% and recharge, that counts as 0.8 cycles, not a full cycle. You gain 20% extra lifespan with every use.</p>
...
<p>The complete correct charging method is detailed in <a href="/en/blog/how-to-charge-power-bank-correctly" style="color:#2563eb;font-weight:600;">How to Charge a Power Bank Correctly</a>.</p>
...
<ul style="list-style:none;padding:0;">
    ...
    <li style="margin-bottom:12px;">📅 <strong>Every 3 Months:</strong> Pull out the power bank and check its level. If it has dropped below 30%, charge it back to 50%. Five minutes every 3 months protects your investment.</li>
    <li style="margin-bottom:12px;">⚡ <strong>Advantage:</strong> The <a href="/en/anker/power-banks/anker-zolo-a110e-20000" style="color:#2563eb;font-weight:600;">Anker ZOLO A110E</a> (1,730 EGP) has a digital display — you can see the percentage instantly without needing to plug it in.</li>
</ul>

<h2>How to Tell If Your Power Bank Battery Is Dying</h2>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    ...
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">Charges phone once instead of twice</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Effective capacity dropped 40-50%</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#ca8a04;">⚠️ Still usable — change your habits</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">Gets very hot during charging (over 50°C)</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Degraded cells or weak protection circuit</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;">🔴 Stop using immediately</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">Swelling (case bulging)</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Internal gas buildup — explosion risk</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;">🔴 Dispose of safely immediately</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">Shuts off suddenly at 20-30%</td>
            <td style="padding:12px;border:1px solid #d1d5db;">Uncalibrated Fuel Gauge or weak cells</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#ca8a04;">⚠️ Try recalibration (one full charge + drain cycle)</td>
        </tr>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">Charging time doubled</td>
            <td style="padding:12px;border:1px solid #d1d5db;">High internal resistance</td>
            <td style="padding:12px;border:1px solid #d1d5db;color:#dc2626;">🔴 Replace it — it will not improve</td>
        </tr>
    </tbody>
</table>

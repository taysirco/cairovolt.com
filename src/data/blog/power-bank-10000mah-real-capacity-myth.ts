...
export const power_bank_10000mah_real_capacity_myth: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'باور بانك 10,000mAh بيشحن موبايل 5,000mAh مرة واحدة ونصف فقط — وليس مرتين. السبب: تحويل الجهد من 3.7V لـ 5V بيضيع 25-35% من الطاقة كحرارة. القاعدة الذهبية: اضرب سعة الباور بانك × 0.65 = السعة الفعلية. يعني 10,000 × 0.65 = 6,500mAh فعلية. اختبار كايرو فولت أثبت: أنكر PowerCore 10000 أعطى كفاءة 68% (الأعلى)، بينما باور بانك تقليد أعطى 52% فقط.',
            content: `

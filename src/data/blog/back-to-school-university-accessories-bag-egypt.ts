...
export const back_to_school_university_accessories_bag_egypt: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'طالب الجامعة في مصر محتاج 6 قطع أساسية: (1) باور بانك 10,000mAh خفيف زي Anker ZOLO A110D بـ 1270 جنيه، (2) شاحن سريع 20W زي Anker PowerPort 20W بـ 350 جنيه، (3) كابل USB-C متين بـ 150-200 جنيه، (4) سماعة بلوتوث TWS اقتصادية زي Soundcore P20i بـ 699 جنيه، (5) ساعة ذكية بميزانية زي Joyroom FT3 بـ 1092 جنيه، (6) منظم كابلات. الميزانية الكاملة: 2,500-3,800 جنيه.',

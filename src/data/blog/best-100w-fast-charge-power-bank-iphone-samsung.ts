...
export const best_100w_fast_charge_power_bank_iphone_samsung: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            metaDescription: 'iPhone 17 يقف عند 30W و Galaxy S26 Ultra عند 45W — فلماذا تحتاج باور بانك 100W؟ 3 أسباب علمية + أفضل خيارين مختبرين في مصر 2026.',
            keywords: 'باور بانك 100 واط, باور بانك ايفون 17, باور بانك سامسونج S26, شحن سريع باور بانك, anker prime 165w, anker 737 140w, باور بانك لابتوب وموبايل, 100w power bank iphone samsung egypt, افضل باور بانك شحن سريع 2026',
            ...
            quickAnswer: 'iPhone 17 Pro Max يحد الشحن عند 30W و Galaxy S26 Ultra عند 45W — لكن باور بانك 100W+ يستحق الفرق لـ 3 أسباب: (1) شحن جهازين معاً بكامل السرعة، (2) إعادة شحن الباور بانك نفسه في 30-50 دقيقة، (3) شحن لابتوب طوارئ. أفضل خيارين: Anker Prime 165W (3,950ج) و Anker 737 140W (4,999ج).',
...
<ul style="list-style:none;padding:0;">
    ...
    <li style="margin-bottom:12px;">⏱️ <strong>شحن ذاتي 100W input:</strong> من 0 إلى 80% في 35 دقيقة فقط مع شاحن Anker Prime 100W.</li>
...
<div class="cta-box" style="background:#f0fdf4;border:1px solid #86efac;padding:20px;margin:32px 0;border-radius:8px;">
    ...
    <p style="margin:0;color:#15803d;font-size:15px;line-height:1.8;">
        <strong>لو بتشحن موبايل بس (iPhone 17 / S26):</strong> Anker ZOLO 45W (2,200ج) كافي تماماً ووفّر 1,750ج.
        <strong>لو عندك لابتوب + بتسافر:</strong> Anker Prime 165W (3,950ج) — الأفضل قيمة لكل وات.
        <strong>لو بتحتاج متانة أعلى:</strong> Anker 737 140W (4,999ج) بدون أجزاء متحركة.
        كلهم متاحون على كايرو فولت بضمان أصلي 18-24 شهر + توصيل لكل المحافظات + دفع عند الاستلام.
            ...
            faq: [
                ...
                },
                {
                    ...
                    answer: 'الـ Output هو الكهرباء اللي بتطلع من الباور بانك لأجهزتك. الـ Input هي السرعة اللي بيشحن بيها الباور بانك نفسه. باور بانك 100W output ممكن يكون 30W input فقط — يعني يطلع طاقة بسرعة لكن يحتاج 5+ ساعات يمتلي. Anker Prime 165W يدعم 100W input — يمتلي من 0 إلى 80% في 35 دقيقة فقط.',
                },
                {
                    question: 'هل أقدر أركّب باور بانك 25,000mAh في الطيارة؟',
                    answer: 'نعم، Anker Prime A1695 سعة 92.7Wh — أقل من حد TSA الدولي وحد الطيران المصري (100Wh). مسموح في حقيبة اليد فقط (لا تضعه في الشحن). أي باور بانك أكبر من 100Wh ممنوع تماماً. التحقق: ابحث عن رقم Wh مطبوع على الجسم — لو غير موجود فهو غير معتمد للطيران.',
                },
                {
                    question: 'هل Galaxy S26 Ultra محتاج باور بانك 100W علشان شحن سريع 45W؟',
                    answer: 'لا، أي باور بانك يدعم USB-C PD 3.0 بقدرة 45W+ يكفي لتشغيل Super Fast Charging على S26 Ultra. حتى Anker ZOLO 45W (2,200ج) يعطي الـ 45W الكاملة. الترقية لـ 100W+ تفيد فقط لو هتشحن S26 Ultra + لابتوب معاً، أو لو محتاج إعادة شحن الباور بانك نفسه بسرعة.',
                },
            ],
        },
        en: {

...
export const anker_agent_egypt_branches_warranty_rules: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'ضمان Anker في مصر 18 شهر من تاريخ الشراء من الموزع الرسمي (كايرو فولت). بيغطي عيوب التصنيع والأعطال التلقائية. مش بيغطي: الكسر، الماء، الجهد الغلط، والتلف المتعمد. المطلوب: فاتورة الشراء الأصلية + المنتج. التقديم عبر info@cairovolt.com أو من خلال صفحة الضمان على الموقع.',
...
<strong>الإجابة السريعة:</strong> ضمان Anker في مصر 18 شهر من كايرو فولت (الموزع الرسمي). بيغطي عيوب التصنيع والأعطال التلقائية. المطلوب: فاتورة الشراء + المنتج. التقديم عبر info@cairovolt.com.
</div>
...
<th style="padding: 12px; text-align: right;">العلامة التجارية</th>
<th style="padding: 12px; text-align: center;">مدة الضمان</th>
...
<h3>مش مغطى بالضمان</h3>
<ul style="line-height: 1.9; margin-right: 20px;">
<li>تلف الماء أو الرطوبة (حتى رشة مطر خفيفة)</li>
<li>الكسر أو الصدمة الجسدية (وقع أو اتعصر)</li>
<li>استخدام جهد كهربائي غير مناسب (مثلاً شاحن 110V في شبكة 220V)</li>
<li>تلف ناتج عن تعديل أو فتح المنتج</li>
<li>الاستهلاك الطبيعي (مثلاً: بطارية Power Bank نقص سعتها بعد 2-3 سنين — ده طبيعي)</li>
<li>تلف ناتج عن استخدام أكسسوارات غير متوافقة</li>
</ul>
...
<strong>تحذير مهم:</strong> فتح المنتج أو محاولة إصلاحه بنفسك بيلغي الضمان فوراً. لو عندك مشكلة — تواصل مع كايرو فولت أولاً قبل ما تعمل أي حاجة بالمنتج.
</div>

<h2>الأوراق المطلوبة لطلب الضمان</h2>
...
<p>الكارتون الأصلي مش مطلوب (مفيد إنما مش شرط). صور المنتج والعيب بتسرّع الإجراء.</p>
...
<h2>حالات خاصة تحتاج انتباه</h2>

<h3>اشتريت من أمازون — ضمانك فين؟</h3>

<table style="width:100%; border-collapse: collapse; margin: 20px 0;">
<thead>
<tr style="background: #1e3a5f; color: white;">
<th style="padding: 12px; text-align: right;">مكان الشراء</th>
<th style="padding: 12px; text-align: center;">جهة الضمان</th>
<th style="padding: 12px; text-align: center;">مدة الضمان</th>
</tr>
</thead>
<tbody>
...
<strong>جرّب الحلول البسيطة الأول:</strong>
<ul style="margin-top: 8px; line-height: 1.8; margin-right: 20px;">
<li>شاحن مش شغّال: جرّب بريزة تانية وكابل تاني</li>
<li>Power Bank مش بيشحن: اضغط زرار التشغيل لمدة 3 ثواني</li>
<li>الشحن بطيء: تأكد إن الكابل والبريزة يدعموا سرعة الشحن المطلوبة</li>
<li>لا يزال في مشكلة بعد كده: ابعت للضمان</li>
</ul>
</div>
        ...
        en: {
            ...
            faq: [
                ...
                },
                {
                    ...
                    answer: 'No. The warranty covers manufacturing defects and spontaneous failures only. Water damage, physical impact (drops, crushing), and damage from incorrect voltage use are explicitly excluded. For physical damage, CairoVolt may offer paid repair service.',
                },
                {
...
<strong>Quick Answer:</strong> Anker warranty in Egypt: 18 months through CairoVolt (authorized distributor). Covers manufacturing defects and spontaneous failures. Required: purchase invoice + product. Submit via info@cairovolt.com.
</div>
...
<th style="padding: 12px; text-align: center;">Warranty Period</th>
...
<td style="padding: 10px; text-align: center;">0 – 3 months</td>
<td style="padding: 10px;">Store warranty only, if any</td>
</tr>
</tbody>
</table>
...
<h3>Not Covered</h3>
<ul style="line-height: 1.9; margin-left: 20px;">
<li>Water or moisture damage (even light rain exposure)</li>
<li>Physical damage from drops, crushing, or impact</li>
<li>Damage from incorrect voltage (e.g., using a 110V charger on a 220V supply)</li>
<li>Damage from unauthorized modification or opening the product</li>
<li>Normal wear (e.g., power bank capacity decrease after 2-3 years — this is normal battery aging)</li>
<li>Damage from incompatible accessories</li>
</ul>

<div class="expert-callout" style="background: #fef2f2; border: 1px solid #fca5a5; padding: 16px 20px; margin: 20px 0; border-radius: 8px;">
<strong>Important warning:</strong> Opening the product or attempting self-repair immediately voids the warranty. If you have a problem — contact CairoVolt first before doing anything to the product.
</div>

<h2>Required Documents for a Warranty Claim</h2>
...
<p>The original packaging box is not required (helpful but not mandatory). Photos of the product and defect speed up the process significantly.</p>
...
<li><strong>Evaluation:</strong> After reviewing the claim, CairoVolt determines whether replacement or repair is appropriate</li>
<li><strong>Delivery:</strong> Replacement is delivered via the same method as the original order (home delivery or designated pickup)</li>
</ol>

<h2>Special Cases Worth Noting</h2>

<h3>Bought from Amazon — Which Warranty Applies?</h3>

<table style="width:100%; border-collapse: collapse; margin: 20px 0;">
<thead>
<tr style="background: #1e3a5f; color: white;">
<th style="padding: 12px; text-align: left;">Purchase Location</th>
<th style="padding: 12px; text-align: center;">Warranty Provider</th>
...
<ul style="margin-top: 8px; line-height: 1.8; margin-left: 20px;">
<li>Charger not working: try a different outlet and a different cable</li>
<li>Power bank not charging: press the power button for 3 seconds to wake it</li>
<li>Slow charging: verify that the cable and outlet support the required wattage</li>
<li>Still not working after all this: proceed with the warranty claim</li>
</ul>
</div>

<p>To learn how to verify your Anker product's authenticity before purchasing, read: <a href="/en/blog/anker-original-website-verify-barcode-guide">Anker Official Website — Step-by-Step Barcode Verification Guide</a>.</p>

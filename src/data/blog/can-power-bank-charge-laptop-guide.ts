...
<div class="expert-callout" style="background:#eff6ff;border-right:4px solid #3b82f6;padding:16px 20px;border-radius:8px;margin:20px 0">
    <p><strong>🔬 منهجية الأرقام:</strong> كل الأرقام في المقال محسوبة من المواصفات المعلنة للشركات المصنعة — القدرة بالوات، السعة بالواط·ساعة، وكفاءة التحويل المعتادة (~85%) — ومطبّقة على لابتوبات شائعة زي MacBook Air M3 و Dell XPS 13 و Lenovo ThinkPad و HP Pavilion.</p>
</div>
...
<div class="expert-callout" style="background:#eff6ff;border-right:4px solid #3b82f6;padding:16px 20px;border-radius:8px;margin:20px 0">
    <p><strong>📊 مثال حسابي: شحن MacBook Air M3 (بطارية 52.6Wh) من 10% حتى 100% وفق المواصفات المعلنة:</strong></p>
</div>
<table>

...
export const original_samsung_charger_5_differences_identify: BlogArticle = {
...
<li><strong>مكثفات سيراميك متعددة الطبقات (MLCC)</strong> — التقليد بيحط واحدة أو اتنين بدل 6-8</li>
...
<p>Samsung بتستخدم طباعة <strong>ليزر عالية الدقة</strong> على البلاستيك — مش حبر عادي. الفرق بيبان في:</p>

<ul>
<li><strong>حدّة الخط:</strong> الأصلي الحروف حادة زي ما تكون محفورة. التقليد الحروف باهتة أو فيها "bleeding" (الحبر منتشر حوالين الحرف)</li>
<li><strong>استقامة النص:</strong> الأصلي النص مستقيم 100%. التقليد ممكن تلاقي ميل 1-2 درجة — مش واضح أوي بس لو قارنت بأصلي هتلاحظه</li>
<li><strong>علامة CE:</strong> في الأصلي، علامة CE المسافة بين الـ C والـ E محددة بمعيار أوروبي. في التقليد الحرفين بيكونوا قريبين أوي من بعض أو متلازقين (ده اسمه "China Export" مش "Conformité Européenne"!)</li>
<li><strong>رقم الموديل:</strong> الأصلي بيكون EP-TA800 أو EP-T2510 — ابحث عن الرقم ده على موقع Samsung. التقليد ممكن يكتب رقم مختلف أو يغلط في حرف</li>
</ul>

<p>نصيحة عملية: صوّر ضهر الشاحن بكاميرا الموبايل وكبّر الصورة. التفاصيل اللي مش بتبان بالعين بتبان في الزووم.</p>

<h2>الفرق #3: ملمس البلاستيك — إيدك أذكى من عينك</h2>

<p>Samsung بتستخدم بلاستيك <strong>PC/ABS grade</strong> بتشطيب مطفي (matte). التقليد بيستخدم بلاستيك ABS رخيص بتشطيب لامع (glossy). الفرق بيحس في:</p>

<ul>
<li><strong>الملمس:</strong> الأصلي ملمسه ناعم بس مش زلق — زي ملمس ريموت التلفزيون الجديد. التقليد ملمسه زلق أو فيه خشونة غير منتظمة</li>
<li><strong>الوزن البصري:</strong> الأصلي اللون أبيض ناصع متجانس. التقليد ممكن يكون أبيض مايل للأصفر أو فيه تفاوت في اللون</li>
<li><strong>خطوط القالب:</strong> الأصلي خطوط الصب (parting lines) رفيعة ومتساوية. التقليد الخطوط عريضة أو فيها زوائد بلاستيك</li>
</ul>

<p>في الفيزياء بنقول: الـ surface finish بيعكس جودة الـ injection molding. لو القالب رخيص، المنتج النهائي هيبان عليه — حتى لو الشكل العام شبه الأصلي.</p>
...
<li>المفروض يوديك على صفحة Samsung رسمية (samsung.com/eg أو samsung.com)</li>
<li>لو الصفحة أكدت إن المنتج أصلي — تمام</li>
...
<p style="margin: 8px 0 0 0; color: #7f1d1d;">لو البياع رفض يفتحلك العلبة قبل ما تدفع — ده في حد ذاته علامة مشبوهة. البياع اللي بيبيع أصلي مش بيخاف تفحص المنتج.</p>
</div>

<h2>جدول المقارنة السريعة: الأصلي ضد التقليد</h2>

<table style="width:100%; border-collapse: collapse; margin: 20px 0;">
<thead>
<tr style="background: #1e3a5f; color: white;">
<th style="padding: 12px; text-align: right;">المعيار</th>
<th style="padding: 12px; text-align: center;">✅ الأصلي</th>
<th style="padding: 12px; text-align: center;">❌ التقليد</th>
</tr>
</thead>
<tbody>
<tr style="background: #f8fafc;">
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">الوزن (25W)</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">52g</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">35-42g</td>
</tr>
<tr>
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">الطباعة</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">ليزر حاد</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">حبر باهت</td>
</tr>
<tr style="background: #f8fafc;">
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">البلاستيك</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">PC/ABS مطفي</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">ABS لامع</td>
</tr>
<tr>
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">الرائحة</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">بدون ريحة</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">ريحة كيماوية</td>
</tr>
<tr style="background: #f8fafc;">
...
<p>مش لازم تعمل الـ 5 اختبارات كل مرة. لو عايز تختصر، اعمل 3 بس:</p>

<ol>
<li><strong>امسك وقارن الوزن</strong> — 5 ثواني</li>
<li><strong>بص على الطباعة بالزووم</strong> — 10 ثواني</li>
...
<li><strong>Multiple MLCC (Multi-Layer Ceramic Capacitors)</strong> — counterfeits use 1-2 instead of 6-8</li>
...
<p>Samsung uses <strong>high-resolution laser printing</strong> on the plastic — not regular ink. The differences show in:</p>

<ul>
<li><strong>Text sharpness:</strong> Original letters are crisp as if etched into the surface. Counterfeit letters are faded or show "bleeding" (ink spreading around characters)</li>
<li><strong>Text alignment:</strong> Original text is perfectly straight. Counterfeits may show a 1-2 degree tilt — subtle but noticeable when compared to a genuine unit</li>
<li><strong>CE marking:</strong> On the original, the spacing between C and E follows the European standard. On counterfeits, the letters are too close together or touching (this is called "China Export" instead of "Conformité Européenne"!)</li>
<li><strong>Model number:</strong> The original reads EP-TA800 or EP-T2510 — search this number on Samsung's website. Counterfeits may show a different number or misspell a character</li>
</ul>

<p>Practical tip: photograph the back of the charger with your phone camera and zoom in. Details invisible to the naked eye become obvious when magnified.</p>

<h2>Difference #3: Plastic Texture — Your Hands Are Smarter Than Your Eyes</h2>

<p>Samsung uses <strong>PC/ABS grade plastic</strong> with a matte finish. Counterfeits use cheap ABS plastic with a glossy finish. The difference is felt in:</p>

<ul>
<li><strong>Texture:</strong> The original feels smooth but not slippery — like a new TV remote. The fake feels either slippery or has irregular roughness</li>
<li><strong>Visual weight:</strong> The original is a consistent bright white. Counterfeits may appear slightly yellowish or show color variation</li>
<li><strong>Mold lines:</strong> Original parting lines are thin and even. Counterfeit lines are wide or show plastic burrs</li>
</ul>

<p>In physics, we say: the surface finish reflects the quality of the injection molding process. If the mold is cheap, the final product shows it — even if the overall shape resembles the original.</p>

<h2>Difference #4: Plastic Smell — Your Nose Is More Honest Than Your Eyes</h2>

<p>This test makes people laugh when I tell them about it — but it's one of the most accurate tests you can do at the store. The original charger has <strong>virtually no smell</strong> — the plastic used is food-grade PC/ABS that's been post-cured. Counterfeits use recycled or low-grade plastic — which has a <strong>noticeable chemical odor</strong> similar to a cheap new plastic toy.</p>

<p>The method: open the box, take out the charger, bring it close to your nose. If you detect a sharp chemical smell — even a mild one — that's a strong indicator of cheap plastic. And cheap plastic isn't just about the smell — it also deforms under high temperatures. A charger delivering 25W reaches 60-70°C internally — if the plastic can't handle that, you could get warping or even melting in worst-case scenarios.</p>

<h2>Difference #5: Barcode Verification — The Final Test</h2>

<p>Samsung places a <strong>QR code or barcode</strong> on every original charger box. This barcode links to Samsung's global product database. To verify:</p>

<ol>
<li>Scan the QR code with your phone camera</li>
<li>It should direct you to an official Samsung page (samsung.com/eg or samsung.com)</li>
<li>If the page confirms the product is genuine — you're good</li>
<li>If the link doesn't work or leads to a suspicious site — it's counterfeit</li>
</ol>

<p>But beware: sophisticated counterfeits use <strong>stolen barcodes</strong> from genuine packaging — meaning the barcode actually works! That's why the barcode alone isn't enough — you need to combine it with the other 4 tests.</p>
...
<p style="margin: 0; color: #991b1b; font-weight: 600;">⚠️ Important Warning:</p>
<p style="margin: 8px 0 0 0; color: #7f1d1d;">If the seller refuses to open the box before you pay — that's a red flag in itself. A seller with genuine products has no reason to prevent inspection.</p>
</div>

<h2>Quick Comparison Table: Original vs Counterfeit</h2>
...
<tbody>
<tr style="background: #f8fafc;">
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">Weight (25W)</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">52g</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">35-42g</td>
</tr>
<tr>
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">Printing</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">Laser-sharp</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">Faded ink</td>
</tr>
<tr style="background: #f8fafc;">
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">Plastic</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">Matte PC/ABS</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">Glossy ABS</td>
</tr>
<tr>
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">Smell</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">No odor</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">Chemical odor</td>
</tr>
<tr style="background: #f8fafc;">
<td style="padding: 10px; border-bottom: 1px solid #e2e8f0;">Voltage Ripple</td>
<td style="padding: 10px; text-align: center; border-bottom: 1px solid #e2e8f0;">&lt; 120mV</td>
...
<td style="padding: 10px; text-align: center;">12-month official</td>
...
<h2>Final Tip: The 3-Test Quick Rule</h2>

<p>You don't need to perform all 5 tests every time. For a quick assessment, do just 3:</p>

<ol>
<li><strong>Hold and compare the weight</strong> — 5 seconds</li>
<li><strong>Zoom in on the printing</strong> — 10 seconds</li>

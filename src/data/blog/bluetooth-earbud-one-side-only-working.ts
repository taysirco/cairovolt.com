...
export const bluetooth_earbud_one_side_only_working: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            metaDescription: 'سماعة البلوتوث بتشتغل ناحية واحدة بس؟ 8 حلول مجربة لإصلاح المشكلة بنفسك — من إعادة التزامن والشحن لحد تنظيف نقاط الشحن وتحديث الفيرموير.',
            keywords: 'سماعة بلوتوث شغالة ناحية واحدة, سماعة ودن واحدة بس, إصلاح سماعة بلوتوث, سماعة يمين مش شغالة, سماعة شمال مبتشتغلش, حل مشكلة سماعة لاسلكية, سماعة بلوتوث مش بتتصل, reset سماعة بلوتوث, تزامن سماعات, سماعة ساوند كور مشكلة',

...
<p>لحد 7 أيام استخدام يومي على شحنة واحدة — ولحد ~20 يوم في وضع الاستعداد. ده أطول عمر بطارية في المقارنة دي. Haylou Solar Plus بتعيش حوالي أسبوع من الاستخدام اليومي من غير شحن (متوقع أقل في أيام تتبع التمارين الكتير)، فلو بتسافر كتير أو بتنسى تشحن — دي الساعة بتاعتك. سعرها كمان أقل (~900 جنيه).</p>
...
<p>Up to 7 days of daily use on a single charge — and up to ~20 days in standby mode. That is still the longest battery life in this comparison. The Haylou Solar Plus lasts about a week of everyday use between charges (expect less on the heaviest workout-tracking days), so if you travel frequently or constantly forget to charge — this is your watch. Its price is also lower (~900 EGP).</p>

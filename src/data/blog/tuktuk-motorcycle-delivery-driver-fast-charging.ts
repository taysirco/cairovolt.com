...
<div class="expert-callout" style="background:#f9fafb;border:1px solid #e5e7eb;border-right:4px solid #059669;padding:20px;margin:32px 0;border-radius:8px;">
    <p style="margin:0 0 8px 0;font-size:15px;color:#059669;font-weight:bold;">🔬 اختبار كايرو فولت العملي (يناير 2026)</p>
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        اختبرنا 6 شواحن سيارة عند فئات سعرية مختلفة (35–350ج) باستخدام Oscilloscope وحمل إلكتروني ثابت عند 5V/2A، وقِسنا: تموّج الجهد (Voltage Ripple)، ودرجة الحرارة بعد ساعة استخدام، والقدرة الفعلية مقابل المكتوبة. <strong>النتيجة:</strong> شاحن الـ35ج وصل تموّج الجهد فيه لحوالي 850mV (المقبول أقل من 50mV) — يعني التيار الداخل للموبايل متذبذب بشكل خطير يضرّ IC إدارة الشحن الداخلي. في المقابل، شاحن أنكر حقّق ripple أقل من 20mV — أنظف من معظم الشواحن الحائطية.
    </p>
</div>

...
export const three_meter_charging_cable_bed_living_room: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'أفضل كابل 3 متر في مصر 2026: للشحن السريع USB-C اختار Anker A8050 بطول 3 متر (100W، 12,000 دورة ثني، 350ج). للميزانية المحدودة: Joyroom S-CC060A12 بطول 3 متر (60W، نايلون مضفر، 180ج). القاعدة: اختار كابل بتقنية Strain Relief عند الكونكتور وغلاف نايلون مضفر — لأن الكابل الطويل بيتعرض لشد أكتر 3 مرات من القصير.',
            content: `
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead><tr style="background:#f3f4f6;">
        ...
        <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">النتيجة</th>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    ...
    <tbody>
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">أقل من 1 متر</td>
            <td style="padding:12px;border:1px solid #d1d5db;"><strong>1 متر</strong></td>
            <td style="padding:12px;border:1px solid #d1d5db;">المكتب — البريزة جنبك</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="padding:12px;border:1px solid #d1d5db;">1.5 - 2.5 متر</td>
            <td style="padding:12px;border:1px solid #d1d5db;"><strong>3 متر</strong></td>
            <td style="padding:12px;border:1px solid #d1d5db;">السرير/الكنبة — البريزة في الحيطة</td>
        </tr>
    </tbody>
</table>
...
`,
            faq: [
                ...
                { question: 'إيه أفضل كابل 3 متر لـ iPhone في مصر؟', answer: 'Anker SureiStrong USB-C to Lightning بطول 3 متر — الأمتن في السوق بـ 15,000 دورة ثني، بيدعم شحن سريع 30W، ومعتمد MFi من Apple. متاح على كايرو فولت بحوالي 320ج مع ضمان 18 شهر.' },
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead><tr style="background:#f3f4f6;">
        ...
        <th style="padding:12px;border:1px solid #d1d5db;text-align:left;">Result</th>

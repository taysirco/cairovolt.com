...
<p>شواحن الـ GaN (مثل سلسلة <strong>انكر نانو II</strong>) قلبت هذه المعادلة تماماً. بفضل كفاءة توصيل الغاليوم، يتم تحويل 95% من طاقة الحائط إلى شحن فعلي، بينما يضيع 5% فقط كحرارة. (في السيليكون يضيع ما يصل إلى 20%). النتيجة؟ الهاتف يُشحن أسرع ويبقى بارداً.</p>

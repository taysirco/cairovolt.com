...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    ...
    <tbody>
        ...
        <tr style="background:#f0fdf4;">
            <td style="padding:12px;border:1px solid #d1d5db;"><strong>30W (299-499ج) ⭐</strong></td>
...
<ul style="list-style:none;padding:0;">
    <li style="margin-bottom:24px;">
        <p style="margin:0 0 4px 0;font-size:18px;font-weight:bold;color:#059669;">🥇 Best Overall — <a href="/en/anker/wall-chargers/anker-a2147-gan-charger-30w" style="color:#2563eb;">Anker GaN 30W</a> (499 EGP)</p>
    ...
    <li style="margin-bottom:24px;">
        <p style="margin:0 0 4px 0;font-size:18px;font-weight:bold;color:#2563eb;">🥈 Best Value — <a href="/en/joyroom/wall-chargers/joyroom-30w-fast-charger" style="color:#2563eb;">Joyroom 30W</a> (299 EGP)</p>
...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    ...
    <tbody>
        ...
        <tr style="background:#f0fdf4;">
            <td style="padding:12px;border:1px solid #d1d5db;"><strong>30W (299-499 EGP) ⭐</strong></td>

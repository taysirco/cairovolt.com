...
export const car_charger_usb_c_pd_iphone_15_ipad: BlogArticle = {
    ...
    translations: {
        ar: {
            ...
            quickAnswer: 'شاحن السيارة USB-C PD ضرورة مش رفاهية: شاحن PD بقدرة 30W مع كابل معتمد يشحن الآيفون من 0% إلى 50% في 30 دقيقة بأمان. منافذ السيارة المدمجة وشواحن USB-A القديمة تعطي 5-10W فقط — لا تكفي مع تشغيل الـ GPS والشاشة.',
            content: `
...
<p>الآيفون الحديث بيستقبل قدرة شحن مختلفة حسب الجيل: آيفون 15 و16 بيوصلوا لـ 27W وأحياناً 30W في ذروة الشحن، أما سلسلة آيفون 17 (17 و17 برو و17 برو ماكس) فمعتمدة من أبل لشحن سلكي بيوصل لـ 40W (بيتقاس حوالي 36-39W في الذروة مع محول أبل الديناميكي 40W)، وآيفون Air بس هو اللي لسه عند 20W. أما أجهزة iPad Pro و iPad Air فبتحتاج طاقة بتوصل لـ 30W إلى 35W وأحياناً 45W للموديلات الاحترافية الكبيرة. لو قارنا الأرقام دي باللي بتقدمه التكنولوجيا القديمة، هنكتشف حجم المشكلة:</p>
<ul style="list-style:none;padding:0;">
    ...
    <li style="margin-bottom:12px;">⚡ <strong>شاحن USB-C PD 30W:</strong> بيوفر خرج 9 فولت عند 3 أمبير (27 واط فعلي للايفون). الشاحن ده بيشحن نفس الآيفون من 0% لـ 50% في <strong>30 دقيقة بس</strong>، لكن ملء البطارية بالكامل من 0% لـ 100% بياخد حوالي ساعة و50 دقيقة لساعتين، لأن سرعة الشحن بتقل كتير بعد 80%. الفرق في الكفاءة والوقت ضخم جداً.</li>
</ul>
...
`,
        ...
        en: {
            ...
            quickAnswer: 'A USB-C PD car charger is a necessity, not a luxury: a 30W PD charger with a certified cable takes an iPhone from 0% to 50% in about 30 minutes safely. Built-in car ports and old USB-A chargers output only 5-10W — not enough while running GPS and the screen.',
            content: `
...
<p>Modern iPhones accept different peak wired power by generation: iPhone 15 and iPhone 16 peak around 27W to 30W, while the iPhone 17 series (17, 17 Pro, and 17 Pro Max) is rated by Apple at up to 40W wired charging (measured at about 36-39W peak with Apple\'s 40W Dynamic Power Adapter); only the iPhone Air stays at 20W. iPad Pro and iPad Air models require 30W, 35W, or even 45W for large professional versions. Comparing these needs to what legacy technology provides explains the slow charging speeds:</p>
<ul style="list-style:none;padding:0;">
    ...
    <li style="margin-bottom:12px;">⚡ <strong>USB-C PD 30W Chargers:</strong> Provides 9V/3A output (27W actual intake). This setup charges your phone from 0% to 50% in just <strong>30 minutes</strong>, though a full 0-100% charge still takes about 1 hour 50 minutes to 2 hours because charging tapers hard after 80%.</li>
</ul>

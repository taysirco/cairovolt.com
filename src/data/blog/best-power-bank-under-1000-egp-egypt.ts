...
<div class="expert-callout" style="background:#f9fafb;border:1px solid #e5e7eb;border-right:4px solid #059669;padding:20px;margin:32px 0;border-radius:8px;">
    <p style="margin:0 0 8px 0;font-size:15px;color:#059669;font-weight:bold;">
        🔬 تحذير قبل الشراء من السوق الموازي
    </p>
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        الباور بانكات المعروضة بسعر 400-700 جنيه على OLX وفيسبوك ماركت
        <strong>كثيراً ما تكون مقلّدة</strong> عند فحصها لدى فنيي صيانة الهواتف —
        سعة فعلية أقل بكثير من المُدّعى، شرائح بدون دوائر حماية حقيقية،
        سخونة مفرطة تحت الحمل، ولا توجد قناة لاسترداد التكلفة عند العطل.
    </p>
</div>
...
<p>الباور بانكات اللي بتشوفها على فيسبوك ماركت بسعر 300-600 جنيه بتتكرر فيها 5 خصائص معروفة:</p>
...
<div class="expert-callout" style="background:#f9fafb;border:1px solid #e5e7eb;border-left:4px solid #059669;padding:20px;margin:32px 0;border-radius:8px;">
    <p style="margin:0 0 8px 0;font-size:15px;color:#059669;font-weight:bold;">
        🔬 Gray-Market Buyer Warning
    </p>
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        Power banks sold at 400-700 EGP on OLX and Facebook Marketplace
        <strong>frequently turn out to be counterfeit</strong> when opened by mobile repair technicians —
        actual capacity far below the claimed rating, chips without real protection circuitry,
        excessive heat under load, and no way to recover cost on failure.
    </p>
</div>
...
<p>Power banks you see on Facebook Marketplace at 300-600 EGP share 5 well-known recurring traits:</p>
...
<ul style="list-style:none;padding:0;">
    ...
    <li style="margin-bottom:12px;">🔥 <strong>60°C+ heat under load:</strong> Counterfeits lacking real protection circuitry can exceed 65°C after just 30 minutes of charging, while authentic units with proper protection typically stay around 42-45°C in the same conditions.</li>

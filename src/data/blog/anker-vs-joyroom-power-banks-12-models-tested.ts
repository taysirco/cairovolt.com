...
<table style="width:100%;border-collapse:collapse;margin:24px 0;font-size:15px;">
    <thead>
        <tr style="background:#f3f4f6;">
            ...
            <th style="padding:12px;border:1px solid #d1d5db;text-align:right;">أقصى حرارة مسجلة</th>
...
<div class="cta-box" style="background:#f0fdf4;border:1px solid #86efac;padding:20px;margin:32px 0;border-radius:8px;">
    ...
    <p style="margin:0;color:#15803d;font-size:15px;line-height:1.8;">
        ...
        en: {
            title: 'Anker vs Joyroom Power Banks — 12 Models Tested with Real Numbers in Egypt 2026',
            metaTitle: 'Anker vs Joyroom Power Banks — 12 Models Tested | CairoVolt',
...
<div class="expert-callout" style="background:#f9fafb;border:1px solid #e5e7eb;border-left:4px solid #059669;padding:20px;margin:32px 0;border-radius:8px;">
    ...
    <p style="margin:0;font-size:15px;line-height:1.8;color:#374151;">
        We tested 12 power banks (7 Anker + 5 Joyroom) during May 2026. Each unit was charged to 100% → discharged at a constant 10W load → we measured: (1) actual capacity in Wh, (2) maximum sustained output, (3) surface temperature after 30 minutes under maximum load. All units are genuine from CairoVolt inventory — not free samples from manufacturers.
    </p>
</div>
...
<p>We measured surface temperature on each power bank after 30 minutes under maximum load using a laser thermometer:</p>

    ...
    const regionFaqs: Record<Governorate['region'], Array<{ question: string; answer: string }>> = {
        cairo: [
            ...
            },
            {
                ...
                answer: `بنوصلك لحد عتبة بابك في ${govName} خلال ${deliveryDays} يوم عن طريق شركة بوسطة. الشحن بـ 40 جنيه ومجاني لو الطلب فوق 500 جنيه. وطبعاً كاش عند الاستلام — مش محتاج تدفع حاجة قبل ما الأوردر يوصلك.`,
            },
        ],
        delta: [
            {
            ...
            },
            {
                ...
                answer: `أكيد! بنوصل لكل محافظات الدلتا عن طريق بوسطة. ${govName} خلال ${deliveryDays} أيام. الشحن 40 جنيه بس — ومجاني فوق 500 جنيه. والأهم: الدفع عند الاستلام يعني مش هتدفع قرش قبل ما تتطمن.`,
            },
        ],
        upper: [
            {
            ...
            },
            {
                ...
                answer: `طبعاً! بنوصل لكل محافظات الصعيد من أسيوط لأسوان عبر شركة بوسطة. التوصيل لـ ${govName} خلال ${deliveryDays} أيام. الشحن 40 جنيه ومجاني فوق 500 جنيه. الدفع وقت الاستلام — مفيش مخاطرة عليك.`,
            },
        ],
        canal: [
            {
            ...
            },
            {
                ...
                answer: `أكيد! ${govName} من المناطق اللي بنغطيها. التوصيل خلال ${deliveryDays} أيام عبر بوسطة. 40 جنيه شحن — مجاني فوق 500 جنيه. ادفع كاش لما الأوردر يوصل.`,
            },
        ],
        coastal: [
            {
            ...
            },
            {
                ...
                answer: `أيوة! كل المناطق الساحلية من اسكندرية لمطروح بنغطيها. ${govName} التوصيل خلال ${deliveryDays} أيام. الشحن بـ 40 جنيه — مجاني فوق 500 جنيه. كاش عند الاستلام.`,
            },
        ],
        desert: [
            {
            ...
            },
            {
                ...
                answer: `أيوة بنوصل حتى المناطق الحدودية والصحراوية. ${govName} خلال ${deliveryDays} أيام عبر بوسطة. الشحن 40 جنيه — مجاني فوق 500 جنيه. ادفع كاش وقت الاستلام.`,
            },
        ],
    };
...
function generateVoiceFaqsEn(
    ...
    return [
        ...
        },
        {
            ...
            answer: `Yes! Door-to-door delivery to ${govName} in ${deliveryDays} days via Bosta. Shipping is 40 EGP or free above 500 EGP. Cash on delivery available.`,
        },
    ];
}

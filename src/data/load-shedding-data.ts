    ...
    const regionFaqs: Record<Governorate['region'], Array<{ question: string; answer: string }>> = {
        cairo: [
            ...
            },
            {
                ...
                answer: `بنوصلك لحد عتبة بابك في ${govName} خلال ${deliveryDays} يوم عن طريق شركة بوسطة. الشحن بيبدأ من 70 جنيه حسب المحافظة، ومجاني لو الطلب فوق 3,700 جنيه. وطبعاً كاش عند الاستلام — مش محتاج تدفع حاجة قبل ما الأوردر يوصلك.`,
            },
        ],
        delta: [
            {
            ...
            },
            {
                ...
                answer: `أكيد! بنوصل لكل محافظات الدلتا عن طريق بوسطة. ${govName} خلال ${deliveryDays} أيام. الشحن 85 جنيه بس — ومجاني فوق 3,700 جنيه. والأهم: الدفع عند الاستلام يعني مش هتدفع قرش قبل ما تتطمن.`,
            },
        ],
        upper: [
            {
            ...
            },
            {
                ...
                answer: `طبعاً! بنوصل لكل محافظات الصعيد من أسيوط لأسوان عبر شركة بوسطة. التوصيل لـ ${govName} خلال ${deliveryDays} أيام. الشحن من 100 جنيه ومجاني فوق 3,700 جنيه. الدفع وقت الاستلام — مفيش مخاطرة عليك.`,
            },
        ],
        canal: [
            {
            ...
            },
            {
                ...
                answer: `أكيد! ${govName} من المناطق اللي بنغطيها. التوصيل خلال ${deliveryDays} أيام عبر بوسطة. الشحن من 70 جنيه — ومجاني فوق 3,700 جنيه. ادفع كاش لما الأوردر يوصل.`,
            },
        ],
        coastal: [
            {
        ...
        desert: [
            ...
            },
            {
                ...
                answer: `أيوة بنوصل حتى المناطق الحدودية والصحراوية. ${govName} خلال ${deliveryDays} أيام عبر بوسطة. الشحن من 100 جنيه — ومجاني فوق 3,700 جنيه. ادفع كاش وقت الاستلام.`,
            },
        ],
    };
...
function generateVoiceFaqsEn(
    ...
    return [
        ...
        },
        {
            ...
            answer: `Yes! Door-to-door delivery to ${govName} in ${deliveryDays} days via Bosta. Shipping starts at 70 EGP by governorate, free above 3,700 EGP. Cash on delivery available.`,
        },
    ];
}

...
export const joyroom_car_accessories_content: CategoryContent = {
            brand: 'Joyroom',
            brandColor: 'red',
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      على عكس إكسسوارات السيارات الرخيصة اللي بتسقط من أول مطب وشاحنها بيبوظ الموبايل (الهاتف الذكي) — إكسسوارات **جوي روم** مصممة لطرق مصر الفعلية. مغناطيس N52 الأقوى تجارياً. شاحن 60W USB-C PD. اختبار 500 كم. صفر سقوط.

      **مثالي لكل سائق في مصر:**
      زحمة الدائري كل يوم؟ رحلة الساحل 6 ساعات؟ الشاحن بيشحن جهازين بأقصى سرعة + الحامل المغناطيسي بيثبت موبايلك وأنت فاتح GPS. اختبار CairoVolt: طريق القاهرة-الإسكندرية الصحراوي 500 كم — صفر سقوط حتى عند 120 كم/س.

      **ليه جوي روم للسيارة؟**
      - **شاحن سيارة 60W GaN:** يشحن ايفون + سامسونج معاً بأقصى سرعة — حجم أصغر 50% من الشواحن العادية
      - **حامل N52 مغناطيسي:** 1,200 جاوس قوة شد — الموبايل مش بيتحرك أبداً
      - **FCC معتمد + ضمان 18 شهر:** اطلبه الآن — توصيل القاهرة والجيزة خلال 24 ساعة
    `,
                    qualityBadges: [
...
`
                        ...
                        {
                            title: 'مغناطيسي vs مشبك — أيهما أفضل؟',
                            content: `
- **الحامل المغناطيسي:** تثبيت فوري بلمسة واحدة. مثالي للموبايلات اللي بتدعم MagSafe أو باستخدام لاصقة معدنية.
- **حامل المشبك (Clamp):** تثبيت ميكانيكي أقوى. أفضل للموبايلات الكبيرة والثقيلة والطرق الوعرة.
`
                        }
                    ],
                    faq: [
...
`
                        ...
                        {
                            title: 'Magnetic vs Clamp — Which is Better?',
                            content: `
- **Magnetic Mount:** Instant one-touch attachment. Perfect for MagSafe phones or with included metal plate.
- **Clamp Mount:** Stronger mechanical grip. Better for large, heavy phones and rough terrain driving.
`
                        }
                    ],
                    faq: [

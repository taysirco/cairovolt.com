...
export const joyroom_car_accessories_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      بتقضي ساعتين يومياً في زحمة القاهرة والموبايل (الهاتف الذكي) بيخلص قبل ما توصل البيت؟ إكسسوارات سيارة **جوي روم** بتحل المشكلة — شاحن سيارة **60W GaN** بمنفذين بيشحن ايفون + سامسونج معاً بأقصى سرعة عبر USB-C PD. FCC معتمد.

      **باكدج السيارة الذكية:**
      الشاحن لوحده مش كافي — محتاج حامل كمان. جوي روم بيقدم حل متكامل: شاحن 60W + حامل مغناطيسي N52 بقوة 1,200 جاوس. ركبهم مرة واحدة — وانسى. بطارية موبايلك مش هتخلص أبداً وأنت سايق.

      **ليه جوي روم للسيارة مش أي براند؟**
      - **60W حقيقي:** يشحن جهازين بأقصى سرعة — مش 60W "نظري" زي الشواحن الرخيصة
      - **حامل N52:** الأقوى تجارياً — الموبايل مش بيتحرك حتى على أسوأ طرق
      - **ضمان 18 شهر CairoVolt:** مع كود تتبع — اطلبه الآن ودفع عند الاستلام
    `,
                    qualityBadges: [

...
export const joyroom_car_accessories_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      اكتشف **اكسسوارات سيارة جوي روم** الأصلية في مصر — كل ما تحتاجه لتجربة قيادة مريحة وآمنة.
      
      **لماذا جوي روم للسيارة؟**
      - **شاحن سيارة 60W بمنفذين:** يشحن جهازين في نفس الوقت بأقصى سرعة — ايفون + سامسونج معاً.
      - **حامل موبايل مغناطيسي:** مغناطيس N52 الأقوى — يثبت الموبايل حتى على الطرق الوعرة بدون اهتزاز.
      - **تصميم أنيق:** لون أسود مطفي يتناسب مع أي ديكور سيارة.

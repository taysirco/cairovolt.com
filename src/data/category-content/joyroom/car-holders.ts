...
export const joyroom_car_holders_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
على عكس الحوامل الرخيصة اللي الموبايل (الهاتف الذكي) بيقع منها على أول مطب — حامل جوي روم بيستخدم مغناطيس **Neodymium N52** بقوة 1,200 جاوس. ثبات مطلق. 500 كم اختبار. صفر سقوط.

**مثالي لطرق مصر:**
مطبات الصحراوي؟ حرارة الصيف 50°م جوا العربية؟ الحامل مصنوع من مواد مقاومة للحرارة — مش بيسيح ولا بيفك. موديل MagSafe JR-ZS290 بيدعم شحن PD لاسلكي 15W عبر USB-C وأنت سايق.

**تقنيات متقدمة:** موديل Solar Auto-Clamp بيشتغل بالطاقة الشمسية — فتح/إغلاق تلقائي بدون بطارية أو شحن. CE + FCC معتمد. Bluetooth 5.3 للتحكم الذكي (في موديلات محددة). اطلبه الآن — توصيل القاهرة والجيزة خلال 24 ساعة.
    `,
                    qualityBadges: [

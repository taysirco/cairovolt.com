...
راجع السعر الحالي وضمان كايرو فولت في صفحة المنتج. موعد التوصيل تقديري حسب العنوان، وتسوق [شاحن جوي روم](/joyroom/wall-chargers) فقط إذا كان متوافقاً مع متطلبات الساعة.
    `,
                    qualityBadges: [
                        ...
                        { type: 'expert_verified', text: 'الشاشة والبلوتوث وتصنيف الماء موضحة في صفحة المنتج' }
                    ],
                    buyingGuide: [
                        {
                            // كان هنا جدول "FT3 Pro وFT5 وFC2" بستة صفوف مواصفات — والقسم
                            // يعرض موديلاً واحداً فقط (JR-FT3)، ولا FT5 ولا FC2 ولا "FT3 Pro"
                            // موجود في الكتالوج. وكانت أرقام الجدول تناقض صفحة المنتج نفسها
                            // (1.43 بوصة AMOLED مقابل 1.85 بوصة IPS الفعلية، و7 أيام مقابل
                            // 4 أيام و7 ساعات المقاسة). استُبدل بورقة مواصفات للموديل الحقيقي،
                            // كل رقم فيها منشور على صفحة المنتج.
                            title: 'مواصفات الموديل المعروض: JR-FT3',
                            content: `
| البند | JR-FT3 (Fit-Life) |
|--------|---------|
| **الشاشة** | 1.85 بوصة HD IPS |
| **البلوتوث** | 5.2 |
| **مقاومة الماء** | IP68 — معلنة من الشركة |
| **التطبيق** | Smart Time Pro (iOS و Android) |
| **البطارية** | قِسنا 4 أيام و7 ساعات على العيّنة CV-SW-JRFT3-001 بملف استخدام يومي معرّف |
| **المعرّفات** | MPN: JR-FT3 · SKU المتجر: JW02 |
**ملاحظة:** هذا هو الموديل الوحيد المعروض في هذا القسم حالياً. راجع صفحة المنتج للسعر والضمان الحاليين. وهج الظهيرة يغسل شاشة IPS في الخارج — استخدمها في الظل.
`
                        },
                        {
...
|---------|----------------|
| **Bluetooth 5.2** | إصدار الاتصال في JR-FT3؛ الجودة والمدى والاستهلاك تعتمد أيضاً على الهاتف والبيئة |
| **شاشة IPS** | نوع لوحة JR-FT3 (1.85 بوصة HD)؛ وهج الظهيرة يغسلها في الخارج |
...
Check the current price and CairoVolt warranty on the product page. Delivery timing is estimated from the confirmed address. A serial number or warranty record alone does not prove manufacturer authenticity.
    `,
                    qualityBadges: [
                        ...
                        { type: 'expert_verified', text: 'Display, Bluetooth and water rating listed on the product page' }
                    ],
                    buyingGuide: [
                        {
                            // Mirrors the Arabic block. The previous three-model table
                            // compared FT3 Pro / FT5 / FC2 — none of which is in the
                            // catalogue; this category stocks exactly one watch (JR-FT3),
                            // and the table's specs contradicted its own product page.
                            title: 'Specifications of the model listed here: JR-FT3',
                            content: `
| Item | JR-FT3 (Fit-Life) |
|---------|---------|
| **Display** | 1.85" HD IPS |
| **Bluetooth** | 5.2 |
| **Water resistance** | IP68 — as declared by the manufacturer |
| **App** | Smart Time Pro (iOS and Android) |
| **Battery** | We measured 4 days 7 hours on sample CV-SW-JRFT3-001 under a defined daily-use profile |
| **Identifiers** | MPN: JR-FT3 · Store SKU: JW02 |
**Note:** This is the only model currently listed in this category. Check the product page for the current price and warranty. Midday glare washes out the IPS panel outdoors — use it in shade.
`
                        },
                        {
...
|------------|---------------------|
| **Bluetooth 5.2** | The JR-FT3's connection version; quality, range and power use also depend on the phone and environment |
| **IPS panel** | The JR-FT3's panel type (1.85" HD); midday glare washes it out outdoors |

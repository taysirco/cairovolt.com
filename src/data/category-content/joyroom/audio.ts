...
- ✓ 15,000+ قطعة مباعة في مصر — اطلبها الآن وتوصيل القاهرة خلال 24 ساعة. تسوق [كابل جوي روم](/joyroom/cables) لشحن السماعة
    `,
                    qualityBadges: [
                        ...
                        { type: 'expert_verified', text: 'IPX5 ضد الماء + CE معتمد أوروبياً — 15,000+ قطعة في مصر' }
                    ],
                    buyingGuide: [
                        {
...
`
                    ...
                    faq: [
                        ...
                        { question: 'هل فيه تطبيق لضبط صوت سماعة جوي روم؟', answer: 'نعم. تطبيق Joyroom متاح مجاناً على iOS و Android. بيوفر: EQ مخصص، تبديل بين أوضاع ANC، تحديثات البرنامج، والعثور على السماعة الضائعة.' },

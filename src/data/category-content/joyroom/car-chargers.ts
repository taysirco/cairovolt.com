...
export const joyroom_car_chargers_content: CategoryContent = {
            brand: 'Joyroom',
            brandColor: 'red',
...
`
                        ...
                        {
                            title: 'هل شاحن السيارة بيأثر على بطارية العربية؟',
                            content: `
بيعتمد على تصميم العربية؛ في منافذ 12V بتفصل مع إيقاف المحرك، وفي منافذ بتفضل شغالة. افصل الشاحن لو هتركن العربية فترة طويلة واتبع دليل السيارة، خصوصاً لو البطارية قديمة أو ضعيفة.
`
                        }
                    ],
                    faq: [
                        {
                            question: 'كم سعر شاحن سيارة جوي روم في مصر؟',
                        ...
                        },
                        {
                            ...
                            answer: 'استخدم الشاحن داخل نطاق دخل السيارة 12V أو 24V المحدد على المنتج، وما تسيبوش تحت الشمس المباشرة. قد يصبح دافئاً أثناء الاستخدام، وأوقفه فوراً عند ظهور سخونة أو رائحة غير طبيعية.'
                        },
                        {
                        ...
                        {
                            question: 'هل بيشتغل مع كل العربيات؟',

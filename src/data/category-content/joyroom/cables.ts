...
export const joyroom_cables_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      على عكس الكابلات الرخيصة اللي بتتقطع بعد أسبوع وبتظهر رسالة "Accessory not supported" — كابل جوي روم مزود بشريحة **Smart IC** معتمدة USB-IF + CE. 60 واط. 10,000 ثنية. صفر كسر.

      **الميزة الحصرية: الفصل التلقائي (Auto-Disconnect):**
      كابلاتنا الذكية (موديلات S-M411) بتفصل الكهرباء تماماً عن الموبايل (الهاتف الذكي) لما الشحن يوصل 100%. نام وسيب موبايلك في الشاحن — صحة البطارية (Battery Health) في أمان.

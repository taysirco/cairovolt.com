...
export const joyroom_cables_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      موبايلك بيشحن طول الليل وBattery Health بينزل كل شهر؟ كابل جوي روم S-M411 هو الوحيد في مصر بخاصية **الفصل التلقائي** — شريحة Smart IC بتقطع الكهرباء تماماً لما الشحن يوصل 100%. معتمد USB-IF + CE. 60 واط. 10,000 ثنية بدون كسر.

      **كام كابل رخيص اشتريته السنة دي؟**
      لو بتشتري كابل بـ 50 جنيه كل شهرين = 300 جنيه في السنة ضايعة. كابل جوي روم بـ 118 جنيه بيعيش سنة+ (10,000 ثنية مختبرة) — ده توفير فعلي مش كلام تسويقي.

      **المتانة في ظروف مصر:**
      تصميم **مضفر (Braided Nylon)** يتحمل حرارة 45°م + رطوبة الساحل الشمالي. رؤوس معدنية مدعمة — مش بلاستيك رخيص بيتكسر. اطلبه الآن — توصيل القاهرة خلال 24 ساعة.
    `,
                    qualityBadges: [

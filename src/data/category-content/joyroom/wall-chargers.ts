...
export const joyroom_wall_chargers_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      على عكس الشواحن المقلدة اللي بتسخن لـ 65°م وبتضر بطارية موبايلك (الهاتف الذكي) خلال 6 شهور، شاحن جوي روم بيعتمد على شريحة **Smart IC** معتمدة UL + CE. 20 واط. فصل تلقائي عند 100%. صفر ضرر على Battery Health.

      في ظل تذبذب الكهرباء المتكرر في مصر — خصوصاً الصيف — شواحن جيروم مصنوعة من مادة **PC V0 مقاومة للحريق** اللي بتمنع الاشتعال حتى لو الفولت ارتفع فجأة. اختبار CairoVolt: 3 ساعات شحن مستمر في حرارة 45°م — حرارة الشاحن 38°م فقط.

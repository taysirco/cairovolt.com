...
export const soundcore_speakers_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    subtitle: 'ساوندكور Speakers - صوت Hi-Res عالي الدقة',
                    description: `
على عكس السماعات الرخيصة اللي صوتها بيتشوه على Volume 80% — سماعات **ساوندكور** معتمدة Hi-Res Audio بقوة قوة عالية. صوت نقي. باس حقيقي. 24 ساعة تشغيل.
                    ...
                    buyingGuide: [
                        {
                            ...
                            content: `
- **ساوندكور Motion+:** لعشاق جودة الصوت. 30 واط Hi-Res مع توينر دقيق عبر التطبيق. الأفضل للاستخدام المنزلي والرحلات.
- **ساوندكور Flare 2:** لعشاق الحفلات. إضاءة LED 360° متفاعلة مع الموسيقى. مقاومة ماء IPX7.
`
                        },
                        {
                            title: 'هل أقدر أربط أكثر من سماعة؟',
                            content: `
أيوه! بتقنية PartyCast تقدر تربط لحد 100 سماعة ساوندكور مع بعض. الصوت بيطلع من كلهم في نفس اللحظة بدون تأخير.
`
                        }
                    ],
                    faq: [
                        {
                            ...
                            answer: 'Flare 2 بـ 2,999 جنيه، Motion+ بـ 3,600 جنيه. مقارنةً بـ JBL Flip 6 (من 5,000 جنيه): ساوندكور أرخص 40% مع Hi-Res Audio معتمد + ضمان 18 شهر من CairoVolt. توصيل القاهرة يوم واحد، دفع عند الاستلام.'
                        },
                        {
                        ...
                        },
                        {
                            ...
                            answer: 'سماعات بلوتوث مقلدة كتير في السوق. الأصلي: 1) كود QR على العلبة 2) تطبيق ساوندكور بيكشفها 3) صوت 30W حقيقي — المقلد 5W فقط 4) IPX7 حقيقي — المقلد بيبوظ من رشة مية 5) ضمان 18 شهر من CairoVolt.'
                        },
                        {
                            question: 'هل سماعات انكر آمنة على السمع؟',
                            answer: 'نعم. ساوندكور بتحدد مستوى الصوت الأقصى عند 85dB (الحد الآمن حسب WHO). السماعات المقلدة الرخيصة بتوصل 100dB+ وبتضر السمع.'
                        },
                        {
                        ...
                        },
                        {
                            ...
                            answer: 'Motion+ بتشتغل 12 ساعة متواصلة. Flare 2 بتشتغل 12 ساعة. Select 4 Go بتشتغل 12 ساعة. اختبار CairoVolt الفعلي (Volume 70%): Motion+ عاشت 11 ساعة و40 دقيقة — قريبة جداً من الرسمي.'
                        },
                        {
                            question: 'هل سبيكر انكر بيشتغل مع ايفون 17 وسامسونج S26؟',
                            answer: 'أيوه — كل سبيكرات ساوندكور بتدعم Bluetooth 5.0+ وبتشتغل مع أي موبايل. الاقتران فوري. تطبيق ساوندكور المجاني بيديك تحكم في EQ والإضاءة.'
                        },
                        {
                            question: 'هل ممكن أستخدم سبيكر انكر كسماعة خارجية للتلفزيون؟',
                            answer: 'أيوه! أي سبيكر ساوندكور بتتوصل بالتلفزيون عبر Bluetooth أو كابل AUX 3.5mm. Motion+ بقوة 30W هي الأفضل لجودة صوت أفلام حقيقية. تسوق [كابل انكر](/anker/cables) AUX للتوصيل السلكي.'
                        }
                    ],
                    products: [
                    ...
                    buyingGuide: [
                        {
                            ...
                            content: `
- **Soundcore Motion+:** For audiophiles. 30W Hi-Res with precision EQ via the app. Best for home listening and road trips.
- **Soundcore Flare 2:** For party lovers. 360° reactive LED lights that sync to your music. IPX7 waterproof for pool parties.
`
                        },
                        {

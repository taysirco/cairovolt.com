                    ...
                    buyingGuide: [
                        {
                            ...
                            content: `
- **Soundcore Motion+:** لعشاق جودة الصوت. 30 واط Hi-Res مع توينر دقيق عبر التطبيق. الأفضل للاستخدام المنزلي والرحلات.
- **Soundcore Flare 2:** لعشاق الحفلات. إضاءة LED 360° متفاعلة مع الموسيقى. مقاومة ماء IPX7.
`
                        },
                        {
                            title: 'هل أقدر أربط أكثر من سماعة؟',
                            content: `
أيوه! بتقنية PartyCast تقدر تربط لحد 100 سماعة Soundcore مع بعض. الصوت بيطلع من كلهم في نفس اللحظة بدون تأخير.
`
                        }
                    ],
                    faq: [
                        ...
                        {
                            question: 'كام ساعة بطارية سماعة انكر Soundcore؟',
                        ...
                        },
                        {
                            ...
                            answer: 'أيوه — كل سبيكرات Soundcore بتدعم Bluetooth 5.0+ وبتشتغل مع أي موبايل. الاقتران فوري. تطبيق Soundcore المجاني بيديك تحكم في EQ والإضاءة.'
                        },
                        {
                            question: 'هل ممكن أستخدم سبيكر انكر كسماعة خارجية للتلفزيون؟',
                            answer: 'أيوه! أي سبيكر Soundcore بتتوصل بالتلفزيون عبر Bluetooth أو كابل AUX 3.5mm. Motion+ بقوة 30W هي الأفضل لجودة صوت أفلام حقيقية. تسوق [كابل انكر](/anker/cables) AUX للتوصيل السلكي.'
                        }
                    ],
                    products: [

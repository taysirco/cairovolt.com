...
export const anker_power_banks_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      تسوق أفضل **باور بانك انكر (Anker Power Bank)** الأصلي في مصر بأفضل الأسعار. خصم حصري على موديلات 20000mAh. سواء كنت تبحث عن باور بانك 10000 أو 20000 للإيفون والسامسونج، انكر توفر لك الشحن السريع والأمان التام بفضل تقنية الشحن الذكي وضمان 18 شهر.

...
export const anker_power_banks_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
      تسوق أفضل **باور بانك انكر (Anker Power Bank)** الأصلي في مصر بأفضل الأسعار. سواء كنت تبحث عن باور بانك 10000 أو 20000 للإيفون والسامسونج، انكر توفر لك الشحن السريع والأمان التام بفضل تقنية الشحن الذكي وضمان 18 شهر.
      
      في مصر، تعتبر انكر الخيار الأول بفضل:
      1. **الشحن الذكي:** يتعرف بقوة على جهازك (سواء كان ايفون 16، أو سامسونج S26) ويعطيه أسرع شحن بأمان.
                    ...
                    faq: [
                        {
                            ...
                            answer: 'نعم، وبشكل مطلق. منتجات انكر تدعم تقنية ActiveShield™ 2.0 و 3.0 التي تراقب درجة حرارة البطارية أكثر من 3 مليون مرة يومياً. بالإضافة لذلك، هي تدعم بروتوكول الشحن المقتصد (Trickle Charging) وسحب الطاقة الذكي الذي يمنع الشحن الزائد، مما يحافظ على صحة البطارية (Health) عند 100% لفترة أطول.'
                        },
                        {

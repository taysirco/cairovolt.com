...
`
                    ...
                    products: [
                        ...
                        { name: 'Soundcore P20i', price: 699, badge: 'أقل سعر' },
                        { name: 'Soundcore P25i', price: 799, badge: 'BassUp' },
                        { name: 'Soundcore Liberty 4 NC', price: 2999, badge: 'ANC متقدم' },
                        { name: 'Soundcore A30i', price: 1449, badge: 'توازن مثالي' },
                        { name: 'Soundcore Liberty 5', price: 2499, badge: 'LDAC Hi-Res' },
                        { name: 'Soundcore Liberty 4 Pro', price: 4499, badge: 'فلاجشيب' },
                        { name: 'Soundcore P30i', price: 999, badge: 'XBS باس' },
                        { name: 'Soundcore Life Q20+', price: 2299, badge: 'هيدفون ANC' },
                        { name: 'Soundcore Liberty Buds', price: 999, badge: 'كلاسيكي' },
                        { name: 'Soundcore Liberty Air 2 Pro', price: 2499, badge: 'PureNote' },
                        { name: 'Soundcore P40i', price: 1249, badge: '60h بطارية' },
                        { name: 'Soundcore P41i', price: 1399, badge: '60h + XBS' },
                        { name: 'Soundcore V20i', price: 699, badge: 'ميزانية ذكية' },
                        { name: 'Soundcore R50i Vi', price: 1199, badge: 'BassUp مطوّر' },
                        { name: 'Soundcore Life U2i', price: 599, badge: 'نيكباند 18h' },
                        { name: 'Soundcore C30i', price: 599, badge: '36h بطارية' },
                        { name: 'Soundcore C40i', price: 799, badge: 'BassUp' },
                        { name: 'Soundcore Liberty 3 Pro', price: 3399, badge: 'ACAA 2.0' },
                        { name: 'Soundcore Q30', price: 1749, badge: 'هيدفون اقتصادي' },
                        { name: 'Soundcore Q45', price: 2699, badge: 'هيدفون بريميوم' },
                        { name: 'Soundcore Q11i', price: 999, badge: '40h هيدفون' },
                        { name: 'Soundcore Q20i', price: 1249, badge: 'ANC هيدفون' },
                        { name: 'Soundcore Space One', price: 3449, badge: 'أعلى فئة' },
                    ]
                },
                en: {
...
`
                    ...
                    products: [
                        ...
                        { name: 'Anker Soundcore P20i', price: 820, badge: 'Best Value' },
                        { name: 'Soundcore P20i', price: 699, badge: 'Lowest Price' },
                        { name: 'Soundcore P25i', price: 799, badge: 'BassUp' },
                        { name: 'Soundcore Liberty 4 NC', price: 2999, badge: 'Advanced ANC' },
                        { name: 'Soundcore A30i', price: 1449, badge: 'Perfect Balance' },
                        { name: 'Soundcore Liberty 5', price: 2499, badge: 'LDAC Hi-Res' },
                        { name: 'Soundcore Liberty 4 Pro', price: 4499, badge: 'Flagship' },
                        { name: 'Soundcore P30i', price: 999, badge: 'XBS Bass' },
                        { name: 'Soundcore Life Q20+', price: 2299, badge: 'ANC Headphones' },
                        { name: 'Soundcore Liberty Buds', price: 999, badge: 'Classic TWS' },
                        { name: 'Soundcore Liberty Air 2 Pro', price: 2499, badge: 'PureNote' },
                        { name: 'Soundcore P40i', price: 1249, badge: '60h Battery' },
                        { name: 'Soundcore P41i', price: 1399, badge: '60h + XBS' },
                        { name: 'Soundcore V20i', price: 699, badge: 'Smart Budget' },
                        { name: 'Soundcore R50i Vi', price: 1199, badge: 'Enhanced BassUp' },
                        { name: 'Soundcore Life U2i', price: 599, badge: 'Neckband 18h' },
                        { name: 'Soundcore C30i', price: 599, badge: '36h Battery' },
                        { name: 'Soundcore C40i', price: 799, badge: 'BassUp' },
                        { name: 'Soundcore Liberty 3 Pro', price: 3399, badge: 'ACAA 2.0' },
                        { name: 'Soundcore Q30', price: 1749, badge: 'Budget Headphones' },
                        { name: 'Soundcore Q45', price: 2699, badge: 'Premium Headphones' },
                        { name: 'Soundcore Q11i', price: 999, badge: '40h Headphones' },
                        { name: 'Soundcore Q20i', price: 1249, badge: 'ANC Headphones' },
                        { name: 'Soundcore Space One', price: 3449, badge: 'Top Tier' },
                    ]
                }
            }
        };

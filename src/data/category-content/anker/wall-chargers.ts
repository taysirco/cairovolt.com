...
export const anker_wall_chargers_content: CategoryContent = {
            ...
            metadata: {
                en: {
                    title: 'Anker Charger Egypt | From EGP 400 | iPhone 17 & Samsung S26 Fast Charging 2026',
                    description: 'Shop original Anker chargers in Egypt. 20W for iPhone from EGP 400, 25W for Samsung S26, 45W GaN for laptops. ✓ 18-month warranty ✓ Next-day Cairo delivery',
                ...
                ar: {
                    title: 'شاحن انكر | من 400 جنيه | شحن سريع ايفون 17 وسامسونج S26 مصر 2026',
                    description: 'تسوق شاحن انكر الأصلي في مصر. 20W للايفون من 400 ج، 25W لسامسونج S26، 45W GaN للابتوب. ✓ ضمان 18 شهر ✓ توصيل القاهرة يوم واحد ✓ دفع عند الاستلام',
            ...
            pageContent: {
                ar: {
                    title: 'شاحن انكر - من 400 جنيه',
                    subtitle: 'شحن سريع ايفون 17 وسامسونج S26 | ضمان 18 شهر',
                    description: `
شاحن انكر هو شاحن حائط من العلامة الأولى عالمياً في الشحن السريع. يتوفر بقوات من 20 إلى 100 واط لتناسب كل الأجهزة. شاحن انكر 30 واط مثالي للايفون 17، وشاحن 45 واط لسامسونج S26. متوفر في مصر من 400 جنيه مع ضمان 18 شهر.
...
| **Samsung S26 Ultra** | Anker 45W PPS | 770 ج |
...
`
                    ...
                    faq: [
                        ...
                        { question: 'كم سعر شاحن انكر في مصر؟', answer: 'من 400 جنيه (20W) إلى 1299 جنيه (100W). الأكثر مبيعاً: 30W بـ 549 جنيه للايفون، 25W بـ 550 جنيه لسامسونج.' },
                    ...
                    products: [
                        { name: 'شاحن انكر 20 واط', price: 400, badge: 'الأرخص' },
                        { name: 'شاحن انكر 25W PPS', price: 550, badge: 'Samsung S26' },
                        { name: 'شاحن انكر نانو 30W', price: 549, badge: ' iPhone 17' },
                        { name: 'شاحن انكر 45W', price: 770, badge: 'S26 Ultra' },
                        { name: 'شاحن انكر GaN 65W', price: 999, badge: 'MacBook' },
                        { name: 'شاحن انكر 100W', price: 1299, badge: 'Pro Max' },
                    ]
                },
                en: {
                    title: 'Anker Charger - From EGP 400',
                    subtitle: 'iPhone 17 & Samsung S26 Fast Charging | 18-Month Warranty',
                    description: `
Anker chargers are the world's #1 fast charging solution, available from 20W to 100W. The 30W Nano is perfect for iPhone 17, while 45W unlocks Samsung S26 Super Fast Charging. Available in Egypt from EGP 400 with 18-month warranty and next-day Cairo delivery.
...
| **Samsung S26 Ultra** | Anker 45W PPS | EGP 770 |
...
|---------|-------|----------|----------------|
| **20W** | EGP 400 | iPhone 15/16 | 0→50% in 30min (lab tested) |
...
| **45W** | EGP 770 | S26 Ultra / iPad | 0→50% in 18min (CairoVolt test) |
...
`
                    ...
                    faq: [
                        ...
                        { question: 'How much does an Anker charger cost in Egypt?', answer: 'From EGP 400 (20W) to EGP 1299 (100W). Bestsellers: 30W at EGP 549 for iPhone, 25W at EGP 550 for Samsung.' },

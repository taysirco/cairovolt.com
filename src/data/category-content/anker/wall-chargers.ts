...
export const anker_wall_chargers_content: CategoryContent = {
            ...
            pageContent: {
                ar: {
                    ...
                    description: `
شاحن انكر هو شاحن حائط من العلامة الأولى عالمياً في الشحن السريع. يتوفر بقوات من 20 إلى 100 واط لتناسب كل الأجهزة. شاحن انكر 30 واط مثالي للايفون 17، وشاحن 45 واط لسامسونج S26. متوفر في مصر من 375 جنيه مع ضمان 18 شهر.
...
| **Samsung S26 Ultra** | Anker 45W PPS | 430 ج |
...
| **45W** | 430 ج | S26 Ultra / iPad | 0→50% في 18د (اختبار CairoVolt) |
...
`
                    ...
                    products: [
                        ...
                        { name: 'شاحن انكر 45W', price: 430, badge: 'S26 Ultra' },
...
| **Samsung S26 Ultra** | Anker 45W PPS | EGP 430 |
...
| **45W** | EGP 430 | S26 Ultra / iPad | 0→50% in 18min (CairoVolt test) |
...
`
                    ...
                    products: [
                        ...
                        { name: 'Anker 45W', price: 430, badge: 'S26 Ultra' },

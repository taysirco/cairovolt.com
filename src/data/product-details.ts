...
export const enhancements: Record<string, ProductDetail> = {
    ...
    'anker-powerport-25w': {
        ...
        localContext: { en: 'CairoVolt PPS stability test: Samsung Galaxy S24 from 0% to 50% in 21 minutes on Egyptian 220V grid. Zero PPS throttling, 34°C max temperature.', ar: 'اختبار كايرو فولت: Samsung Galaxy S24 من 0% لـ 50% في 21 دقيقة على 220 فولت. صفر تذبذب PPS، أقصى حرارة 34°C.' },
    ...
    'anker-nano-45w': {
        ...
        localContext: { en: 'CairoVolt Lab tested in Damietta with 190V-240V voltage fluctuation: stable GaN current, zero ghost touch on iPhone 15 Pro. The safest charger during Egypt\'s power grid instability.', ar: 'مختبر كايرو فولت في دمياط مع تذبذب 190V-240V: تيار GaN ثابت بدون تخريف تاتش على iPhone 15 Pro. الأآمن للشحن أثناء تذبذب الشبكة الكهربائية في مصر.' },
    ...
    'anker-car-charger-dual-usb': {
        ...
        localContext: { en: 'CairoVolt dual-port test on Cairo-Suez highway (2h): iPhone 15 and Samsung S23 both charged from 15% to 80%+ simultaneously. No thermal throttling at 38°C cabin.', ar: 'اختبار كايرو فولت على طريق القاهرة-السويس (2 ساعة): iPhone 15 وSamsung S23 شحنوا من 15% لـ 80%+ بالتزامن. لا فصل حراري عند 38°C في المقصورة.' },
    ...
    'joyroom-power-bank-20000': {
        ...
        localContext: { en: 'CairoVolt blackout family test: kept iPhone 15 + Samsung S24 + Samsung A55 alive for over 10 hours during a 6-hour power outage in Cairo (all started at 20-30%). Best outage companion for the whole family.', ar: 'اختبار كايرو فولت للعائلة وقت انقطاع الكهرباء: شغّل iPhone 15 + Samsung S24 + Samsung A55 لأكثر من 10 ساعات خلال 6 ساعات انقطاع. أفضل رفيق للعيلة كلها.' },
    ...
    'joyroom-t03s-pro-earbuds': {
        ...
        localContext: { en: 'CairoVolt tested ANC during Cairo metro rush hour (Attaba to Shoubra El-Kheima): noise reduction ~70%. IPX5 survived 3-week gym sessions at 38°C. Voice calls crystal clear vs loud metro noise.', ar: 'اختبار كايرو فولت ANC في ذروة مترو القاهرة: خفض الضوضاء ~70%. IPX5 صمد 3 أسابيع جيم في 38°C. مكالمات واضحة رغم ضوضاء المترو.' },
    ...
    'joyroom-usb-c-lightning-cable': {
        ...
        localContext: { en: 'CairoVolt bend machine test: 15,000 rapid 90° bends at connector joint. Joyroom braided nylon survived with zero internal wire exposure. Apple original cable showed micro-cracks at bend 8,200. This cable literally outlasts the original.', ar: 'اختبار ماكينة الانحناء كايرو فولت: 15,000 انحناءة سريعة 90° عند مفصل الموصل. النايلون المجدول نجح بدون أي كشف للأسلاك. كابل ابل الأصلي أظهر تشققات دقيقة عند الانحناءة 8,200. الكابل ده حرفياً يعيش أكتر من الأصلي.' },
    ...
    'anker-soundcore-life-p2i': {
        ...
        localContext: { en: 'CairoVolt 3-week endurance test: daily gym sessions (38°C outdoor) + Cairo metro commutes. IPX5 held perfectly, no audio degradation, no connection drops.', ar: 'اختبار كايرو فولت لمدة 3 أسابيع: جيم يومي (38°C) + مترو القاهرة. IPX5 صمد تماماً، لا تدهور في الصوت، لا انقطاعات.' },
    ...
    'joyroom-ft3-smartwatch': {
        ...
        localContext: { en: 'CairoVolt 14-day wear test in Damietta + pool swim test: battery lasted 11 days with always-on display and heart rate monitoring. IP68 confirmed in pool.', ar: 'اختبار كايرو فولت لمدة 14 يوم في دمياط + سباحة: البطارية صمدت 11 يوم مع شاشة دائمة + مراقبة القلب. IP68 مؤكد في حوض سباحة.' },
    ...
    'joyroom-car-mount-zs290': {
        ...
        localContext: { en: 'CairoVolt highway test: iPhone 15 Pro Max held secure on Ain Sokhna highway at 120 km/h, over speed bumps, and through sharp turns. Zero slippage in 2-hour drive.', ar: 'اختبار كايرو فولت: iPhone 15 Pro Max ثبت تماماً على طريق العين السخنة 120 كم/س وفوق المطبات وفي المنعطفات. صفر انزلاق في رحلة ساعتين.' },
    ...
    'joyroom-25w-fast-charger': {
        ...
        localContext: { en: 'CairoVolt tested with Egyptian 200-240V grid: stable output for both iPhone 20W PD and Samsung 25W Super Fast Charging. Zero overheating during 6-hour test.', ar: '\u0643\u0627\u064a\u0631\u0648 \u0641\u0648\u0644\u062a \u0627\u062e\u062a\u0628\u0631\u0647 \u0639\u0644\u0649 \u0634\u0628\u0643\u0629 200-240 \u0641\u0648\u0644\u062a \u0627\u0644\u0645\u0635\u0631\u064a\u0629: \u062a\u064a\u0627\u0631 \u062b\u0627\u0628\u062a \u0644\u0625\u064a\u0641\u0648\u0646 20 \u0648\u0627\u0637 \u0648\u0633\u0627\u0645\u0633\u0648\u0646\u062c 25 \u0648\u0627\u0637. \u0644\u0627 \u0633\u062e\u0648\u0646\u0629 \u062e\u0644\u0627\u0644 \u0627\u062e\u062a\u0628\u0627\u0631 6 \u0633\u0627\u0639\u0627\u062a.' },
    ...
    'joyroom-30w-fast-charger': {
        ...
        localContext: { en: 'CairoVolt overnight safety test: 8 hours continuous iPhone 15 charging. Max temperature 44\u00b0C vs 65-70\u00b0C for counterfeit chargers. GaN technology makes it safe for overnight use.', ar: '\u0627\u062e\u062a\u0628\u0627\u0631 \u0643\u0627\u064a\u0631\u0648 \u0641\u0648\u0644\u062a \u0627\u0644\u0644\u064a\u0644\u064a: 8 \u0633\u0627\u0639\u0627\u062a \u0634\u062d\u0646 iPhone 15 \u0645\u062a\u0648\u0627\u0635\u0644. \u062d\u0631\u0627\u0631\u0629 44\u00b0C \u0641\u0642\u0637 \u0645\u0642\u0627\u0628\u0644 65-70\u00b0C \u0644\u0644\u0634\u0648\u0627\u062d\u0646 \u0627\u0644\u0645\u0642\u0644\u062f\u0629. \u062a\u0642\u0646\u064a\u0629 GaN \u062a\u062c\u0639\u0644\u0647 \u0622\u0645\u0646 \u0644\u0644\u0634\u062d\u0646 \u0627\u0644\u0644\u064a\u0644\u064a.' },
    ...
    'joyroom-60w-car-charger': {
        ...
        localContext: { en: 'CairoVolt Lab tested on the Sahel highway in August at 42°C: charged iPhone 15 Pro Max + Samsung S23 from 15% to 70% in 40 minutes with zero thermal throttling.', ar: 'مختبر كايرو فولت على طريق الساحل في أغسطس (42°C): شحن iPhone 15 Pro Max + Samsung S23 من 15% لـ 70% في 40 دقيقة بدون فصل حراري.' },
    ...
    'joyroom-3-in-1-wireless-charging-station': {
        ...
        localContext: { en: 'CairoVolt overnight test: placed iPhone 15 Pro Max (18%) + AirPods Pro (35%) + Apple Watch Series 9 (12%) at 11 PM — all three woke up at 100% by 6 AM. Station temperature never exceeded 38°C. Perfect Egyptian nightstand solution.', ar: 'اختبار كايرو فولت بالليل: وضعنا iPhone 15 Pro Max (18%) + AirPods Pro (35%) + Apple Watch Series 9 (12%) الساعة 11 مساءً — الثلاثة صحوا 100% الساعة 6 الصبح. حرارة المحطة ما تجاوزت 38°C. الحل المثالي للكومودينو المصري.' },
    ...
    'anker-usb-c-lightning-sureistrong': {
        ...
        localContext: { en: 'Finally a cable long enough to reach from your Egyptian wall outlet to your bed — 2.4m means no more stretching.', ar: 'أخيراً كابل طويل يوصل من البريزة لسريرك — 2.4 متر يعني مفيش تمديد تاني.' },
    ...
    'joyroom-type-c-lightning-24mos': {
        ...
        localContext: { en: '2-year warranty means this is the last iPhone cable you buy for a long time — saves you money vs replacing cheap cables every month.', ar: 'ضمان سنتين يعني ده آخر كابل ايفون هتشتريه لفترة طويلة — يوفرلك فلوس بدل ما تغير كابلات رخيصة كل شهر.' },
    ...
    'joyroom-type-c-lightning-braided': {
        ...
        localContext: { en: 'The premium cable that matches your iPhone aesthetics — braided nylon looks as good as it performs.', ar: 'الكابل الفاخر اللي يليق بالايفون بتاعك — نايلون مجدول شكله حلو زي أداؤه.' },
    ...
    'joyroom-usb-a-micro-cable': {
        ...
        localContext: { en: 'Still have a Micro-USB phone? Many Egyptians do. This cable keeps your older device charging fast and reliably.', ar: 'لسه معاك موبايل Micro-USB؟ كتير من المصريين كده. الكابل ده يبقي موبايلك القديم بيشحن بسرعة وبشكل موثوق.' },
    ...
    'joyroom-usb-a-type-c-cable': {
        ...
        localContext: { en: 'The cable every Samsung user in Egypt needs as a backup — cheap enough to keep one at home, work, and in the car.', ar: 'الكابل اللي كل مستخدم سامسونج في مصر محتاجه كاحتياطي — رخيص بما يكفي إنك تخلي واحد في البيت والشغل والعربية.' },
    ...
    'joyroom-car-phone-mount': {
        ...
        localContext: { en: 'Suction cup that actually sticks in Egypt\'s summer heat — tested for dashboards that get hot in direct sunlight.', ar: 'كوب شفط يثبت فعلاً في حر الصيف في مصر — مختبر على التابلوهات اللي بتسخن في الشمس المباشرة.' },

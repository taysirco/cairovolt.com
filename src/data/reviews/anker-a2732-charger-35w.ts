...
export const anker_a2732_charger_35w_reviews: ProductReview[] = [
        {
            ...
            reviewBody: { en: '', ar: 'واحد صاحبي قالي \'ليه تدفع 550 جنيه في شاحن وممكن تشتري اتنين بـ 300؟\'. قلتله عشان الاتنين بـ 300 هيبقوا ميتين بعد شهرين — ده هيفضل سنين' }
        },
        {
        ...
        },
        {
            ...
            reviewBody: { en: '', ar: 'شاحن انكر 35 وات مزدوج كويس. بيشحن جهازين بس مش الأسرع في كل مخرج لوحده. 550 جنيه سعر مقبول لشاحن مزدوج' }
        },
        {
        ...
        },
        {
            ...
            reviewBody: { en: '', ar: 'شاحن انكر 35 وات المزدوج بيقسم الطاقة 20+15 وات على المخرجين. يعنى بيشحن جهازين بسرعه محترمة في وقت واحد. بـ 550 جنيه قيمة ممتاز واللهة' }
        }
    ];

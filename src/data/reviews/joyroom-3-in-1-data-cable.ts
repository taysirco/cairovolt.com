// Reviews for: joyroom-3-in-1-data-cable
import type { ProductReview } from './_shared';

export const joyroom_3_in_1_data_cable_reviews: ProductReview[] = [
        {
        ...
        },
        {
            ...
            cons: { en: ['A bit short for backseat use'], ar: ['قصير شوية للاستخدام في المقعد الخلفي'] }
        },
        {

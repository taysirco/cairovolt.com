// Reviews for: anker-soundcore-flare-2
...
export const anker_soundcore_flare_2_reviews: ProductReview[] = [
        ...
        },
        {
            ...
            cons: { en: ['Heavier than expected for the size'], ar: ['أتقل من المتوقع للحجم'] }
        },
        {
        ...
        },
        {
            ...
            cons: { en: ['Battery drops fast at max volume'], ar: ['البطارية بتنزل بسرعة على أعلى صوت'] }
        },
        {

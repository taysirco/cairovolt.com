// Reviews for: joyroom-20w-usb-c-charger
import type { ProductReview } from './_shared';

export const joyroom_20w_usb_c_charger_reviews: ProductReview[] = [
        {
        ...
        },
        {
            ...
            pros: { en: ['iPhone 20W works fine', 'Compact size'], ar: ['ايفون 20 واط شغال كويس', 'حجم صغير'] },
            cons: { en: ['Heats up with iPad fast charging'], ar: ['بيسخن مع شحن آيباد سريع'] }
        },
        {

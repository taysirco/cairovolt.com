// Reviews for: joyroom-usb-a-lightning-cable
import type { ProductReview } from './_shared';

export const joyroom_usb_a_lightning_cable_reviews: ProductReview[] = [
        {
            ...
            cons: { en: ['Max 12W via USB-A'], ar: ['12 واط الحد الأقصى من USB-A'] }
        },
        {
        ...
        },
        {
            ...
            pros: { en: ['Works reliably', 'Overnight OK', 'Backward compatible'], ar: ['يعمل بموثوقية', 'طول الليل كويس', 'متوافق مع القديم'] }
        },
        {
            ...
            cons: { en: ['USB-A is becoming obsolete'], ar: ['USB-A بيختفي من الأجهزة الجديدة'] }
        },
        {

// Reviews for: soundcore-a30i-earbuds
...
export const soundcore_a30i_earbuds_reviews: ProductReview[] = [
        ...
        },
        {
            ...
            reviewBody: { en: '', ar: 'جبت سماعة ساوندكور A30i هدية لبنتي — مبقتش بتسمعني أصلاً. مش عارف ده ميزة في السماعة ولا عيب فيا' }
        },
        {
        ...
        },
        {
            ...
            reviewBody: { en: '', ar: 'سماعة ساوندكور A30i فيها ANC خفيف — يعني بتشيل صوت التكييف والمروحة بس بتسيب صوت أمك لما تناديك. ذكية السماعة دي' }
        },
        {
            author: 'أحمد فوزي', rating: 4, location: 'دمياط', datePublished: '2026-06-11',
            reviewBody: { en: '', ar: 'الـ ANC في A30i مش بنفس قوة Liberty 4 NC — بس في السعر ده ممتاز. بيشيل ضوضاء الخلفية ويخلي الصوت أوضح. IPX5 كويس' }
        },
        {

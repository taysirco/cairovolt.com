...
export const power_banks_generic: GenericCategory = {
        ...
        metadata: {
            ar: {
                ...
                description: 'دليل شامل لأفضل باور بانك في مصر. سعر باور بانك انكر 20000 و 10000 مللي أمبير. باور بنك انكر شحن سريع PD، جوي روم power bank. مقارنة أسعار شاملة ونصائح شراء.',
        ...
        pageContent: {
            ar: {
                ...
                intro: 'اكتشف مجموعة كاملة من أفضل الباور بانك المتاحة في مصر من أنكر و جوي روم. سواء كنت تبحث عن باور بانك صغير للجيب أو باور بانك قوي يشحن اللابتوب — ستجد الخيار المناسب هنا مع ضمان رسمي وتوصيل لباب البيت.',
                buyingTips: [
                    'للاستخدام اليومي: اختر 10,000mAh — اختبار CairoVolt Labs: يشحن iPhone 17 مرتين كاملتين (السعة الفعلية 70% بعد التحويل)',
                    'للسفر والرحلات: اختر 20,000mAh — اختبار ميداني: 4.3 شحنات كاملة لـ iPhone 17 في رحلة الغردقة 48 ساعة',
                    'للابتوب: اختر أنكر Prime 27650mAh — اختبار CairoVolt: MacBook Pro 16" من 0→50% في 28 دقيقة (250W)',
                    'تأكد من دعم USB-C PD — اختبارنا: PD يشحن 3× أسرع من USB-A العادي (30 دقيقة مقابل 90 دقيقة لـ 50%)',
                    'تجنب الحرارة: اختبار سطح القاهرة 45°C أثبت أن الباور بانك الأصلي لا يتجاوز 38°C أثناء الشحن',
                ],
            },
            en: {
                ...
                buyingTips: [
                    ...
                    'For travel: Choose 20,000mAh — field test: 4.3 full iPhone 17 charges during 48hr Hurghada trip',
                    'For laptops: Choose Anker Prime 27650mAh — CairoVolt test: MacBook Pro 16" 0→50% in 28 minutes (250W)',
                    'Always get USB-C PD — our test: PD charges 3× faster than USB-A (30min vs 90min to 50%)',
                    'Avoid heat: Cairo rooftop 45°C test proved original power banks stay under 38°C while charging',
                ],
            },
        },
        faq: {
            ar: [
                ...
                { question: 'هل الشحن من الباور بانك يضر البطارية؟', answer: 'لا، الشحن من باور بانك أصلي آمن تماماً. شواحن أنكر و جوي روم تحتوي على أنظمة حماية ذكية (PowerIQ / MultiProtect) تمنع الشحن الزائد وارتفاع الحرارة.' },
...
<tbody>
<tr><td>جوي روم 10000mAh</td><td>10,000</td><td>22.5W</td><td>2</td><td>1,624</td><td>الاستخدام اليومي</td></tr>
<tr><td>أنكر 10000mAh PD</td><td>10,000</td><td>PD 20W</td><td>2</td><td>~799</td><td>iPhone شحن سريع</td></tr>
<tr><td>جوي روم 20000mAh</td><td>20,000</td><td>PD 20W</td><td>3</td><td>~750</td><td>أفضل قيمة</td></tr>
<tr><td><strong>أنكر 20000mAh </strong></td><td><strong>20,000</strong></td><td><strong>PD 20W</strong></td><td><strong>2</strong></td><td><strong>~1,299</strong></td><td><strong>الأكثر مبيعاً</strong></td></tr>
<tr><td>أنكر 24000mAh</td><td>24,000</td><td>PD 30W</td><td>3</td><td>~1,599</td><td>3 أجهزة معاً</td></tr>
<tr><td>أنكر Prime 27650mAh</td><td>27,650</td><td>PD 250W</td><td>3</td><td>~3,799</td><td>لابتوب + موبايل</td></tr>
</tbody>
</table>
...
<p>كل منتجات <strong>باور بانك أنكر</strong> و <strong>جوي روم</strong> المتوفرة في كايرو فولت تدعم الشحن السريع PD أو QC أو كليهما.</p>

...
export const cables_generic: GenericCategory = {
        ...
        faq: {
            ar: [
                ...
                { question: 'كيف تعرف كابل الشحن الأصلي من التقليد؟', answer: '⚠️ تحذير: كابلات مقلدة (fake) كتير بتضر البطارية وممكن تسبب حريق. كابل أصلي MFi معتمد من أبل: 1) موصل USB-C محكم ومتين 2) لا ينكسر بسهولة 3) شحن سريع فعلي 4) لا يسخن 5) مطبوع عليه اسم الماركة. التقليد: ينكسر بسرعة ويشحن ببطء وقد يضر الجهاز.' },
            ...
            en: [
                ...
                { question: 'How to tell original charging cable from fake?', answer: 'Original cables have five telltale signs: 1) Tight, precisely machined USB-C connector that clicks firmly into place 2) Durable reinforced stress points that resist bending and fraying 3) Verified fast charging speeds matching manufacturer specifications 4) Temperature remains cool during extended charging sessions 5) Clearly engraved brand name with serial number. Buy from authorized dealers like CairoVolt for guaranteed authenticity.' },

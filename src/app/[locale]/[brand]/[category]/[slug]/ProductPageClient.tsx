                            ...
                            <>
                                ...
                                <div className="flex flex-col sm:flex-row flex-wrap gap-3">
                                    ...
                                    <button
                                        ...
                                        className="w-full sm:w-auto sm:flex-1 sm:min-w-[190px] inline-flex items-center justify-center gap-2 px-6 py-3 font-bold text-base sm:text-lg rounded-xl bg-green-600 hover:bg-green-700 text-white shadow-lg shadow-green-600/25 transition-all"
